...
main(void)
{
  ...
  15:	e8 39 03 00 00       	call   353 <toggle>
  ...
  24:	e8 17 04 00 00       	call   440 <printf>
	int cid = fork();
  29:	e8 7d 02 00 00       	call   2ab <fork>
	if(cid!=0){
  ...
  33:	75 0a                	jne    3f <main+0x3f>
	...
	wait();
  35:	e8 81 02 00 00       	call   2bb <wait>
	exit();
  3a:	e8 74 02 00 00       	call   2b3 <exit>
		print_count();
  3f:	e8 17 03 00 00       	call   35b <print_count>
		toggle();		
  44:	e8 0a 03 00 00       	call   353 <toggle>
  49:	eb ea                	jmp    35 <main+0x35>
  4b:	66 90                	xchg   %ax,%ax
  4d:	66 90                	xchg   %ax,%ax
  4f:	90                   	nop
