...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 fb 80 10 80 	movl   $0x801080fb,(%esp)
...
80100515:	e8 76 5d 00 00       	call   80106290 <uartputc>
8010051a:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100521:	e8 6a 5d 00 00       	call   80106290 <uartputc>
80100526:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010052d:	e8 5e 5d 00 00       	call   80106290 <uartputc>
...
80100589:	68 e5 76 10 80       	push   $0x801076e5
...
801005c9:	0f b6 92 10 77 10 80 	movzbl -0x7fef88f0(%edx),%edx
...
8010077b:	75 55                	jne    801007d2 <cprintf+0x122>
        s = "(null)";
8010077d:	bb f8 76 10 80       	mov    $0x801076f8,%ebx
      for(; *s; s++)
...
80100838:	68 ff 76 10 80       	push   $0x801076ff
...
80100a3a:	68 08 77 10 80       	push   $0x80107708
...
80100b0a:	75 ce                	jne    80100ada <exec+0x5a>
  if((pgdir = setupkvm()) == 0)
80100b0c:	e8 ef 68 00 00       	call   80107400 <setupkvm>
...
80100b73:	e8 a8 66 00 00       	call   80107220 <allocuvm>
...
80100ba9:	e8 a2 65 00 00       	call   80107150 <loaduvm>
...
80100beb:	e8 90 67 00 00       	call   80107380 <freevm>
  if(ip){
...
80100c32:	e8 e9 65 00 00       	call   80107220 <allocuvm>
...
80100c51:	31 ff                	xor    %edi,%edi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c53:	e8 48 68 00 00       	call   801074a0 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100ce1:	e8 9a 66 00 00       	call   80107380 <freevm>
...
80100d2d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d33:	e8 c8 68 00 00       	call   80107600 <copyout>
...
80100d9d:	e8 1e 62 00 00       	call   80106fc0 <switchuvm>
  freevm(oldpgdir);
80100da2:	89 3c 24             	mov    %edi,(%esp)
80100da5:	e8 d6 65 00 00       	call   80107380 <freevm>
  return 0;
...
80100dbc:	68 21 77 10 80       	push   $0x80107721
...
80100dea:	68 2d 77 10 80       	push   $0x8010772d
...
80100eaf:	68 34 77 10 80       	push   $0x80107734
...
80100f8c:	68 3c 77 10 80       	push   $0x8010773c
...
8010107a:	68 46 77 10 80       	push   $0x80107746
...
80101163:	68 4f 77 10 80       	push   $0x8010774f
...
80101199:	68 55 77 10 80       	push   $0x80107755
...
80101217:	68 5f 77 10 80       	push   $0x8010775f
...
801012d4:	68 72 77 10 80       	push   $0x80107772
...
80101422:	68 88 77 10 80       	push   $0x80107788
...
801014eb:	68 98 77 10 80       	push   $0x80107798
...
80101550:	68 ab 77 10 80       	push   $0x801077ab
...
8010156b:	68 b2 77 10 80       	push   $0x801077b2
...
801015c1:	68 18 78 10 80       	push   $0x80107818
...
80101693:	68 b8 77 10 80       	push   $0x801077b8
...
8010181d:	68 d0 77 10 80       	push   $0x801077d0
80101822:	e8 69 eb ff ff       	call   80100390 <panic>
    panic("ilock");
80101827:	83 ec 0c             	sub    $0xc,%esp
8010182a:	68 ca 77 10 80       	push   $0x801077ca
...
8010187b:	68 df 77 10 80       	push   $0x801077df
...
80101d4a:	68 f9 77 10 80       	push   $0x801077f9
80101d4f:	e8 3c e6 ff ff       	call   80100390 <panic>
    panic("dirlookup not DIR");
80101d54:	83 ec 0c             	sub    $0xc,%esp
80101d57:	68 e7 77 10 80       	push   $0x801077e7
...
80102013:	68 08 78 10 80       	push   $0x80107808
80102018:	e8 73 e3 ff ff       	call   80100390 <panic>
    panic("dirlink");
8010201d:	83 ec 0c             	sub    $0xc,%esp
80102020:	68 1a 7e 10 80       	push   $0x80107e1a
...
8010212b:	68 74 78 10 80       	push   $0x80107874
80102130:	e8 5b e2 ff ff       	call   80100390 <panic>
    panic("idestart");
80102135:	83 ec 0c             	sub    $0xc,%esp
80102138:	68 6b 78 10 80       	push   $0x8010786b
...
8010215a:	68 86 78 10 80       	push   $0x80107886
...
8010235a:	68 b5 78 10 80       	push   $0x801078b5
8010235f:	e8 2c e0 ff ff       	call   80100390 <panic>
    panic("iderw: nothing to do");
80102364:	83 ec 0c             	sub    $0xc,%esp
80102367:	68 a0 78 10 80       	push   $0x801078a0
8010236c:	e8 1f e0 ff ff       	call   80100390 <panic>
    panic("iderw: buf not locked");
80102371:	83 ec 0c             	sub    $0xc,%esp
80102374:	68 8a 78 10 80       	push   $0x8010788a
...
801023ce:	68 d4 78 10 80       	push   $0x801078d4
...
80102486:	81 fb c8 9b 13 80    	cmp    $0x80139bc8,%ebx
...
80102503:	68 06 79 10 80       	push   $0x80107906
...
8010256f:	68 0c 79 10 80       	push   $0x8010790c
...
801026df:	0f b6 8a 40 7a 10 80 	movzbl -0x7fef85c0(%edx),%ecx
  shift ^= togglecode[data];
801026e6:	0f b6 82 40 79 10 80 	movzbl -0x7fef86c0(%edx),%eax
  shift |= shiftcode[data];
...
801026fc:	83 e1 08             	and    $0x8,%ecx
  c = charcode[shift & (CTL | SHIFT)][data];
801026ff:	8b 04 85 20 79 10 80 	mov    -0x7fef86e0(,%eax,4),%eax
...
80102738:	31 c0                	xor    %eax,%eax
    shift &= ~(shiftcode[data] | E0ESC);
8010273a:	0f b6 8a 40 7a 10 80 	movzbl -0x7fef85c0(%edx),%ecx
...
80102c9e:	68 40 7b 10 80       	push   $0x80107b40
...
80102ef7:	68 44 7b 10 80       	push   $0x80107b44
...
80102fc1:	68 53 7b 10 80       	push   $0x80107b53
80102fc6:	e8 c5 d3 ff ff       	call   80100390 <panic>
    panic("log_write outside of trans");
80102fcb:	83 ec 0c             	sub    $0xc,%esp
80102fce:	68 69 7b 10 80       	push   $0x80107b69
...
80102ff8:	68 84 7b 10 80       	push   $0x80107b84
80102ffd:	e8 ae d6 ff ff       	call   801006b0 <cprintf>
  idtinit();       // load idt register
80103002:	e8 c9 2e 00 00       	call   80105ed0 <idtinit>
...
80103027:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
8010302a:	e8 71 3f 00 00       	call   80106fa0 <switchkvm>
  seginit();
8010302f:	e8 dc 3e 00 00       	call   80106f10 <seginit>
  lapicinit();
...
8010305b:	68 c8 9b 13 80       	push   $0x80139bc8
80103060:	e8 fb f4 ff ff       	call   80102560 <kinit1>
  kvmalloc();      // kernel page table
80103065:	e8 16 44 00 00       	call   80107480 <kvmalloc>
  mpinit();        // detect other processors
8010306a:	e8 81 01 00 00       	call   801031f0 <mpinit>
  lapicinit();     // interrupt controller
8010306f:	e8 2c f7 ff ff       	call   801027a0 <lapicinit>
  seginit();       // segment descriptors
80103074:	e8 97 3e 00 00       	call   80106f10 <seginit>
  picinit();       // disable pic
...
80103088:	e8 43 31 00 00       	call   801061d0 <uartinit>
  pinit();         // process table
8010308d:	e8 1e 08 00 00       	call   801038b0 <pinit>
  tvinit();        // trap vectors
80103092:	e8 b9 2d 00 00       	call   80105e50 <tvinit>
  binit();         // buffer cache
...
8010319e:	68 98 7b 10 80       	push   $0x80107b98
...
8010325a:	68 9d 7b 10 80       	push   $0x80107b9d
...
801033c0:	68 bc 7b 10 80       	push   $0x80107bbc
...
80103464:	00 00 00 
  initlock(&p->lock, "pipe");
80103467:	68 77 7e 10 80       	push   $0x80107e77
...
801037b3:	81 fb d4 92 13 80    	cmp    $0x801392d4,%ebx
...
801037d4:	8d 50 01             	lea    0x1(%eax),%edx
  release(&ptable.lock);
801037d7:	68 a0 73 13 80       	push   $0x801373a0
  p->pid = nextpid++;
...
80103804:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103807:	c7 40 14 3b 5e 10 80 	movl   $0x80105e3b,0x14(%eax)
  p->context = (struct context*)sp;
...
80103833:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
80103835:	68 a0 73 13 80       	push   $0x801373a0
...
80103867:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
8010386a:	68 a0 73 13 80       	push   $0x801373a0
...
801038ba:	68 db 7b 10 80       	push   $0x80107bdb
801038bf:	68 a0 73 13 80       	push   $0x801373a0
...
801038e0:	e8 bb ef ff ff       	call   801028a0 <lapicid>
  for (i = 0; i < ncpu; ++i) {
801038e5:	8b 35 60 73 13 80    	mov    0x80137360,%esi
  apicid = lapicid();
...
80103905:	0f b6 81 e0 6d 13 80 	movzbl -0x7fec9220(%ecx),%eax
8010390c:	39 d8                	cmp    %ebx,%eax
8010390e:	75 e8                	jne    801038f8 <mycpu+0x28>
}
80103910:	8d 65 f8             	lea    -0x8(%ebp),%esp
      return &cpus[i];
80103913:	8d 81 e0 6d 13 80    	lea    -0x7fec9220(%ecx),%eax
}
80103919:	5b                   	pop    %ebx
8010391a:	5e                   	pop    %esi
8010391b:	5d                   	pop    %ebp
...
8010394f:	c9                   	leave  
  return mycpu()-cpus;
80103950:	2d e0 6d 13 80       	sub    $0x80136de0,%eax
...
801039a0:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039a2:	a3 b8 d5 10 80       	mov    %eax,0x8010d5b8
  if((p->pgdir = setupkvm()) == 0)
801039a7:	e8 54 3a 00 00       	call   80107400 <setupkvm>
...
801039bf:	68 60 d4 10 80       	push   $0x8010d460
801039c4:	50                   	push   %eax
801039c5:	e8 06 37 00 00       	call   801070d0 <inituvm>
...
80103a77:	68 f2 7b 10 80       	push   $0x80107bf2
...
80103abf:	e8 fc 34 00 00       	call   80106fc0 <switchuvm>
  return 0;
...
80103ada:	e8 41 37 00 00       	call   80107220 <allocuvm>
...
80103afa:	e8 51 38 00 00       	call   80107350 <deallocuvm>
...
80103b4c:	e8 7f 39 00 00       	call   801074d0 <copyuvm>
...
80103bce:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103bd1:	c7 04 24 a0 73 13 80 	movl   $0x801373a0,(%esp)
80103bd8:	e8 e3 09 00 00       	call   801045c0 <acquire>
  np->state = RUNNABLE;
80103bdd:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103be4:	c7 04 24 a0 73 13 80 	movl   $0x801373a0,(%esp)
...
80103c59:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c5c:	bb d4 73 13 80       	mov    $0x801373d4,%ebx
    acquire(&ptable.lock);
80103c61:	68 a0 73 13 80       	push   $0x801373a0
...
80103c80:	e8 3b 33 00 00       	call   80106fc0 <switchuvm>
...
80103c92:	e8 5c 0c 00 00       	call   801048f3 <swtch>
      switchkvm();
80103c97:	e8 04 33 00 00       	call   80106fa0 <switchkvm>
      c->proc = 0;
...
80103cac:	81 fb d4 92 13 80    	cmp    $0x801392d4,%ebx
80103cb2:	75 bc                	jne    80103c70 <scheduler+0x40>
    release(&ptable.lock);
80103cb4:	83 ec 0c             	sub    $0xc,%esp
80103cb7:	68 a0 73 13 80       	push   $0x801373a0
...
80103cf1:	68 a0 73 13 80       	push   $0x801373a0
...
80103db8:	39 35 b8 d5 10 80    	cmp    %esi,0x8010d5b8
...
80103dfc:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103e03:	c7 04 24 a0 73 13 80 	movl   $0x801373a0,(%esp)
...
80103e3f:	3d d4 92 13 80       	cmp    $0x801392d4,%eax
80103e44:	75 e4                	jne    80103e2a <exit+0x9a>
      p->parent = initproc;
80103e46:	8b 0d b8 d5 10 80    	mov    0x8010d5b8,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e4c:	ba d4 73 13 80       	mov    $0x801373d4,%edx
80103e51:	eb 10                	jmp    80103e63 <exit+0xd3>
80103e53:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103e57:	90                   	nop
80103e58:	83 c2 7c             	add    $0x7c,%edx
80103e5b:	81 fa d4 92 13 80    	cmp    $0x801392d4,%edx
...
80103ead:	68 63 7c 10 80       	push   $0x80107c63
80103eb2:	e8 d9 c4 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103eb7:	83 ec 0c             	sub    $0xc,%esp
80103eba:	68 56 7c 10 80       	push   $0x80107c56
...
80103edb:	68 a0 73 13 80       	push   $0x801373a0
...
80103f01:	e8 ca fd ff ff       	call   80103cd0 <sched>
  release(&ptable.lock);
80103f06:	c7 04 24 a0 73 13 80 	movl   $0x801373a0,(%esp)
...
80103f54:	81 fe a0 73 13 80    	cmp    $0x801373a0,%esi
80103f5a:	74 4c                	je     80103fa8 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103f5c:	83 ec 0c             	sub    $0xc,%esp
80103f5f:	68 a0 73 13 80       	push   $0x801373a0
...
80103f80:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80103f87:	c7 04 24 a0 73 13 80 	movl   $0x801373a0,(%esp)
...
80103fc9:	68 6f 7c 10 80       	push   $0x80107c6f
80103fce:	e8 bd c3 ff ff       	call   80100390 <panic>
    panic("sleep");
80103fd3:	83 ec 0c             	sub    $0xc,%esp
80103fd6:	68 cb 7e 10 80       	push   $0x80107ecb
...
80104023:	81 fb d4 92 13 80    	cmp    $0x801392d4,%ebx
...
80104039:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010403e:	81 fb d4 92 13 80    	cmp    $0x801392d4,%ebx
...
80104054:	68 a0 73 13 80       	push   $0x801373a0
...
8010407a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104081:	e8 fa 32 00 00       	call   80107380 <freevm>
        release(&ptable.lock);
80104086:	c7 04 24 a0 73 13 80 	movl   $0x801373a0,(%esp)
        p->pid = 0;
...
801040c1:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801040c6:	68 a0 73 13 80       	push   $0x801373a0
...
80104127:	3d d4 92 13 80       	cmp    $0x801392d4,%eax
8010412c:	75 e4                	jne    80104112 <wakeup+0x32>
  wakeup1(chan);
  release(&ptable.lock);
8010412e:	c7 45 08 a0 73 13 80 	movl   $0x801373a0,0x8(%ebp)
}
...
8010418e:	68 a0 73 13 80       	push   $0x801373a0
...
801041ab:	68 a0 73 13 80       	push   $0x801373a0
...
801041dd:	bb 40 74 13 80       	mov    $0x80137440,%ebx
...
80104214:	74 ea                	je     80104200 <procdump+0x30>
      state = "???";
80104216:	ba 80 7c 10 80       	mov    $0x80107c80,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010421b:	83 f8 05             	cmp    $0x5,%eax
8010421e:	77 11                	ja     80104231 <procdump+0x61>
80104220:	8b 14 85 f8 7c 10 80 	mov    -0x7fef8308(,%eax,4),%edx
      state = "???";
80104227:	b8 80 7c 10 80       	mov    $0x80107c80,%eax
...
80104236:	68 84 7c 10 80       	push   $0x80107c84
...
80104275:	68 e1 76 10 80       	push   $0x801076e1
...
801042a7:	53                   	push   %ebx
  struct proc *p;
  for(p=ptable.proc;p<&ptable.proc[NPROC];p++){
801042a8:	bb d4 73 13 80       	mov    $0x801373d4,%ebx
ps(void){
801042ad:	83 ec 04             	sub    $0x4,%esp
801042b0:	eb 11                	jmp    801042c3 <ps+0x23>
801042b2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p=ptable.proc;p<&ptable.proc[NPROC];p++){
801042b8:	83 c3 7c             	add    $0x7c,%ebx
801042bb:	81 fb d4 92 13 80    	cmp    $0x801392d4,%ebx
801042c1:	74 33                	je     801042f6 <ps+0x56>
    if(p->state!=UNUSED)cprintf("%s%d %s%s\n","pid:",p->pid,"name:", p->name);
801042c3:	8b 43 0c             	mov    0xc(%ebx),%eax
801042c6:	85 c0                	test   %eax,%eax
801042c8:	74 ee                	je     801042b8 <ps+0x18>
801042ca:	83 ec 0c             	sub    $0xc,%esp
801042cd:	8d 43 6c             	lea    0x6c(%ebx),%eax
  for(p=ptable.proc;p<&ptable.proc[NPROC];p++){
801042d0:	83 c3 7c             	add    $0x7c,%ebx
    if(p->state!=UNUSED)cprintf("%s%d %s%s\n","pid:",p->pid,"name:", p->name);
801042d3:	50                   	push   %eax
801042d4:	68 8d 7c 10 80       	push   $0x80107c8d
801042d9:	ff 73 94             	pushl  -0x6c(%ebx)
801042dc:	68 93 7c 10 80       	push   $0x80107c93
801042e1:	68 98 7c 10 80       	push   $0x80107c98
801042e6:	e8 c5 c3 ff ff       	call   801006b0 <cprintf>
801042eb:	83 c4 20             	add    $0x20,%esp
  for(p=ptable.proc;p<&ptable.proc[NPROC];p++){
801042ee:	81 fb d4 92 13 80    	cmp    $0x801392d4,%ebx
801042f4:	75 cd                	jne    801042c3 <ps+0x23>
  }
  return 0;
}
...
8010430e:	68 10 7d 10 80       	push   $0x80107d10
...
80104555:	68 1b 7d 10 80       	push   $0x80107d1b
8010455a:	e8 31 be ff ff       	call   80100390 <panic>
    panic("popcli");
8010455f:	83 ec 0c             	sub    $0xc,%esp
80104562:	68 32 7d 10 80       	push   $0x80107d32
...
80104667:	68 39 7d 10 80       	push   $0x80107d39
...
801046c0:	68 41 7d 10 80       	push   $0x80107d41
...
80104ab5:	8b 40 1c             	mov    0x1c(%eax),%eax
  ...
  if(num<=ONSC){
80104ab8:	83 f8 15             	cmp    $0x15,%eax
80104abb:	7f 08                	jg     80104ac5 <syscall+0x25>
    CALLS[num]++;
80104abd:	83 04 85 e0 92 13 80 	addl   $0x1,-0x7fec6d20(,%eax,4)
80104ac4:	01 
  }

  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104ac5:	8d 50 ff             	lea    -0x1(%eax),%edx
80104ac8:	83 fa 1b             	cmp    $0x1b,%edx
80104acb:	77 23                	ja     80104af0 <syscall+0x50>
80104acd:	8b 14 85 80 7d 10 80 	mov    -0x7fef8280(,%eax,4),%edx
80104ad4:	85 d2                	test   %edx,%edx
80104ad6:	74 18                	je     80104af0 <syscall+0x50>
    curproc->tf->eax = syscalls[num]();
80104ad8:	ff d2                	call   *%edx
80104ada:	89 c2                	mov    %eax,%edx
80104adc:	8b 43 18             	mov    0x18(%ebx),%eax
80104adf:	89 50 1c             	mov    %edx,0x1c(%eax)
  } else {
...
80104af8:	68 49 7d 10 80       	push   $0x80107d49
...
80104b5c:	e8 4f d1 ff ff       	call   80101cb0 <dirlookup>
...
80104b6e:	e8 8d ce ff ff       	call   80101a00 <iunlockput>
    ilock(ip);
80104b73:	89 34 24             	mov    %esi,(%esp)
80104b76:	e8 e5 cb ff ff       	call   80101760 <ilock>
...
80104c54:	68 10 7e 10 80       	push   $0x80107e10
...
80104c6c:	68 0f 7e 10 80       	push   $0x80107e0f
...
80104c81:	68 03 7e 10 80       	push   $0x80107e03
...
80104c9f:	68 12 7e 10 80       	push   $0x80107e12
80104ca4:	e8 e7 b6 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104ca9:	83 ec 0c             	sub    $0xc,%esp
80104cac:	68 f4 7d 10 80       	push   $0x80107df4
...
80104ce4:	e8 77 ec ff ff       	call   80103960 <myproc>
...
80104d2d:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104d2f:	e8 2c ec ff ff       	call   80103960 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80104da1:	e8 0a fc ff ff       	call   801049b0 <argint>
...
80104db9:	e8 42 fc ff ff       	call   80104a00 <argptr>
...
80104e11:	e8 9a fb ff ff       	call   801049b0 <argint>
...
80104e29:	e8 d2 fb ff ff       	call   80104a00 <argptr>
...
80104e77:	78 27                	js     80104ea0 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104e79:	e8 e2 ea ff ff       	call   80103960 <myproc>
...
80104ed3:	e8 28 fb ff ff       	call   80104a00 <argptr>
...
80104f13:	e8 48 fb ff ff       	call   80104a60 <argstr>
...
80104f2c:	e8 2f fb ff ff       	call   80104a60 <argstr>
...
80105063:	e8 f8 f9 ff ff       	call   80104a60 <argstr>
...
8010509d:	58                   	pop    %eax
8010509e:	5a                   	pop    %edx
8010509f:	68 10 7e 10 80       	push   $0x80107e10
...
801050b8:	68 0f 7e 10 80       	push   $0x80107e0f
...
80105112:	e8 b9 f5 ff ff       	call   801046d0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80105243:	e8 18 f8 ff ff       	call   80104a60 <argstr>
...
8010525c:	e8 4f f7 ff ff       	call   801049b0 <argint>
...
801052a7:	74 23                	je     801052cc <sys_open+0x9c>
  struct proc *curproc = myproc();
801052a9:	e8 b2 e6 ff ff       	call   80103960 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105388:	e8 d3 f6 ff ff       	call   80104a60 <argstr>
...
801053f8:	e8 63 f6 ff ff       	call   80104a60 <argstr>
...
8010540d:	e8 9e f5 ff ff       	call   801049b0 <argint>
  if((argstr(0, &path)) < 0 ||
...
80105422:	e8 89 f5 ff ff       	call   801049b0 <argint>
     argint(1, &major) < 0 ||
...
80105489:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
8010548c:	e8 cf e4 ff ff       	call   80103960 <myproc>
...
801054a1:	e8 ba f5 ff ff       	call   80104a60 <argstr>
...
80105549:	e8 12 f5 ff ff       	call   80104a60 <argstr>
...
80105565:	e8 46 f4 ff ff       	call   801049b0 <argint>
...
8010558a:	e8 41 f1 ff ff       	call   801046d0 <memset>
...
801055ac:	e8 5f f3 ff ff       	call   80104910 <fetchint>
...
801055d0:	e8 7b f3 ff ff       	call   80104950 <fetchstr>
...
80105645:	e8 b6 f3 ff ff       	call   80104a00 <argptr>
...
8010566b:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
8010566d:	e8 ee e2 ff ff       	call   80103960 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801056b7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801056ba:	e8 a1 e2 ff ff       	call   80103960 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801056d6:	75 f0                	jne    801056c8 <sys_pipe+0x98>
      myproc()->ofile[fd0] = 0;
801056d8:	e8 83 e2 ff ff       	call   80103960 <myproc>
...
80105719:	8b 75 0c             	mov    0xc(%ebp),%esi
8010571c:	8b 5d 08             	mov    0x8(%ebp),%ebx
  memmove(buffers[index], (char**)ch, MSSG_SIZE);
8010571f:	8d 04 f5 e0 b0 10 80 	lea    -0x7fef4f20(,%esi,8),%eax
80105726:	83 ec 04             	sub    $0x4,%esp
80105729:	6a 08                	push   $0x8
8010572b:	ff 75 10             	pushl  0x10(%ebp)
8010572e:	50                   	push   %eax
8010572f:	e8 3c f0 ff ff       	call   80104770 <memmove>
  queue[pid][rear[pid]] = index;
80105734:	69 c3 f4 01 00 00    	imul   $0x1f4,%ebx,%eax
  rear[pid] = (rear[pid] + 1) % MAX_QUEUE_SIZE;
8010573a:	ba d3 4d 62 10       	mov    $0x10624dd3,%edx
}
8010573f:	83 c4 10             	add    $0x10,%esp
  queue[pid][rear[pid]] = index;
80105742:	8b 0c 9d c0 d6 10 80 	mov    -0x7fef2940(,%ebx,4),%ecx
80105749:	01 c8                	add    %ecx,%eax
  rear[pid] = (rear[pid] + 1) % MAX_QUEUE_SIZE;
8010574b:	83 c1 01             	add    $0x1,%ecx
  queue[pid][rear[pid]] = index;
8010574e:	89 34 85 c0 d8 10 80 	mov    %esi,-0x7fef2740(,%eax,4)
  rear[pid] = (rear[pid] + 1) % MAX_QUEUE_SIZE;
80105755:	89 c8                	mov    %ecx,%eax
80105757:	f7 ea                	imul   %edx
80105759:	89 c8                	mov    %ecx,%eax
8010575b:	c1 f8 1f             	sar    $0x1f,%eax
8010575e:	c1 fa 05             	sar    $0x5,%edx
80105761:	29 c2                	sub    %eax,%edx
80105763:	69 d2 f4 01 00 00    	imul   $0x1f4,%edx,%edx
80105769:	29 d1                	sub    %edx,%ecx
8010576b:	89 0c 9d c0 d6 10 80 	mov    %ecx,-0x7fef2940(,%ebx,4)
}
...
80105789:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  if(front[pid] == rear[pid])return -1;
8010578c:	8b 0c 9d c0 d7 10 80 	mov    -0x7fef2840(,%ebx,4),%ecx
80105793:	3b 0c 9d c0 d6 10 80 	cmp    -0x7fef2940(,%ebx,4),%ecx
8010579a:	74 64                	je     80105800 <deque+0x80>
  int result = queue[pid][front[pid]];
8010579c:	69 c3 f4 01 00 00    	imul   $0x1f4,%ebx,%eax
  front[pid] = (front[pid] + 1) % MAX_QUEUE_SIZE;
801057a2:	ba d3 4d 62 10       	mov    $0x10624dd3,%edx
  memmove(msg,buffers[result],MSSG_SIZE);
801057a7:	83 ec 04             	sub    $0x4,%esp
801057aa:	6a 08                	push   $0x8
  int result = queue[pid][front[pid]];
801057ac:	01 c8                	add    %ecx,%eax
  front[pid] = (front[pid] + 1) % MAX_QUEUE_SIZE;
801057ae:	83 c1 01             	add    $0x1,%ecx
  int result = queue[pid][front[pid]];
801057b1:	8b 34 85 c0 d8 10 80 	mov    -0x7fef2740(,%eax,4),%esi
  front[pid] = (front[pid] + 1) % MAX_QUEUE_SIZE;
801057b8:	89 c8                	mov    %ecx,%eax
801057ba:	f7 ea                	imul   %edx
801057bc:	89 c8                	mov    %ecx,%eax
801057be:	c1 f8 1f             	sar    $0x1f,%eax
801057c1:	c1 fa 05             	sar    $0x5,%edx
801057c4:	29 c2                	sub    %eax,%edx
  memmove(msg,buffers[result],MSSG_SIZE);
801057c6:	8d 04 f5 e0 b0 10 80 	lea    -0x7fef4f20(,%esi,8),%eax
  front[pid] = (front[pid] + 1) % MAX_QUEUE_SIZE;
801057cd:	69 d2 f4 01 00 00    	imul   $0x1f4,%edx,%edx
  memmove(msg,buffers[result],MSSG_SIZE);
801057d3:	50                   	push   %eax
801057d4:	ff 75 08             	pushl  0x8(%ebp)
  front[pid] = (front[pid] + 1) % MAX_QUEUE_SIZE;
801057d7:	29 d1                	sub    %edx,%ecx
801057d9:	89 0c 9d c0 d7 10 80 	mov    %ecx,-0x7fef2840(,%ebx,4)
  memmove(msg,buffers[result],MSSG_SIZE);
801057e0:	e8 8b ef ff ff       	call   80104770 <memmove>
  recv_pids[result] = -1;
  return result;
801057e5:	83 c4 10             	add    $0x10,%esp
  recv_pids[result] = -1;
801057e8:	c7 04 b5 c0 cc 12 80 	movl   $0xffffffff,-0x7fed3340(,%esi,4)
801057ef:	ff ff ff ff 
}
...
801057fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(front[pid] == rear[pid])return -1;
80105800:	be ff ff ff ff       	mov    $0xffffffff,%esi
80105805:	eb ec                	jmp    801057f3 <deque+0x73>
...
80105810:	f3 0f 1e fb          	endbr32 
  return fork();
80105814:	e9 f7 e2 ff ff       	jmp    80103b10 <fork>
...
80105827:	83 ec 08             	sub    $0x8,%esp
  exit();
8010582a:	e8 61 e5 ff ff       	call   80103d90 <exit>
...
80105840:	f3 0f 1e fb          	endbr32 
  return wait();
80105844:	e9 97 e7 ff ff       	jmp    80103fe0 <wait>
...
80105860:	e8 4b f1 ff ff       	call   801049b0 <argint>
...
80105872:	e8 c9 e8 ff ff       	call   80104140 <kill>
...
80105897:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
8010589a:	e8 c1 e0 ff ff       	call   80103960 <myproc>
...
801058c1:	e8 ea f0 ff ff       	call   801049b0 <argint>
...
801058da:	e8 b1 e1 ff ff       	call   80103a90 <growproc>
...
80105911:	e8 9a f0 ff ff       	call   801049b0 <argint>
...
80105924:	68 80 93 13 80       	push   $0x80139380
80105929:	e8 92 ec ff ff       	call   801045c0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010592e:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105931:	8b 1d c0 9b 13 80    	mov    0x80139bc0,%ebx
  while(ticks - ticks0 < n){
...
80105943:	68 80 93 13 80       	push   $0x80139380
80105948:	68 c0 9b 13 80       	push   $0x80139bc0
8010594d:	e8 ce e5 ff ff       	call   80103f20 <sleep>
  while(ticks - ticks0 < n){
80105952:	a1 c0 9b 13 80       	mov    0x80139bc0,%eax
...
8010595f:	73 2f                	jae    80105990 <sys_sleep+0x90>
    if(myproc()->killed){
80105961:	e8 fa df ff ff       	call   80103960 <myproc>
...
80105970:	68 80 93 13 80       	push   $0x80139380
80105975:	e8 06 ed ff ff       	call   80104680 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105993:	68 80 93 13 80       	push   $0x80139380
80105998:	e8 e3 ec ff ff       	call   80104680 <release>
  return 0;
...
801059b8:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801059bb:	68 80 93 13 80       	push   $0x80139380
801059c0:	e8 fb eb ff ff       	call   801045c0 <acquire>
  xticks = ticks;
801059c5:	8b 1d c0 9b 13 80    	mov    0x80139bc0,%ebx
  release(&tickslock);
801059cb:	c7 04 24 80 93 13 80 	movl   $0x80139380,(%esp)
801059d2:	e8 a9 ec ff ff       	call   80104680 <release>
  return xticks;
}
...
801059e0:	f3 0f 1e fb          	endbr32 
  if(trace==TRACE_ON){
801059e4:	83 3d bc d5 10 80 01 	cmpl   $0x1,0x8010d5bc
801059eb:	74 33                	je     80105a20 <sys_toggle+0x40>
    trace = TRACE_OFF;
  }
  else{
    trace = TRACE_ON;
801059ed:	c7 05 bc d5 10 80 01 	movl   $0x1,0x8010d5bc
801059f4:	00 00 00 
    for(int i=1;i<=ONSC;i++){
801059f7:	b8 01 00 00 00       	mov    $0x1,%eax
801059fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      CALLS[i]=0;
80105a00:	c7 04 85 e0 92 13 80 	movl   $0x0,-0x7fec6d20(,%eax,4)
80105a07:	00 00 00 00 
    for(int i=1;i<=ONSC;i++){
80105a0b:	83 c0 01             	add    $0x1,%eax
80105a0e:	83 f8 16             	cmp    $0x16,%eax
80105a11:	75 ed                	jne    80105a00 <sys_toggle+0x20>
80105a13:	b8 01 00 00 00       	mov    $0x1,%eax
    }
  }
  return trace;
}
...
80105a19:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    trace = TRACE_OFF;
80105a20:	c7 05 bc d5 10 80 00 	movl   $0x0,0x8010d5bc
80105a27:	00 00 00 
80105a2a:	31 c0                	xor    %eax,%eax
80105a2c:	c3                   	ret    
80105a2d:	8d 76 00             	lea    0x0(%esi),%esi

80105a30 <sys_print_count>:
...
80105a37:	53                   	push   %ebx
  for(int i=1;i<=ONSC;i++){
80105a38:	bb 01 00 00 00       	mov    $0x1,%ebx
sys_print_count(void){
80105a3d:	83 ec 04             	sub    $0x4,%esp
    if(CALLS[map[i]]>0){
80105a40:	8b 04 9d 20 b0 10 80 	mov    -0x7fef4fe0(,%ebx,4),%eax
80105a47:	8b 0c 85 e0 92 13 80 	mov    -0x7fec6d20(,%eax,4),%ecx
80105a4e:	85 c9                	test   %ecx,%ecx
80105a50:	7e 38                	jle    80105a8a <sys_print_count+0x5a>
      cprintf(Call_name[map[i]]);
80105a52:	83 ec 0c             	sub    $0xc,%esp
80105a55:	ff 34 85 80 b0 10 80 	pushl  -0x7fef4f80(,%eax,4)
80105a5c:	e8 4f ac ff ff       	call   801006b0 <cprintf>
      cprintf(" ");
80105a61:	c7 04 24 c4 7c 10 80 	movl   $0x80107cc4,(%esp)
80105a68:	e8 43 ac ff ff       	call   801006b0 <cprintf>
      cprintf("%d\n",CALLS[map[i]]);
80105a6d:	58                   	pop    %eax
80105a6e:	8b 04 9d 20 b0 10 80 	mov    -0x7fef4fe0(,%ebx,4),%eax
80105a75:	5a                   	pop    %edx
80105a76:	ff 34 85 e0 92 13 80 	pushl  -0x7fec6d20(,%eax,4)
80105a7d:	68 94 7b 10 80       	push   $0x80107b94
80105a82:	e8 29 ac ff ff       	call   801006b0 <cprintf>
80105a87:	83 c4 10             	add    $0x10,%esp
  for(int i=1;i<=ONSC;i++){
80105a8a:	83 c3 01             	add    $0x1,%ebx
80105a8d:	83 fb 16             	cmp    $0x16,%ebx
80105a90:	75 ae                	jne    80105a40 <sys_print_count+0x10>
    }
  }
  return 0;
}
...
80105ab0:	e8 fb ee ff ff       	call   801049b0 <argint>
  argint(1,&b);
80105ab5:	58                   	pop    %eax
...
80105abd:	e8 ee ee ff ff       	call   801049b0 <argint>
  return a+b;
80105ac2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ac5:	03 45 f0             	add    -0x10(%ebp),%eax
}
80105ac8:	c9                   	leave  
80105ac9:	c3                   	ret    
...
80105ad7:	83 ec 08             	sub    $0x8,%esp
  ps();
80105ada:	e8 c1 e7 ff ff       	call   801042a0 <ps>
  return 0;
}
...
80105af8:	53                   	push   %ebx
  void* data;
  argint(0, &sender_pid);
80105af9:	8d 45 08             	lea    0x8(%ebp),%eax
  argint(1, &rec_pid);
  argptr(2, (char**)&data, MSSG_SIZE);
  acquire(&lock);
  // cprintf("%s  \n",ch);
  for(int i = 0; i < BUFFER_SIZE; i++){
80105afc:	31 db                	xor    %ebx,%ebx
{
80105afe:	83 ec 18             	sub    $0x18,%esp
  argint(0, &sender_pid);
80105b01:	50                   	push   %eax
80105b02:	6a 00                	push   $0x0
80105b04:	e8 a7 ee ff ff       	call   801049b0 <argint>
  argint(1, &rec_pid);
80105b09:	8d 45 0c             	lea    0xc(%ebp),%eax
80105b0c:	5a                   	pop    %edx
80105b0d:	59                   	pop    %ecx
80105b0e:	50                   	push   %eax
80105b0f:	6a 01                	push   $0x1
80105b11:	e8 9a ee ff ff       	call   801049b0 <argint>
  argptr(2, (char**)&data, MSSG_SIZE);
80105b16:	83 c4 0c             	add    $0xc,%esp
80105b19:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105b1c:	6a 08                	push   $0x8
80105b1e:	50                   	push   %eax
80105b1f:	6a 02                	push   $0x2
80105b21:	e8 da ee ff ff       	call   80104a00 <argptr>
  acquire(&lock);
80105b26:	c7 04 24 40 93 13 80 	movl   $0x80139340,(%esp)
80105b2d:	e8 8e ea ff ff       	call   801045c0 <acquire>
80105b32:	83 c4 10             	add    $0x10,%esp
80105b35:	eb 18                	jmp    80105b4f <sys_send+0x5f>
80105b37:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105b3e:	66 90                	xchg   %ax,%ax
  for(int i = 0; i < BUFFER_SIZE; i++){
80105b40:	83 c3 01             	add    $0x1,%ebx
80105b43:	81 fb e8 03 00 00    	cmp    $0x3e8,%ebx
80105b49:	0f 84 c1 00 00 00    	je     80105c10 <sys_send+0x120>
    if(recv_pids[i] <= 0){        
80105b4f:	8b 04 9d c0 cc 12 80 	mov    -0x7fed3340(,%ebx,4),%eax
80105b56:	85 c0                	test   %eax,%eax
80105b58:	7f e6                	jg     80105b40 <sys_send+0x50>
      sender_pids[i] = sender_pid;
80105b5a:	8b 45 08             	mov    0x8(%ebp),%eax
  memmove(buffers[index], (char**)ch, MSSG_SIZE);
80105b5d:	83 ec 04             	sub    $0x4,%esp
      recv_pids[i] = rec_pid;
80105b60:	8b 75 0c             	mov    0xc(%ebp),%esi
80105b63:	6a 08                	push   $0x8
      sender_pids[i] = sender_pid;
80105b65:	89 04 9d 60 dc 12 80 	mov    %eax,-0x7fed23a0(,%ebx,4)
80105b6c:	8d 04 dd e0 b0 10 80 	lea    -0x7fef4f20(,%ebx,8),%eax
80105b73:	ff 75 f4             	pushl  -0xc(%ebp)
80105b76:	50                   	push   %eax
      recv_pids[i] = rec_pid;
80105b77:	89 34 9d c0 cc 12 80 	mov    %esi,-0x7fed3340(,%ebx,4)
80105b7e:	e8 ed eb ff ff       	call   80104770 <memmove>
  queue[pid][rear[pid]] = index;
80105b83:	69 c6 f4 01 00 00    	imul   $0x1f4,%esi,%eax
  rear[pid] = (rear[pid] + 1) % MAX_QUEUE_SIZE;
80105b89:	ba d3 4d 62 10       	mov    $0x10624dd3,%edx
      enque(rec_pid, i,data);
      if(wait_queue[rec_pid] == 1){
80105b8e:	83 c4 10             	add    $0x10,%esp
  queue[pid][rear[pid]] = index;
80105b91:	8b 0c b5 c0 d6 10 80 	mov    -0x7fef2940(,%esi,4),%ecx
80105b98:	01 c8                	add    %ecx,%eax
  rear[pid] = (rear[pid] + 1) % MAX_QUEUE_SIZE;
80105b9a:	83 c1 01             	add    $0x1,%ecx
  queue[pid][rear[pid]] = index;
80105b9d:	89 1c 85 c0 d8 10 80 	mov    %ebx,-0x7fef2740(,%eax,4)
  rear[pid] = (rear[pid] + 1) % MAX_QUEUE_SIZE;
80105ba4:	89 c8                	mov    %ecx,%eax
80105ba6:	f7 ea                	imul   %edx
80105ba8:	89 c8                	mov    %ecx,%eax
80105baa:	c1 f8 1f             	sar    $0x1f,%eax
80105bad:	c1 fa 05             	sar    $0x5,%edx
80105bb0:	29 c2                	sub    %eax,%edx
80105bb2:	69 c2 f4 01 00 00    	imul   $0x1f4,%edx,%eax
80105bb8:	29 c1                	sub    %eax,%ecx
80105bba:	8b 45 0c             	mov    0xc(%ebp),%eax
80105bbd:	89 0c b5 c0 d6 10 80 	mov    %ecx,-0x7fef2940(,%esi,4)
80105bc4:	83 3c 85 c0 d5 10 80 	cmpl   $0x1,-0x7fef2a40(,%eax,4)
80105bcb:	01 
80105bcc:	74 22                	je     80105bf0 <sys_send+0x100>
        wait_queue[rec_pid] = 0;
        wakeup((void*)rec_pid);
      }
      release(&lock);
80105bce:	83 ec 0c             	sub    $0xc,%esp
80105bd1:	68 40 93 13 80       	push   $0x80139340
80105bd6:	e8 a5 ea ff ff       	call   80104680 <release>
      // cprintf("%s\n",buffers[i]);
      return 0;
...
80105bde:	8d 65 f8             	lea    -0x8(%ebp),%esp
      return 0;
...
80105bee:	66 90                	xchg   %ax,%ax
        wait_queue[rec_pid] = 0;
80105bf0:	c7 04 85 c0 d5 10 80 	movl   $0x0,-0x7fef2a40(,%eax,4)
80105bf7:	00 00 00 00 
        wakeup((void*)rec_pid);
80105bfb:	83 ec 0c             	sub    $0xc,%esp
80105bfe:	50                   	push   %eax
80105bff:	e8 dc e4 ff ff       	call   801040e0 <wakeup>
80105c04:	83 c4 10             	add    $0x10,%esp
80105c07:	eb c5                	jmp    80105bce <sys_send+0xde>
80105c09:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  release(&lock);
80105c10:	83 ec 0c             	sub    $0xc,%esp
80105c13:	68 40 93 13 80       	push   $0x80139340
80105c18:	e8 63 ea ff ff       	call   80104680 <release>
  return -1;
80105c1d:	83 c4 10             	add    $0x10,%esp
}
80105c20:	8d 65 f8             	lea    -0x8(%ebp),%esp
  return -1;
...
80105c38:	8d 45 08             	lea    0x8(%ebp),%eax
int sys_recv(void *msg){
80105c3b:	83 ec 08             	sub    $0x8,%esp
  argptr(0, (char**)&msg, MSSG_SIZE);
80105c3e:	6a 08                	push   $0x8
80105c40:	50                   	push   %eax
80105c41:	6a 00                	push   $0x0
80105c43:	e8 b8 ed ff ff       	call   80104a00 <argptr>
  int me = myproc()->pid;
80105c48:	e8 13 dd ff ff       	call   80103960 <myproc>
80105c4d:	83 c4 10             	add    $0x10,%esp
80105c50:	8b 58 10             	mov    0x10(%eax),%ebx
80105c53:	eb 2b                	jmp    80105c80 <sys_recv+0x50>
80105c55:	8d 76 00             	lea    0x0(%esi),%esi
    ...
    wait_queue[me] = 1;
80105c58:	c7 04 9d c0 d5 10 80 	movl   $0x1,-0x7fef2a40(,%ebx,4)
80105c5f:	01 00 00 00 
    sleep((void*)me, &lock);
80105c63:	83 ec 08             	sub    $0x8,%esp
80105c66:	68 40 93 13 80       	push   $0x80139340
80105c6b:	53                   	push   %ebx
80105c6c:	e8 af e2 ff ff       	call   80103f20 <sleep>
    release(&lock);
80105c71:	c7 04 24 40 93 13 80 	movl   $0x80139340,(%esp)
80105c78:	e8 03 ea ff ff       	call   80104680 <release>
    acquire(&lock);
80105c7d:	83 c4 10             	add    $0x10,%esp
80105c80:	83 ec 0c             	sub    $0xc,%esp
80105c83:	68 40 93 13 80       	push   $0x80139340
80105c88:	e8 33 e9 ff ff       	call   801045c0 <acquire>
    val = deque(msg,me);
80105c8d:	58                   	pop    %eax
80105c8e:	5a                   	pop    %edx
80105c8f:	53                   	push   %ebx
80105c90:	ff 75 08             	pushl  0x8(%ebp)
80105c93:	e8 e8 fa ff ff       	call   80105780 <deque>
    if(val!=-1){
80105c98:	83 c4 10             	add    $0x10,%esp
80105c9b:	83 f8 ff             	cmp    $0xffffffff,%eax
80105c9e:	74 b8                	je     80105c58 <sys_recv+0x28>
      release(&lock);
80105ca0:	83 ec 0c             	sub    $0xc,%esp
80105ca3:	68 40 93 13 80       	push   $0x80139340
80105ca8:	e8 d3 e9 ff ff       	call   80104680 <release>
  }
  return 0;
}
...
80105cc7:	57                   	push   %edi
  ...
  // cprintf("%d\n",sender_pid);
  int j = 0;
80105cc8:	31 ff                	xor    %edi,%edi
int sys_send_multi(int sender_pid, int rec_pids[], void *msg){
80105cca:	56                   	push   %esi
  argint(0,&sender_pid);
80105ccb:	8d 45 08             	lea    0x8(%ebp),%eax
int sys_send_multi(int sender_pid, int rec_pids[], void *msg){
...
int sys_send_multi(int sender_pid, int rec_pids[], void *msg){
80105cd1:	83 ec 24             	sub    $0x24,%esp
  argint(0,&sender_pid);
80105cd4:	50                   	push   %eax
80105cd5:	6a 00                	push   $0x0
80105cd7:	e8 d4 ec ff ff       	call   801049b0 <argint>
  argptr(1,(char**)&rec_pids,n*sizeof(int));
80105cdc:	83 c4 0c             	add    $0xc,%esp
80105cdf:	8d 45 0c             	lea    0xc(%ebp),%eax
80105ce2:	6a 20                	push   $0x20
80105ce4:	50                   	push   %eax
80105ce5:	6a 01                	push   $0x1
80105ce7:	e8 14 ed ff ff       	call   80104a00 <argptr>
  argptr(2,(char**)&msg,MSSG_SIZE);
80105cec:	83 c4 0c             	add    $0xc,%esp
80105cef:	8d 45 10             	lea    0x10(%ebp),%eax
80105cf2:	6a 08                	push   $0x8
80105cf4:	50                   	push   %eax
80105cf5:	6a 02                	push   $0x2
80105cf7:	e8 04 ed ff ff       	call   80104a00 <argptr>
  acquire(&lock);
80105cfc:	c7 04 24 40 93 13 80 	movl   $0x80139340,(%esp)
80105d03:	e8 b8 e8 ff ff       	call   801045c0 <acquire>
80105d08:	83 c4 10             	add    $0x10,%esp
80105d0b:	eb 1b                	jmp    80105d28 <sys_send_multi+0x68>
80105d0d:	8d 76 00             	lea    0x0(%esi),%esi
  for(int i=0;i<BUFFER_SIZE && j<n;i++){
80105d10:	83 c3 01             	add    $0x1,%ebx
80105d13:	81 fb e7 03 00 00    	cmp    $0x3e7,%ebx
80105d19:	0f 8f a9 00 00 00    	jg     80105dc8 <sys_send_multi+0x108>
80105d1f:	83 ff 07             	cmp    $0x7,%edi
80105d22:	0f 8f a0 00 00 00    	jg     80105dc8 <sys_send_multi+0x108>
    if(recv_pids[i] <= 0){
80105d28:	8b 0c 9d c0 cc 12 80 	mov    -0x7fed3340(,%ebx,4),%ecx
80105d2f:	85 c9                	test   %ecx,%ecx
80105d31:	7f dd                	jg     80105d10 <sys_send_multi+0x50>
      sender_pids[i] = sender_pid;
80105d33:	8b 45 08             	mov    0x8(%ebp),%eax
  memmove(buffers[index], (char**)ch, MSSG_SIZE);
80105d36:	83 ec 04             	sub    $0x4,%esp
80105d39:	89 04 9d 60 dc 12 80 	mov    %eax,-0x7fed23a0(,%ebx,4)
      recv_pids[i] = rec_pids[j];
80105d40:	8b 45 0c             	mov    0xc(%ebp),%eax
80105d43:	8d 04 b8             	lea    (%eax,%edi,4),%eax
      enque(rec_pids[j], i,msg);
      cprintf("%s\n",buffers[i]);
      j++;
80105d46:	83 c7 01             	add    $0x1,%edi
      recv_pids[i] = rec_pids[j];
80105d49:	8b 10                	mov    (%eax),%edx
80105d4b:	89 14 9d c0 cc 12 80 	mov    %edx,-0x7fed3340(,%ebx,4)
      enque(rec_pids[j], i,msg);
80105d52:	8b 30                	mov    (%eax),%esi
80105d54:	8d 04 dd e0 b0 10 80 	lea    -0x7fef4f20(,%ebx,8),%eax
80105d5b:	6a 08                	push   $0x8
80105d5d:	ff 75 10             	pushl  0x10(%ebp)
80105d60:	50                   	push   %eax
80105d61:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105d64:	e8 07 ea ff ff       	call   80104770 <memmove>
  queue[pid][rear[pid]] = index;
80105d69:	69 c6 f4 01 00 00    	imul   $0x1f4,%esi,%eax
80105d6f:	8b 0c b5 c0 d6 10 80 	mov    -0x7fef2940(,%esi,4),%ecx
80105d76:	01 c8                	add    %ecx,%eax
  rear[pid] = (rear[pid] + 1) % MAX_QUEUE_SIZE;
80105d78:	83 c1 01             	add    $0x1,%ecx
  queue[pid][rear[pid]] = index;
80105d7b:	89 1c 85 c0 d8 10 80 	mov    %ebx,-0x7fef2740(,%eax,4)
  rear[pid] = (rear[pid] + 1) % MAX_QUEUE_SIZE;
80105d82:	b8 d3 4d 62 10       	mov    $0x10624dd3,%eax
  for(int i=0;i<BUFFER_SIZE && j<n;i++){
80105d87:	83 c3 01             	add    $0x1,%ebx
80105d8a:	f7 e9                	imul   %ecx
80105d8c:	89 c8                	mov    %ecx,%eax
80105d8e:	c1 f8 1f             	sar    $0x1f,%eax
80105d91:	c1 fa 05             	sar    $0x5,%edx
80105d94:	29 c2                	sub    %eax,%edx
      cprintf("%s\n",buffers[i]);
80105d96:	58                   	pop    %eax
80105d97:	69 d2 f4 01 00 00    	imul   $0x1f4,%edx,%edx
80105d9d:	29 d1                	sub    %edx,%ecx
80105d9f:	5a                   	pop    %edx
80105da0:	ff 75 e4             	pushl  -0x1c(%ebp)
80105da3:	68 9f 7c 10 80       	push   $0x80107c9f
80105da8:	89 0c b5 c0 d6 10 80 	mov    %ecx,-0x7fef2940(,%esi,4)
80105daf:	e8 fc a8 ff ff       	call   801006b0 <cprintf>
      j++;
80105db4:	83 c4 10             	add    $0x10,%esp
  for(int i=0;i<BUFFER_SIZE && j<n;i++){
80105db7:	81 fb e7 03 00 00    	cmp    $0x3e7,%ebx
80105dbd:	0f 8e 5c ff ff ff    	jle    80105d1f <sys_send_multi+0x5f>
...
80105dcd:	68 40 93 13 80       	push   $0x80139340
80105dd2:	e8 a9 e8 ff ff       	call   80104680 <release>
80105dd7:	83 c4 10             	add    $0x10,%esp
80105dda:	eb 0c                	jmp    80105de8 <sys_send_multi+0x128>
80105ddc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(int i=0;i<n;i++){
80105de0:	83 c3 04             	add    $0x4,%ebx
80105de3:	83 fb 20             	cmp    $0x20,%ebx
80105de6:	74 31                	je     80105e19 <sys_send_multi+0x159>
    if(wait_queue[rec_pids[i]]==1){
80105de8:	8b 45 0c             	mov    0xc(%ebp),%eax
80105deb:	01 d8                	add    %ebx,%eax
80105ded:	8b 10                	mov    (%eax),%edx
80105def:	83 3c 95 c0 d5 10 80 	cmpl   $0x1,-0x7fef2a40(,%edx,4)
80105df6:	01 
80105df7:	75 e7                	jne    80105de0 <sys_send_multi+0x120>
      wait_queue[rec_pids[i]]=0;
      wakeup((void*)rec_pids[i]);
80105df9:	83 ec 0c             	sub    $0xc,%esp
80105dfc:	83 c3 04             	add    $0x4,%ebx
      wait_queue[rec_pids[i]]=0;
80105dff:	c7 04 95 c0 d5 10 80 	movl   $0x0,-0x7fef2a40(,%edx,4)
80105e06:	00 00 00 00 
      wakeup((void*)rec_pids[i]);
80105e0a:	ff 30                	pushl  (%eax)
80105e0c:	e8 cf e2 ff ff       	call   801040e0 <wakeup>
80105e11:	83 c4 10             	add    $0x10,%esp
  for(int i=0;i<n;i++){
80105e14:	83 fb 20             	cmp    $0x20,%ebx
80105e17:	75 cf                	jne    80105de8 <sys_send_multi+0x128>
    }
  }
  return 0;
...
80105e24:	06                   	push   %es
  pushl %fs
80105e25:	0f a0                	push   %fs
  pushl %gs
80105e27:	0f a8                	push   %gs
  pushal
80105e29:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105e2a:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105e2e:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105e30:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105e32:	54                   	push   %esp
  call trap
80105e33:	e8 c8 00 00 00       	call   80105f00 <trap>
  addl $4, %esp
80105e38:	83 c4 04             	add    $0x4,%esp
...
80105e3b:	61                   	popa   
  popl %gs
80105e3c:	0f a9                	pop    %gs
  popl %fs
80105e3e:	0f a1                	pop    %fs
  popl %es
80105e40:	07                   	pop    %es
  popl %ds
80105e41:	1f                   	pop    %ds
...
80105e60:	8b 14 85 20 d0 10 80 	mov    -0x7fef2fe0(,%eax,4),%edx
80105e67:	c7 04 c5 c2 93 13 80 	movl   $0x8e000008,-0x7fec6c3e(,%eax,8)
80105e6e:	08 00 00 8e 
80105e72:	66 89 14 c5 c0 93 13 	mov    %dx,-0x7fec6c40(,%eax,8)
80105e79:	80 
80105e7a:	c1 ea 10             	shr    $0x10,%edx
80105e7d:	66 89 14 c5 c6 93 13 	mov    %dx,-0x7fec6c3a(,%eax,8)
80105e84:	80 
  for(i = 0; i < 256; i++)
...
80105e8f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105e92:	a1 20 d1 10 80       	mov    0x8010d120,%eax
80105e97:	c7 05 c2 95 13 80 08 	movl   $0xef000008,0x801395c2
80105e9e:	00 00 ef 
  initlock(&tickslock, "time");
80105ea1:	68 d7 7e 10 80       	push   $0x80107ed7
80105ea6:	68 80 93 13 80       	push   $0x80139380
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105eab:	66 a3 c0 95 13 80    	mov    %ax,0x801395c0
80105eb1:	c1 e8 10             	shr    $0x10,%eax
80105eb4:	66 a3 c6 95 13 80    	mov    %ax,0x801395c6
  initlock(&tickslock, "time");
80105eba:	e8 81 e5 ff ff       	call   80104440 <initlock>
}
...
80105edf:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105ee3:	b8 c0 93 13 80       	mov    $0x801393c0,%eax
...
80105f24:	3e ff 24 85 c4 7f 10 	notrack jmp *-0x7fef803c(,%eax,4)
80105f2b:	80 
    lapiceoi();
    break;
...
80105f2c:	e8 2f da ff ff       	call   80103960 <myproc>
...
80105f4c:	e8 ef d9 ff ff       	call   80103940 <cpuid>
...
80105f5d:	e8 fe d9 ff ff       	call   80103960 <myproc>
80105f62:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105f65:	e8 f6 d9 ff ff       	call   80103960 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105f81:	68 80 7f 10 80       	push   $0x80107f80
80105f86:	e8 25 a7 ff ff       	call   801006b0 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105f8b:	83 c4 20             	add    $0x20,%esp
80105f8e:	e8 cd d9 ff ff       	call   80103960 <myproc>
...
80105f9a:	e8 c1 d9 ff ff       	call   80103960 <myproc>
80105f9f:	85 c0                	test   %eax,%eax
80105fa1:	74 1d                	je     80105fc0 <trap+0xc0>
80105fa3:	e8 b8 d9 ff ff       	call   80103960 <myproc>
...
80105fc0:	e8 9b d9 ff ff       	call   80103960 <myproc>
80105fc5:	85 c0                	test   %eax,%eax
80105fc7:	74 0f                	je     80105fd8 <trap+0xd8>
80105fc9:	e8 92 d9 ff ff       	call   80103960 <myproc>
...
80105fd2:	0f 84 e8 00 00 00    	je     801060c0 <trap+0x1c0>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105fd8:	e8 83 d9 ff ff       	call   80103960 <myproc>
80105fdd:	85 c0                	test   %eax,%eax
80105fdf:	74 1d                	je     80105ffe <trap+0xfe>
80105fe1:	e8 7a d9 ff ff       	call   80103960 <myproc>
...
80106005:	c3                   	ret    
    ideintr();
80106006:	e8 d5 c1 ff ff       	call   801021e0 <ideintr>
    lapiceoi();
8010600b:	e8 b0 c8 ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
...
80106019:	eb a5                	jmp    80105fc0 <trap+0xc0>
    if(cpuid() == 0){
8010601b:	e8 20 d9 ff ff       	call   80103940 <cpuid>
80106020:	85 c0                	test   %eax,%eax
80106022:	75 e7                	jne    8010600b <trap+0x10b>
      acquire(&tickslock);
80106024:	83 ec 0c             	sub    $0xc,%esp
80106027:	68 80 93 13 80       	push   $0x80139380
8010602c:	e8 8f e5 ff ff       	call   801045c0 <acquire>
      wakeup(&ticks);
80106031:	c7 04 24 c0 9b 13 80 	movl   $0x80139bc0,(%esp)
      ticks++;
80106038:	83 05 c0 9b 13 80 01 	addl   $0x1,0x80139bc0
      wakeup(&ticks);
8010603f:	e8 9c e0 ff ff       	call   801040e0 <wakeup>
      release(&tickslock);
80106044:	c7 04 24 80 93 13 80 	movl   $0x80139380,(%esp)
8010604b:	e8 30 e6 ff ff       	call   80104680 <release>
80106050:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80106053:	eb b6                	jmp    8010600b <trap+0x10b>
    kbdintr();
80106055:	e8 26 c7 ff ff       	call   80102780 <kbdintr>
    lapiceoi();
8010605a:	e8 61 c8 ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010605f:	e8 fc d8 ff ff       	call   80103960 <myproc>
...
80106071:	e8 4a 02 00 00       	call   801062c0 <uartintr>
    lapiceoi();
80106076:	e8 45 c8 ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010607b:	e8 e0 d8 ff ff       	call   80103960 <myproc>
...
80106094:	e8 a7 d8 ff ff       	call   80103940 <cpuid>
80106099:	57                   	push   %edi
8010609a:	56                   	push   %esi
8010609b:	50                   	push   %eax
8010609c:	68 28 7f 10 80       	push   $0x80107f28
801060a1:	e8 0a a6 ff ff       	call   801006b0 <cprintf>
    lapiceoi();
801060a6:	e8 15 c8 ff ff       	call   801028c0 <lapiceoi>
    break;
801060ab:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801060ae:	e8 ad d8 ff ff       	call   80103960 <myproc>
...
80106138:	68 4c 7f 10 80       	push   $0x80107f4c
8010613d:	e8 6e a5 ff ff       	call   801006b0 <cprintf>
      panic("trap");
80106142:	83 c4 14             	add    $0x14,%esp
80106145:	68 21 7f 10 80       	push   $0x80107f21
...
80106150:	f3 0f 1e fb          	endbr32 
  if(!uart)
80106154:	a1 00 ec 12 80       	mov    0x8012ec00,%eax
...
801061a5:	e8 36 c7 ff ff       	call   801028e0 <microdelay>
...
8010622b:	74 52                	je     8010627f <uartinit+0xaf>
  uart = 1;
8010622d:	c7 05 00 ec 12 80 01 	movl   $0x1,0x8012ec00
80106234:	00 00 00 
...
80106243:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80106248:	bb 44 80 10 80       	mov    $0x80108044,%ebx
  ioapicenable(IRQ_COM1, 0);
8010624d:	6a 00                	push   $0x0
8010624f:	6a 04                	push   $0x4
80106251:	e8 da c1 ff ff       	call   80102430 <ioapicenable>
...
80106260:	0f b6 73 01          	movzbl 0x1(%ebx),%esi
  if(!uart)
80106264:	8b 15 00 ec 12 80    	mov    0x8012ec00,%edx
...
80106294:	55                   	push   %ebp
  if(!uart)
80106295:	8b 15 00 ec 12 80    	mov    0x8012ec00,%edx
{
...
801062cf:	e8 8c a5 ff ff       	call   80100860 <consoleintr>
}
...
801062db:	6a 00                	push   $0x0
  jmp alltraps
801062dd:	e9 41 fb ff ff       	jmp    80105e23 <alltraps>
...
801062e4:	6a 01                	push   $0x1
  jmp alltraps
801062e6:	e9 38 fb ff ff       	jmp    80105e23 <alltraps>
...
801062ed:	6a 02                	push   $0x2
  jmp alltraps
801062ef:	e9 2f fb ff ff       	jmp    80105e23 <alltraps>
...
801062f6:	6a 03                	push   $0x3
  jmp alltraps
801062f8:	e9 26 fb ff ff       	jmp    80105e23 <alltraps>
...
801062ff:	6a 04                	push   $0x4
  jmp alltraps
80106301:	e9 1d fb ff ff       	jmp    80105e23 <alltraps>
...
80106308:	6a 05                	push   $0x5
  jmp alltraps
8010630a:	e9 14 fb ff ff       	jmp    80105e23 <alltraps>
...
80106311:	6a 06                	push   $0x6
  jmp alltraps
80106313:	e9 0b fb ff ff       	jmp    80105e23 <alltraps>
...
8010631a:	6a 07                	push   $0x7
  jmp alltraps
8010631c:	e9 02 fb ff ff       	jmp    80105e23 <alltraps>
...
80106321:	6a 08                	push   $0x8
  jmp alltraps
80106323:	e9 fb fa ff ff       	jmp    80105e23 <alltraps>
...
8010632a:	6a 09                	push   $0x9
  jmp alltraps
8010632c:	e9 f2 fa ff ff       	jmp    80105e23 <alltraps>
...
80106331:	6a 0a                	push   $0xa
  jmp alltraps
80106333:	e9 eb fa ff ff       	jmp    80105e23 <alltraps>
...
80106338:	6a 0b                	push   $0xb
  jmp alltraps
8010633a:	e9 e4 fa ff ff       	jmp    80105e23 <alltraps>
...
8010633f:	6a 0c                	push   $0xc
  jmp alltraps
80106341:	e9 dd fa ff ff       	jmp    80105e23 <alltraps>
...
80106346:	6a 0d                	push   $0xd
  jmp alltraps
80106348:	e9 d6 fa ff ff       	jmp    80105e23 <alltraps>
...
8010634d:	6a 0e                	push   $0xe
  jmp alltraps
8010634f:	e9 cf fa ff ff       	jmp    80105e23 <alltraps>
...
80106356:	6a 0f                	push   $0xf
  jmp alltraps
80106358:	e9 c6 fa ff ff       	jmp    80105e23 <alltraps>
...
8010635f:	6a 10                	push   $0x10
  jmp alltraps
80106361:	e9 bd fa ff ff       	jmp    80105e23 <alltraps>
...
80106366:	6a 11                	push   $0x11
  jmp alltraps
80106368:	e9 b6 fa ff ff       	jmp    80105e23 <alltraps>
...
8010636f:	6a 12                	push   $0x12
  jmp alltraps
80106371:	e9 ad fa ff ff       	jmp    80105e23 <alltraps>
...
80106378:	6a 13                	push   $0x13
  jmp alltraps
8010637a:	e9 a4 fa ff ff       	jmp    80105e23 <alltraps>
...
80106381:	6a 14                	push   $0x14
  jmp alltraps
80106383:	e9 9b fa ff ff       	jmp    80105e23 <alltraps>
...
8010638a:	6a 15                	push   $0x15
  jmp alltraps
8010638c:	e9 92 fa ff ff       	jmp    80105e23 <alltraps>
...
80106393:	6a 16                	push   $0x16
  jmp alltraps
80106395:	e9 89 fa ff ff       	jmp    80105e23 <alltraps>
...
8010639c:	6a 17                	push   $0x17
  jmp alltraps
8010639e:	e9 80 fa ff ff       	jmp    80105e23 <alltraps>
...
801063a5:	6a 18                	push   $0x18
  jmp alltraps
801063a7:	e9 77 fa ff ff       	jmp    80105e23 <alltraps>
...
801063ae:	6a 19                	push   $0x19
  jmp alltraps
801063b0:	e9 6e fa ff ff       	jmp    80105e23 <alltraps>
...
801063b7:	6a 1a                	push   $0x1a
  jmp alltraps
801063b9:	e9 65 fa ff ff       	jmp    80105e23 <alltraps>
...
801063c0:	6a 1b                	push   $0x1b
  jmp alltraps
801063c2:	e9 5c fa ff ff       	jmp    80105e23 <alltraps>
...
801063c9:	6a 1c                	push   $0x1c
  jmp alltraps
801063cb:	e9 53 fa ff ff       	jmp    80105e23 <alltraps>
...
801063d2:	6a 1d                	push   $0x1d
  jmp alltraps
801063d4:	e9 4a fa ff ff       	jmp    80105e23 <alltraps>
...
801063db:	6a 1e                	push   $0x1e
  jmp alltraps
801063dd:	e9 41 fa ff ff       	jmp    80105e23 <alltraps>
...
801063e4:	6a 1f                	push   $0x1f
  jmp alltraps
801063e6:	e9 38 fa ff ff       	jmp    80105e23 <alltraps>
...
801063ed:	6a 20                	push   $0x20
  jmp alltraps
801063ef:	e9 2f fa ff ff       	jmp    80105e23 <alltraps>
...
801063f6:	6a 21                	push   $0x21
  jmp alltraps
801063f8:	e9 26 fa ff ff       	jmp    80105e23 <alltraps>
...
801063ff:	6a 22                	push   $0x22
  jmp alltraps
80106401:	e9 1d fa ff ff       	jmp    80105e23 <alltraps>
...
80106408:	6a 23                	push   $0x23
  jmp alltraps
8010640a:	e9 14 fa ff ff       	jmp    80105e23 <alltraps>
...
80106411:	6a 24                	push   $0x24
  jmp alltraps
80106413:	e9 0b fa ff ff       	jmp    80105e23 <alltraps>
...
8010641a:	6a 25                	push   $0x25
  jmp alltraps
8010641c:	e9 02 fa ff ff       	jmp    80105e23 <alltraps>
...
80106423:	6a 26                	push   $0x26
  jmp alltraps
80106425:	e9 f9 f9 ff ff       	jmp    80105e23 <alltraps>
...
8010642c:	6a 27                	push   $0x27
  jmp alltraps
8010642e:	e9 f0 f9 ff ff       	jmp    80105e23 <alltraps>
...
80106435:	6a 28                	push   $0x28
  jmp alltraps
80106437:	e9 e7 f9 ff ff       	jmp    80105e23 <alltraps>
...
8010643e:	6a 29                	push   $0x29
  jmp alltraps
80106440:	e9 de f9 ff ff       	jmp    80105e23 <alltraps>
...
80106447:	6a 2a                	push   $0x2a
  jmp alltraps
80106449:	e9 d5 f9 ff ff       	jmp    80105e23 <alltraps>
...
80106450:	6a 2b                	push   $0x2b
  jmp alltraps
80106452:	e9 cc f9 ff ff       	jmp    80105e23 <alltraps>
...
80106459:	6a 2c                	push   $0x2c
  jmp alltraps
8010645b:	e9 c3 f9 ff ff       	jmp    80105e23 <alltraps>
...
80106462:	6a 2d                	push   $0x2d
  jmp alltraps
80106464:	e9 ba f9 ff ff       	jmp    80105e23 <alltraps>
...
8010646b:	6a 2e                	push   $0x2e
  jmp alltraps
8010646d:	e9 b1 f9 ff ff       	jmp    80105e23 <alltraps>
...
80106474:	6a 2f                	push   $0x2f
  jmp alltraps
80106476:	e9 a8 f9 ff ff       	jmp    80105e23 <alltraps>
...
8010647d:	6a 30                	push   $0x30
  jmp alltraps
8010647f:	e9 9f f9 ff ff       	jmp    80105e23 <alltraps>
...
80106486:	6a 31                	push   $0x31
  jmp alltraps
80106488:	e9 96 f9 ff ff       	jmp    80105e23 <alltraps>
...
8010648f:	6a 32                	push   $0x32
  jmp alltraps
80106491:	e9 8d f9 ff ff       	jmp    80105e23 <alltraps>
...
80106498:	6a 33                	push   $0x33
  jmp alltraps
8010649a:	e9 84 f9 ff ff       	jmp    80105e23 <alltraps>
...
801064a1:	6a 34                	push   $0x34
  jmp alltraps
801064a3:	e9 7b f9 ff ff       	jmp    80105e23 <alltraps>
...
801064aa:	6a 35                	push   $0x35
  jmp alltraps
801064ac:	e9 72 f9 ff ff       	jmp    80105e23 <alltraps>
...
801064b3:	6a 36                	push   $0x36
  jmp alltraps
801064b5:	e9 69 f9 ff ff       	jmp    80105e23 <alltraps>
...
801064bc:	6a 37                	push   $0x37
  jmp alltraps
801064be:	e9 60 f9 ff ff       	jmp    80105e23 <alltraps>
...
801064c5:	6a 38                	push   $0x38
  jmp alltraps
801064c7:	e9 57 f9 ff ff       	jmp    80105e23 <alltraps>
...
801064ce:	6a 39                	push   $0x39
  jmp alltraps
801064d0:	e9 4e f9 ff ff       	jmp    80105e23 <alltraps>
...
801064d7:	6a 3a                	push   $0x3a
  jmp alltraps
801064d9:	e9 45 f9 ff ff       	jmp    80105e23 <alltraps>
...
801064e0:	6a 3b                	push   $0x3b
  jmp alltraps
801064e2:	e9 3c f9 ff ff       	jmp    80105e23 <alltraps>
...
801064e9:	6a 3c                	push   $0x3c
  jmp alltraps
801064eb:	e9 33 f9 ff ff       	jmp    80105e23 <alltraps>
...
801064f2:	6a 3d                	push   $0x3d
  jmp alltraps
801064f4:	e9 2a f9 ff ff       	jmp    80105e23 <alltraps>
...
801064fb:	6a 3e                	push   $0x3e
  jmp alltraps
801064fd:	e9 21 f9 ff ff       	jmp    80105e23 <alltraps>
...
80106504:	6a 3f                	push   $0x3f
  jmp alltraps
80106506:	e9 18 f9 ff ff       	jmp    80105e23 <alltraps>
...
8010650d:	6a 40                	push   $0x40
  jmp alltraps
8010650f:	e9 0f f9 ff ff       	jmp    80105e23 <alltraps>
...
80106516:	6a 41                	push   $0x41
  jmp alltraps
80106518:	e9 06 f9 ff ff       	jmp    80105e23 <alltraps>
...
8010651f:	6a 42                	push   $0x42
  jmp alltraps
80106521:	e9 fd f8 ff ff       	jmp    80105e23 <alltraps>
...
80106528:	6a 43                	push   $0x43
  jmp alltraps
8010652a:	e9 f4 f8 ff ff       	jmp    80105e23 <alltraps>
...
80106531:	6a 44                	push   $0x44
  jmp alltraps
80106533:	e9 eb f8 ff ff       	jmp    80105e23 <alltraps>
...
8010653a:	6a 45                	push   $0x45
  jmp alltraps
8010653c:	e9 e2 f8 ff ff       	jmp    80105e23 <alltraps>
...
80106543:	6a 46                	push   $0x46
  jmp alltraps
80106545:	e9 d9 f8 ff ff       	jmp    80105e23 <alltraps>
...
8010654c:	6a 47                	push   $0x47
  jmp alltraps
8010654e:	e9 d0 f8 ff ff       	jmp    80105e23 <alltraps>
...
80106555:	6a 48                	push   $0x48
  jmp alltraps
80106557:	e9 c7 f8 ff ff       	jmp    80105e23 <alltraps>
...
8010655e:	6a 49                	push   $0x49
  jmp alltraps
80106560:	e9 be f8 ff ff       	jmp    80105e23 <alltraps>
...
80106567:	6a 4a                	push   $0x4a
  jmp alltraps
80106569:	e9 b5 f8 ff ff       	jmp    80105e23 <alltraps>
...
80106570:	6a 4b                	push   $0x4b
  jmp alltraps
80106572:	e9 ac f8 ff ff       	jmp    80105e23 <alltraps>
...
80106579:	6a 4c                	push   $0x4c
  jmp alltraps
8010657b:	e9 a3 f8 ff ff       	jmp    80105e23 <alltraps>
...
80106582:	6a 4d                	push   $0x4d
  jmp alltraps
80106584:	e9 9a f8 ff ff       	jmp    80105e23 <alltraps>
...
8010658b:	6a 4e                	push   $0x4e
  jmp alltraps
8010658d:	e9 91 f8 ff ff       	jmp    80105e23 <alltraps>
...
80106594:	6a 4f                	push   $0x4f
  jmp alltraps
80106596:	e9 88 f8 ff ff       	jmp    80105e23 <alltraps>
...
8010659d:	6a 50                	push   $0x50
  jmp alltraps
8010659f:	e9 7f f8 ff ff       	jmp    80105e23 <alltraps>
...
801065a6:	6a 51                	push   $0x51
  jmp alltraps
801065a8:	e9 76 f8 ff ff       	jmp    80105e23 <alltraps>
...
801065af:	6a 52                	push   $0x52
  jmp alltraps
801065b1:	e9 6d f8 ff ff       	jmp    80105e23 <alltraps>
...
801065b8:	6a 53                	push   $0x53
  jmp alltraps
801065ba:	e9 64 f8 ff ff       	jmp    80105e23 <alltraps>
...
801065c1:	6a 54                	push   $0x54
  jmp alltraps
801065c3:	e9 5b f8 ff ff       	jmp    80105e23 <alltraps>
...
801065ca:	6a 55                	push   $0x55
  jmp alltraps
801065cc:	e9 52 f8 ff ff       	jmp    80105e23 <alltraps>
...
801065d3:	6a 56                	push   $0x56
  jmp alltraps
801065d5:	e9 49 f8 ff ff       	jmp    80105e23 <alltraps>
...
801065dc:	6a 57                	push   $0x57
  jmp alltraps
801065de:	e9 40 f8 ff ff       	jmp    80105e23 <alltraps>
...
801065e5:	6a 58                	push   $0x58
  jmp alltraps
801065e7:	e9 37 f8 ff ff       	jmp    80105e23 <alltraps>
...
801065ee:	6a 59                	push   $0x59
  jmp alltraps
801065f0:	e9 2e f8 ff ff       	jmp    80105e23 <alltraps>
...
801065f7:	6a 5a                	push   $0x5a
  jmp alltraps
801065f9:	e9 25 f8 ff ff       	jmp    80105e23 <alltraps>
...
80106600:	6a 5b                	push   $0x5b
  jmp alltraps
80106602:	e9 1c f8 ff ff       	jmp    80105e23 <alltraps>
...
80106609:	6a 5c                	push   $0x5c
  jmp alltraps
8010660b:	e9 13 f8 ff ff       	jmp    80105e23 <alltraps>
...
80106612:	6a 5d                	push   $0x5d
  jmp alltraps
80106614:	e9 0a f8 ff ff       	jmp    80105e23 <alltraps>
...
8010661b:	6a 5e                	push   $0x5e
  jmp alltraps
8010661d:	e9 01 f8 ff ff       	jmp    80105e23 <alltraps>
...
80106624:	6a 5f                	push   $0x5f
  jmp alltraps
80106626:	e9 f8 f7 ff ff       	jmp    80105e23 <alltraps>
...
8010662d:	6a 60                	push   $0x60
  jmp alltraps
8010662f:	e9 ef f7 ff ff       	jmp    80105e23 <alltraps>
...
80106636:	6a 61                	push   $0x61
  jmp alltraps
80106638:	e9 e6 f7 ff ff       	jmp    80105e23 <alltraps>
...
8010663f:	6a 62                	push   $0x62
  jmp alltraps
80106641:	e9 dd f7 ff ff       	jmp    80105e23 <alltraps>
...
80106648:	6a 63                	push   $0x63
  jmp alltraps
8010664a:	e9 d4 f7 ff ff       	jmp    80105e23 <alltraps>
...
80106651:	6a 64                	push   $0x64
  jmp alltraps
80106653:	e9 cb f7 ff ff       	jmp    80105e23 <alltraps>
...
8010665a:	6a 65                	push   $0x65
  jmp alltraps
8010665c:	e9 c2 f7 ff ff       	jmp    80105e23 <alltraps>
...
80106663:	6a 66                	push   $0x66
  jmp alltraps
80106665:	e9 b9 f7 ff ff       	jmp    80105e23 <alltraps>
...
8010666c:	6a 67                	push   $0x67
  jmp alltraps
8010666e:	e9 b0 f7 ff ff       	jmp    80105e23 <alltraps>
...
80106675:	6a 68                	push   $0x68
  jmp alltraps
80106677:	e9 a7 f7 ff ff       	jmp    80105e23 <alltraps>
...
8010667e:	6a 69                	push   $0x69
  jmp alltraps
80106680:	e9 9e f7 ff ff       	jmp    80105e23 <alltraps>
...
80106687:	6a 6a                	push   $0x6a
  jmp alltraps
80106689:	e9 95 f7 ff ff       	jmp    80105e23 <alltraps>
...
80106690:	6a 6b                	push   $0x6b
  jmp alltraps
80106692:	e9 8c f7 ff ff       	jmp    80105e23 <alltraps>
...
80106699:	6a 6c                	push   $0x6c
  jmp alltraps
8010669b:	e9 83 f7 ff ff       	jmp    80105e23 <alltraps>
...
801066a2:	6a 6d                	push   $0x6d
  jmp alltraps
801066a4:	e9 7a f7 ff ff       	jmp    80105e23 <alltraps>
...
801066ab:	6a 6e                	push   $0x6e
  jmp alltraps
801066ad:	e9 71 f7 ff ff       	jmp    80105e23 <alltraps>
...
801066b4:	6a 6f                	push   $0x6f
  jmp alltraps
801066b6:	e9 68 f7 ff ff       	jmp    80105e23 <alltraps>
...
801066bd:	6a 70                	push   $0x70
  jmp alltraps
801066bf:	e9 5f f7 ff ff       	jmp    80105e23 <alltraps>
...
801066c6:	6a 71                	push   $0x71
  jmp alltraps
801066c8:	e9 56 f7 ff ff       	jmp    80105e23 <alltraps>
...
801066cf:	6a 72                	push   $0x72
  jmp alltraps
801066d1:	e9 4d f7 ff ff       	jmp    80105e23 <alltraps>
...
801066d8:	6a 73                	push   $0x73
  jmp alltraps
801066da:	e9 44 f7 ff ff       	jmp    80105e23 <alltraps>
...
801066e1:	6a 74                	push   $0x74
  jmp alltraps
801066e3:	e9 3b f7 ff ff       	jmp    80105e23 <alltraps>
...
801066ea:	6a 75                	push   $0x75
  jmp alltraps
801066ec:	e9 32 f7 ff ff       	jmp    80105e23 <alltraps>
...
801066f3:	6a 76                	push   $0x76
  jmp alltraps
801066f5:	e9 29 f7 ff ff       	jmp    80105e23 <alltraps>
...
801066fc:	6a 77                	push   $0x77
  jmp alltraps
801066fe:	e9 20 f7 ff ff       	jmp    80105e23 <alltraps>
...
80106705:	6a 78                	push   $0x78
  jmp alltraps
80106707:	e9 17 f7 ff ff       	jmp    80105e23 <alltraps>
...
8010670e:	6a 79                	push   $0x79
  jmp alltraps
80106710:	e9 0e f7 ff ff       	jmp    80105e23 <alltraps>
...
80106717:	6a 7a                	push   $0x7a
  jmp alltraps
80106719:	e9 05 f7 ff ff       	jmp    80105e23 <alltraps>
...
80106720:	6a 7b                	push   $0x7b
  jmp alltraps
80106722:	e9 fc f6 ff ff       	jmp    80105e23 <alltraps>
...
80106729:	6a 7c                	push   $0x7c
  jmp alltraps
8010672b:	e9 f3 f6 ff ff       	jmp    80105e23 <alltraps>
...
80106732:	6a 7d                	push   $0x7d
  jmp alltraps
80106734:	e9 ea f6 ff ff       	jmp    80105e23 <alltraps>
...
8010673b:	6a 7e                	push   $0x7e
  jmp alltraps
8010673d:	e9 e1 f6 ff ff       	jmp    80105e23 <alltraps>
...
80106744:	6a 7f                	push   $0x7f
  jmp alltraps
80106746:	e9 d8 f6 ff ff       	jmp    80105e23 <alltraps>
...
8010674d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106752:	e9 cc f6 ff ff       	jmp    80105e23 <alltraps>
...
80106759:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010675e:	e9 c0 f6 ff ff       	jmp    80105e23 <alltraps>
...
80106765:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010676a:	e9 b4 f6 ff ff       	jmp    80105e23 <alltraps>
...
80106771:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106776:	e9 a8 f6 ff ff       	jmp    80105e23 <alltraps>
...
8010677d:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106782:	e9 9c f6 ff ff       	jmp    80105e23 <alltraps>
...
80106789:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010678e:	e9 90 f6 ff ff       	jmp    80105e23 <alltraps>
...
80106795:	68 86 00 00 00       	push   $0x86
  jmp alltraps
8010679a:	e9 84 f6 ff ff       	jmp    80105e23 <alltraps>
...
801067a1:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801067a6:	e9 78 f6 ff ff       	jmp    80105e23 <alltraps>
...
801067ad:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801067b2:	e9 6c f6 ff ff       	jmp    80105e23 <alltraps>
...
801067b9:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801067be:	e9 60 f6 ff ff       	jmp    80105e23 <alltraps>
...
801067c5:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801067ca:	e9 54 f6 ff ff       	jmp    80105e23 <alltraps>
...
801067d1:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801067d6:	e9 48 f6 ff ff       	jmp    80105e23 <alltraps>
...
801067dd:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801067e2:	e9 3c f6 ff ff       	jmp    80105e23 <alltraps>
...
801067e9:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801067ee:	e9 30 f6 ff ff       	jmp    80105e23 <alltraps>
...
801067f5:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801067fa:	e9 24 f6 ff ff       	jmp    80105e23 <alltraps>
...
80106801:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106806:	e9 18 f6 ff ff       	jmp    80105e23 <alltraps>
...
8010680d:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80106812:	e9 0c f6 ff ff       	jmp    80105e23 <alltraps>
...
80106819:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010681e:	e9 00 f6 ff ff       	jmp    80105e23 <alltraps>
...
80106825:	68 92 00 00 00       	push   $0x92
  jmp alltraps
8010682a:	e9 f4 f5 ff ff       	jmp    80105e23 <alltraps>
...
80106831:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106836:	e9 e8 f5 ff ff       	jmp    80105e23 <alltraps>
...
8010683d:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106842:	e9 dc f5 ff ff       	jmp    80105e23 <alltraps>
...
80106849:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010684e:	e9 d0 f5 ff ff       	jmp    80105e23 <alltraps>
...
80106855:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010685a:	e9 c4 f5 ff ff       	jmp    80105e23 <alltraps>
...
80106861:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106866:	e9 b8 f5 ff ff       	jmp    80105e23 <alltraps>
...
8010686d:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106872:	e9 ac f5 ff ff       	jmp    80105e23 <alltraps>
...
80106879:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010687e:	e9 a0 f5 ff ff       	jmp    80105e23 <alltraps>
...
80106885:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010688a:	e9 94 f5 ff ff       	jmp    80105e23 <alltraps>
...
80106891:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106896:	e9 88 f5 ff ff       	jmp    80105e23 <alltraps>
...
8010689d:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801068a2:	e9 7c f5 ff ff       	jmp    80105e23 <alltraps>
...
801068a9:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801068ae:	e9 70 f5 ff ff       	jmp    80105e23 <alltraps>
...
801068b5:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801068ba:	e9 64 f5 ff ff       	jmp    80105e23 <alltraps>
...
801068c1:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801068c6:	e9 58 f5 ff ff       	jmp    80105e23 <alltraps>
...
801068cd:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801068d2:	e9 4c f5 ff ff       	jmp    80105e23 <alltraps>
...
801068d9:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801068de:	e9 40 f5 ff ff       	jmp    80105e23 <alltraps>
...
801068e5:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801068ea:	e9 34 f5 ff ff       	jmp    80105e23 <alltraps>
...
801068f1:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801068f6:	e9 28 f5 ff ff       	jmp    80105e23 <alltraps>
...
801068fd:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80106902:	e9 1c f5 ff ff       	jmp    80105e23 <alltraps>
...
80106909:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010690e:	e9 10 f5 ff ff       	jmp    80105e23 <alltraps>
...
80106915:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
8010691a:	e9 04 f5 ff ff       	jmp    80105e23 <alltraps>
...
80106921:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106926:	e9 f8 f4 ff ff       	jmp    80105e23 <alltraps>
...
8010692d:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80106932:	e9 ec f4 ff ff       	jmp    80105e23 <alltraps>
...
80106939:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010693e:	e9 e0 f4 ff ff       	jmp    80105e23 <alltraps>
...
80106945:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010694a:	e9 d4 f4 ff ff       	jmp    80105e23 <alltraps>
...
80106951:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106956:	e9 c8 f4 ff ff       	jmp    80105e23 <alltraps>
...
8010695d:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80106962:	e9 bc f4 ff ff       	jmp    80105e23 <alltraps>
...
80106969:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010696e:	e9 b0 f4 ff ff       	jmp    80105e23 <alltraps>
...
80106975:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010697a:	e9 a4 f4 ff ff       	jmp    80105e23 <alltraps>
...
80106981:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106986:	e9 98 f4 ff ff       	jmp    80105e23 <alltraps>
...
8010698d:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80106992:	e9 8c f4 ff ff       	jmp    80105e23 <alltraps>
...
80106999:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010699e:	e9 80 f4 ff ff       	jmp    80105e23 <alltraps>
...
801069a5:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801069aa:	e9 74 f4 ff ff       	jmp    80105e23 <alltraps>
...
801069b1:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801069b6:	e9 68 f4 ff ff       	jmp    80105e23 <alltraps>
...
801069bd:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801069c2:	e9 5c f4 ff ff       	jmp    80105e23 <alltraps>
...
801069c9:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801069ce:	e9 50 f4 ff ff       	jmp    80105e23 <alltraps>
...
801069d5:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801069da:	e9 44 f4 ff ff       	jmp    80105e23 <alltraps>
...
801069e1:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801069e6:	e9 38 f4 ff ff       	jmp    80105e23 <alltraps>
...
801069ed:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801069f2:	e9 2c f4 ff ff       	jmp    80105e23 <alltraps>
...
801069f9:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801069fe:	e9 20 f4 ff ff       	jmp    80105e23 <alltraps>
...
80106a05:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106a0a:	e9 14 f4 ff ff       	jmp    80105e23 <alltraps>
...
80106a11:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106a16:	e9 08 f4 ff ff       	jmp    80105e23 <alltraps>
...
80106a1d:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80106a22:	e9 fc f3 ff ff       	jmp    80105e23 <alltraps>
...
80106a29:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80106a2e:	e9 f0 f3 ff ff       	jmp    80105e23 <alltraps>
...
80106a35:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106a3a:	e9 e4 f3 ff ff       	jmp    80105e23 <alltraps>
...
80106a41:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106a46:	e9 d8 f3 ff ff       	jmp    80105e23 <alltraps>
...
80106a4d:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106a52:	e9 cc f3 ff ff       	jmp    80105e23 <alltraps>
...
80106a59:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106a5e:	e9 c0 f3 ff ff       	jmp    80105e23 <alltraps>
...
80106a65:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106a6a:	e9 b4 f3 ff ff       	jmp    80105e23 <alltraps>
...
80106a71:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106a76:	e9 a8 f3 ff ff       	jmp    80105e23 <alltraps>
...
80106a7d:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106a82:	e9 9c f3 ff ff       	jmp    80105e23 <alltraps>
...
80106a89:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106a8e:	e9 90 f3 ff ff       	jmp    80105e23 <alltraps>
...
80106a95:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106a9a:	e9 84 f3 ff ff       	jmp    80105e23 <alltraps>
...
80106aa1:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106aa6:	e9 78 f3 ff ff       	jmp    80105e23 <alltraps>
...
80106aad:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106ab2:	e9 6c f3 ff ff       	jmp    80105e23 <alltraps>
...
80106ab9:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106abe:	e9 60 f3 ff ff       	jmp    80105e23 <alltraps>
...
80106ac5:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106aca:	e9 54 f3 ff ff       	jmp    80105e23 <alltraps>
...
80106ad1:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106ad6:	e9 48 f3 ff ff       	jmp    80105e23 <alltraps>
...
80106add:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106ae2:	e9 3c f3 ff ff       	jmp    80105e23 <alltraps>
...
80106ae9:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106aee:	e9 30 f3 ff ff       	jmp    80105e23 <alltraps>
...
80106af5:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106afa:	e9 24 f3 ff ff       	jmp    80105e23 <alltraps>
...
80106b01:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106b06:	e9 18 f3 ff ff       	jmp    80105e23 <alltraps>
...
80106b0d:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106b12:	e9 0c f3 ff ff       	jmp    80105e23 <alltraps>
...
80106b19:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106b1e:	e9 00 f3 ff ff       	jmp    80105e23 <alltraps>
...
80106b25:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106b2a:	e9 f4 f2 ff ff       	jmp    80105e23 <alltraps>
...
80106b31:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106b36:	e9 e8 f2 ff ff       	jmp    80105e23 <alltraps>
...
80106b3d:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106b42:	e9 dc f2 ff ff       	jmp    80105e23 <alltraps>
...
80106b49:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106b4e:	e9 d0 f2 ff ff       	jmp    80105e23 <alltraps>
...
80106b55:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106b5a:	e9 c4 f2 ff ff       	jmp    80105e23 <alltraps>
...
80106b61:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106b66:	e9 b8 f2 ff ff       	jmp    80105e23 <alltraps>
...
80106b6d:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106b72:	e9 ac f2 ff ff       	jmp    80105e23 <alltraps>
...
80106b79:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106b7e:	e9 a0 f2 ff ff       	jmp    80105e23 <alltraps>
...
80106b85:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106b8a:	e9 94 f2 ff ff       	jmp    80105e23 <alltraps>
...
80106b91:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106b96:	e9 88 f2 ff ff       	jmp    80105e23 <alltraps>
...
80106b9d:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106ba2:	e9 7c f2 ff ff       	jmp    80105e23 <alltraps>
...
80106ba9:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106bae:	e9 70 f2 ff ff       	jmp    80105e23 <alltraps>
...
80106bb5:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106bba:	e9 64 f2 ff ff       	jmp    80105e23 <alltraps>
...
80106bc1:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106bc6:	e9 58 f2 ff ff       	jmp    80105e23 <alltraps>
...
80106bcd:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106bd2:	e9 4c f2 ff ff       	jmp    80105e23 <alltraps>
...
80106bd9:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106bde:	e9 40 f2 ff ff       	jmp    80105e23 <alltraps>
...
80106be5:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106bea:	e9 34 f2 ff ff       	jmp    80105e23 <alltraps>
...
80106bf1:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106bf6:	e9 28 f2 ff ff       	jmp    80105e23 <alltraps>
...
80106bfd:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106c02:	e9 1c f2 ff ff       	jmp    80105e23 <alltraps>
...
80106c09:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106c0e:	e9 10 f2 ff ff       	jmp    80105e23 <alltraps>
...
80106c15:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106c1a:	e9 04 f2 ff ff       	jmp    80105e23 <alltraps>
...
80106c21:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106c26:	e9 f8 f1 ff ff       	jmp    80105e23 <alltraps>
...
80106c2d:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106c32:	e9 ec f1 ff ff       	jmp    80105e23 <alltraps>
...
80106c39:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106c3e:	e9 e0 f1 ff ff       	jmp    80105e23 <alltraps>
...
80106c45:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106c4a:	e9 d4 f1 ff ff       	jmp    80105e23 <alltraps>
...
80106c51:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106c56:	e9 c8 f1 ff ff       	jmp    80105e23 <alltraps>
...
80106c5d:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106c62:	e9 bc f1 ff ff       	jmp    80105e23 <alltraps>
...
80106c69:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106c6e:	e9 b0 f1 ff ff       	jmp    80105e23 <alltraps>
...
80106c75:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106c7a:	e9 a4 f1 ff ff       	jmp    80105e23 <alltraps>
...
80106c81:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106c86:	e9 98 f1 ff ff       	jmp    80105e23 <alltraps>
...
80106c8d:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106c92:	e9 8c f1 ff ff       	jmp    80105e23 <alltraps>
...
80106c99:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106c9e:	e9 80 f1 ff ff       	jmp    80105e23 <alltraps>
...
80106ca5:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106caa:	e9 74 f1 ff ff       	jmp    80105e23 <alltraps>
...
80106cb1:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106cb6:	e9 68 f1 ff ff       	jmp    80105e23 <alltraps>
...
80106cbd:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106cc2:	e9 5c f1 ff ff       	jmp    80105e23 <alltraps>
...
80106cc9:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106cce:	e9 50 f1 ff ff       	jmp    80105e23 <alltraps>
...
80106cd5:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106cda:	e9 44 f1 ff ff       	jmp    80105e23 <alltraps>
...
80106ce1:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106ce6:	e9 38 f1 ff ff       	jmp    80105e23 <alltraps>
...
80106ced:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106cf2:	e9 2c f1 ff ff       	jmp    80105e23 <alltraps>
...
80106cf9:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106cfe:	e9 20 f1 ff ff       	jmp    80105e23 <alltraps>
...
80106d05:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106d0a:	e9 14 f1 ff ff       	jmp    80105e23 <alltraps>
...
80106d11:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106d16:	e9 08 f1 ff ff       	jmp    80105e23 <alltraps>
...
80106d1d:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106d22:	e9 fc f0 ff ff       	jmp    80105e23 <alltraps>
...
80106d29:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106d2e:	e9 f0 f0 ff ff       	jmp    80105e23 <alltraps>
...
80106d35:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106d3a:	e9 e4 f0 ff ff       	jmp    80105e23 <alltraps>
...
80106d41:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106d46:	e9 d8 f0 ff ff       	jmp    80105e23 <alltraps>
...
80106d94:	e8 97 b8 ff ff       	call   80102630 <kalloc>
...
80106daa:	e8 21 d9 ff ff       	call   801046d0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106e4d:	68 4c 80 10 80       	push   $0x8010804c
...
80106ec8:	e8 a3 b5 ff ff       	call   80102470 <kfree>
      *pte = 0;
...
80106f03:	68 06 79 10 80       	push   $0x80107906
...
80106f17:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106f1a:	e8 21 ca ff ff       	call   80103940 <cpuid>
  pd[0] = size-1;
...
80106f2e:	c7 80 58 6e 13 80 ff 	movl   $0xffff,-0x7fec91a8(%eax)
80106f35:	ff 00 00 
80106f38:	c7 80 5c 6e 13 80 00 	movl   $0xcf9a00,-0x7fec91a4(%eax)
80106f3f:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106f42:	c7 80 60 6e 13 80 ff 	movl   $0xffff,-0x7fec91a0(%eax)
80106f49:	ff 00 00 
80106f4c:	c7 80 64 6e 13 80 00 	movl   $0xcf9200,-0x7fec919c(%eax)
80106f53:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106f56:	c7 80 68 6e 13 80 ff 	movl   $0xffff,-0x7fec9198(%eax)
80106f5d:	ff 00 00 
80106f60:	c7 80 6c 6e 13 80 00 	movl   $0xcffa00,-0x7fec9194(%eax)
80106f67:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106f6a:	c7 80 70 6e 13 80 ff 	movl   $0xffff,-0x7fec9190(%eax)
80106f71:	ff 00 00 
80106f74:	c7 80 74 6e 13 80 00 	movl   $0xcff200,-0x7fec918c(%eax)
80106f7b:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106f7e:	05 50 6e 13 80       	add    $0x80136e50,%eax
  pd[1] = (uint)p;
...
80106fa4:	a1 c4 9b 13 80       	mov    0x80139bc4,%eax
...
80106fe8:	0f 84 c2 00 00 00    	je     801070b0 <switchuvm+0xf0>
  pushcli();
80106fee:	e8 cd d4 ff ff       	call   801044c0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106ff3:	e8 d8 c8 ff ff       	call   801038d0 <mycpu>
80106ff8:	89 c3                	mov    %eax,%ebx
80106ffa:	e8 d1 c8 ff ff       	call   801038d0 <mycpu>
80106fff:	89 c7                	mov    %eax,%edi
80107001:	e8 ca c8 ff ff       	call   801038d0 <mycpu>
80107006:	83 c7 08             	add    $0x8,%edi
80107009:	89 45 e4             	mov    %eax,-0x1c(%ebp)
8010700c:	e8 bf c8 ff ff       	call   801038d0 <mycpu>
...
801070ef:	77 4b                	ja     8010713c <inituvm+0x6c>
  mem = kalloc();
801070f1:	e8 3a b5 ff ff       	call   80102630 <kalloc>
  memset(mem, 0, PGSIZE);
...
80107103:	e8 c8 d5 ff ff       	call   801046d0 <memset>
...
80107136:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80107137:	e9 34 d6 ff ff       	jmp    80104770 <memmove>
    panic("inituvm: more than a page");
8010713c:	83 ec 0c             	sub    $0xc,%esp
8010713f:	68 91 80 10 80       	push   $0x80108091
...
801071ce:	e8 8d a8 ff ff       	call   80101a60 <readi>
...
8010726b:	e8 60 d4 ff ff       	call   801046d0 <memset>
...
80107299:	76 48                	jbe    801072e3 <allocuvm+0xc3>
    mem = kalloc();
8010729b:	e8 90 b3 ff ff       	call   80102630 <kalloc>
...
801072ae:	e8 fd 93 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
...
80107310:	e8 9b 93 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
...
80107330:	e8 3b b1 ff ff       	call   80102470 <kfree>
      return 0;
...
801073ce:	e8 9d b0 ff ff       	call   80102470 <kfree>
...
801073e3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
801073e4:	e9 87 b0 ff ff       	jmp    80102470 <kfree>
    panic("freevm: no pgdir");
...
80107409:	e8 22 b2 ff ff       	call   80102630 <kalloc>
...
80107417:	bb 20 d4 10 80       	mov    $0x8010d420,%ebx
  memset(pgdir, 0, PGSIZE);
8010741c:	68 00 10 00 00       	push   $0x1000
80107421:	6a 00                	push   $0x0
80107423:	50                   	push   %eax
80107424:	e8 a7 d2 ff ff       	call   801046d0 <memset>
...
8010744e:	81 fb 60 d4 10 80    	cmp    $0x8010d460,%ebx
...
8010748f:	a3 c4 9b 13 80       	mov    %eax,0x80139bc4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801074c3:	68 0e 81 10 80       	push   $0x8010810e
...
80107510:	e8 5b d2 ff ff       	call   80104770 <memmove>
...
80107562:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107568:	e8 c3 b0 ff ff       	call   80102630 <kalloc>
...
8010763e:	e8 2d d1 ff ff       	call   80104770 <memmove>
    len -= n;
    buf += n;
