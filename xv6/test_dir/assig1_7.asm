...
int main(void)
{
  ...
  12:	51                   	push   %ecx
	toggle(); 
  13:	e8 ab 03 00 00       	call   3c3 <toggle>
	printf(1,"%s\n","IPC Test case");
  18:	83 ec 04             	sub    $0x4,%esp
  1b:	68 18 08 00 00       	push   $0x818
  20:	68 26 08 00 00       	push   $0x826
  25:	6a 01                	push   $0x1
...
int cid = fork();
  2c:	e8 ea 02 00 00       	call   31b <fork>
	if(cid==0){
  31:	83 c4 10             	add    $0x10,%esp
  34:	85 c0                	test   %eax,%eax
  36:	75 3c                	jne    74 <main+0x74>
		// This is child
		char *msg = (char *)malloc(MSGSIZE);
  38:	83 ec 0c             	sub    $0xc,%esp
  3b:	6a 08                	push   $0x8
  3d:	e8 ce 06 00 00       	call   710 <malloc>
  ...
  53:	53                   	push   %ebx
  54:	e8 92 03 00 00       	call   3eb <recv>
		while(stat==-1){
  59:	83 c4 10             	add    $0x10,%esp
  5c:	83 f8 ff             	cmp    $0xffffffff,%eax
  5f:	74 ef                	je     50 <main+0x50>
		}
		printf(1,"2 CHILD: msg recv is: %s \n", msg );
  61:	50                   	push   %eax
  62:	53                   	push   %ebx
  63:	68 2a 08 00 00       	push   $0x82a
  68:	6a 01                	push   $0x1
  6a:	e8 41 04 00 00       	call   4b0 <printf>
		exit();
  6f:	e8 af 02 00 00       	call   323 <exit>
	}else{
		// This is parent
  ...
  79:	6a 08                	push   $0x8
  7b:	e8 90 06 00 00       	call   710 <malloc>
		msg_child = "P";
		printf(1,"1 PARENT: msg sent is: %s \n", msg_child );
  80:	83 c4 0c             	add    $0xc,%esp
  83:	68 45 08 00 00       	push   $0x845
  88:	68 47 08 00 00       	push   $0x847
  8d:	6a 01                	push   $0x1
  8f:	e8 1c 04 00 00       	call   4b0 <printf>
		send(getpid(),cid,msg_child);	
  94:	e8 0a 03 00 00       	call   3a3 <getpid>
  99:	83 c4 0c             	add    $0xc,%esp
  9c:	68 45 08 00 00       	push   $0x845
  a1:	53                   	push   %ebx
  a2:	50                   	push   %eax
  a3:	e8 3b 03 00 00       	call   3e3 <send>
		
		
		free(msg_child);
  a8:	c7 04 24 45 08 00 00 	movl   $0x845,(%esp)
  af:	e8 cc 05 00 00       	call   680 <free>
	}
	wait();
  b4:	e8 72 02 00 00       	call   32b <wait>
	
	exit();
  b9:	e8 65 02 00 00       	call   323 <exit>
  be:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
 ...
 685:	a1 18 0b 00 00       	mov    0xb18,%eax
{
 ...
 6a6:	73 10                	jae    6b8 <free+0x38>
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	a3 18 0b 00 00       	mov    %eax,0xb18
}
 6d7:	5e                   	pop    %esi
 6d8:	5f                   	pop    %edi
 6d9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 71d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 720:	8b 3d 18 0b 00 00    	mov    0xb18,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 769:	8b 3d 18 0b 00 00    	mov    0xb18,%edi
 ...
 792:	e8 e9 fe ff ff       	call   680 <free>
  return freep;
 797:	a1 18 0b 00 00       	mov    0xb18,%eax
 ...
 7c4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7c7:	a3 18 0b 00 00       	mov    %eax,0xb18
}
 ...
 7de:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 18 0b 00 00 1c 	movl   $0xb1c,0xb18
 7e7:	0b 00 00 
    base.s.size = 0;
 7ea:	bf 1c 0b 00 00       	mov    $0xb1c,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 1c 0b 00 00 1c 	movl   $0xb1c,0xb1c
 7f6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7fb:	c7 05 20 0b 00 00 00 	movl   $0x0,0xb20
 802:	00 00 00 
    if(p->s.size >= nunits){
