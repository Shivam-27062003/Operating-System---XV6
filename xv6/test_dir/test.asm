...
{  
  ...
  11:	57                   	push   %edi
  12:	56                   	push   %esi
  13:	8d 75 e8             	lea    -0x18(%ebp),%esi
  16:	53                   	push   %ebx
  17:	8d 5d c8             	lea    -0x38(%ebp),%ebx
  1a:	51                   	push   %ecx
...
{  
  1d:	83 ec 48             	sub    $0x48,%esp
  int mypid = getpid();
  20:	e8 7e 03 00 00       	call   3a3 <getpid>
  char num[] = "toxic27";
  25:	c7 45 b8 74 6f 78 69 	movl   $0x69786f74,-0x48(%ebp)
  int mypid = getpid();
  2c:	89 45 b4             	mov    %eax,-0x4c(%ebp)
  char num[] = "toxic27";
  2f:	c7 45 bc 63 32 37 00 	movl   $0x373263,-0x44(%ebp)
  void* mssg = num;
  int pids[8];
  for(int i=0;i<8;i++){
  ...
  3d:	8d 76 00             	lea    0x0(%esi),%esi
    int pid = fork();
  40:	e8 d6 02 00 00       	call   31b <fork>
    if(pid>0)pids[i]=pid;
  45:	85 c0                	test   %eax,%eax
  47:	7e 09                	jle    52 <main+0x52>
  49:	89 07                	mov    %eax,(%edi)
  for(int i=0;i<8;i++){
  4b:	83 c7 04             	add    $0x4,%edi
  4e:	39 f7                	cmp    %esi,%edi
  50:	75 ee                	jne    40 <main+0x40>
    else break;
  }
  if(getpid()==mypid){
  52:	e8 4c 03 00 00       	call   3a3 <getpid>
  57:	3b 45 b4             	cmp    -0x4c(%ebp),%eax
  5a:	75 27                	jne    83 <main+0x83>
  5c:	8d 7d b8             	lea    -0x48(%ebp),%edi
  5f:	90                   	nop
    for(int i=0;i<8;i++){
  ...
  66:	57                   	push   %edi
  67:	ff 73 fc             	pushl  -0x4(%ebx)
  6a:	ff 75 b4             	pushl  -0x4c(%ebp)
  6d:	e8 71 03 00 00       	call   3e3 <send>
      wait();
  ...
  exit();
  7e:	e8 a0 02 00 00       	call   323 <exit>
    printf(1,"%d\n",recv(data));
  83:	83 ec 0c             	sub    $0xc,%esp
  86:	8d 45 c0             	lea    -0x40(%ebp),%eax
    char c[8]= "$$$$$$$";
  89:	c7 45 c0 24 24 24 24 	movl   $0x24242424,-0x40(%ebp)
    printf(1,"%d\n",recv(data));
  90:	50                   	push   %eax
    char c[8]= "$$$$$$$";
  91:	c7 45 c4 24 24 24 00 	movl   $0x242424,-0x3c(%ebp)
    printf(1,"%d\n",recv(data));
  98:	e8 4e 03 00 00       	call   3eb <recv>
...
printf(int fd, const char *fmt, ...)
{
 ...
 634:	eb 1a                	jmp    650 <printf+0x1a0>
          s = "(null)";
 636:	bb 1c 08 00 00       	mov    $0x81c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 685:	a1 dc 0a 00 00       	mov    0xadc,%eax
{
 ...
 6a6:	73 10                	jae    6b8 <free+0x38>
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	a3 dc 0a 00 00       	mov    %eax,0xadc
}
 6d7:	5e                   	pop    %esi
 6d8:	5f                   	pop    %edi
 6d9:	5d                   	pop    %ebp
 ...
 6f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6fa:	a3 dc 0a 00 00       	mov    %eax,0xadc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 71d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 720:	8b 3d dc 0a 00 00    	mov    0xadc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 769:	8b 3d dc 0a 00 00    	mov    0xadc,%edi
 ...
 792:	e8 e9 fe ff ff       	call   680 <free>
  return freep;
 797:	a1 dc 0a 00 00       	mov    0xadc,%eax
 ...
 7c4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7c7:	a3 dc 0a 00 00       	mov    %eax,0xadc
}
 ...
 7de:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 dc 0a 00 00 e0 	movl   $0xae0,0xadc
 7e7:	0a 00 00 
    base.s.size = 0;
 7ea:	bf e0 0a 00 00       	mov    $0xae0,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 e0 0a 00 00 e0 	movl   $0xae0,0xae0
 7f6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7fb:	c7 05 e4 0a 00 00 00 	movl   $0x0,0xae4
 802:	00 00 00 
    if(p->s.size >= nunits){
