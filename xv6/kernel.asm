...
80100028:	bc 10 fc 12 80       	mov    $0x8012fc10,%esp
...
80100048:	bb 54 fc 12 80       	mov    $0x8012fc54,%ebx
{
8010004d:	83 ec 0c             	sub    $0xc,%esp
  initlock(&bcache.lock, "bcache");
80100050:	68 e0 79 10 80       	push   $0x801079e0
80100055:	68 20 fc 12 80       	push   $0x8012fc20
8010005a:	e8 31 46 00 00       	call   80104690 <initlock>
  bcache.head.next = &bcache.head;
8010005f:	83 c4 10             	add    $0x10,%esp
80100062:	b8 1c 43 13 80       	mov    $0x8013431c,%eax
  bcache.head.prev = &bcache.head;
80100067:	c7 05 6c 43 13 80 1c 	movl   $0x8013431c,0x8013436c
8010006e:	43 13 80 
  bcache.head.next = &bcache.head;
80100071:	c7 05 70 43 13 80 1c 	movl   $0x8013431c,0x80134370
80100078:	43 13 80 
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
...
801000b0:	89 1d 70 43 13 80    	mov    %ebx,0x80134370
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
801000b6:	81 fb c0 40 13 80    	cmp    $0x801340c0,%ebx
...
801000e0:	8b 75 0c             	mov    0xc(%ebp),%esi
  acquire(&bcache.lock);
801000e3:	68 20 fc 12 80       	push   $0x8012fc20
801000e8:	e8 23 47 00 00       	call   80104810 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
801000ed:	8b 1d 70 43 13 80    	mov    0x80134370,%ebx
801000f3:	83 c4 10             	add    $0x10,%esp
801000f6:	81 fb 1c 43 13 80    	cmp    $0x8013431c,%ebx
801000fc:	75 0d                	jne    8010010b <bread+0x3b>
801000fe:	eb 20                	jmp    80100120 <bread+0x50>
80100100:	8b 5b 54             	mov    0x54(%ebx),%ebx
80100103:	81 fb 1c 43 13 80    	cmp    $0x8013431c,%ebx
...
80100120:	8b 1d 6c 43 13 80    	mov    0x8013436c,%ebx
80100126:	81 fb 1c 43 13 80    	cmp    $0x8013431c,%ebx
8010012c:	75 0d                	jne    8010013b <bread+0x6b>
8010012e:	eb 70                	jmp    801001a0 <bread+0xd0>
80100130:	8b 5b 50             	mov    0x50(%ebx),%ebx
80100133:	81 fb 1c 43 13 80    	cmp    $0x8013431c,%ebx
...
8010015d:	68 20 fc 12 80       	push   $0x8012fc20
...
80100213:	e8 d8 43 00 00       	call   801045f0 <releasesleep>
  ...
  acquire(&bcache.lock);
80100218:	c7 04 24 20 fc 12 80 	movl   $0x8012fc20,(%esp)
...
80100243:	89 50 54             	mov    %edx,0x54(%eax)
    b->next = bcache.head.next;
80100246:	a1 70 43 13 80       	mov    0x80134370,%eax
    b->prev = &bcache.head;
8010024b:	c7 43 50 1c 43 13 80 	movl   $0x8013431c,0x50(%ebx)
    b->next = bcache.head.next;
80100252:	89 43 54             	mov    %eax,0x54(%ebx)
    bcache.head.next->prev = b;
80100255:	a1 70 43 13 80       	mov    0x80134370,%eax
8010025a:	89 58 50             	mov    %ebx,0x50(%eax)
    bcache.head.next = b;
8010025d:	89 1d 70 43 13 80    	mov    %ebx,0x80134370
  }
  
  release(&bcache.lock);
80100263:	c7 45 08 20 fc 12 80 	movl   $0x8012fc20,0x8(%ebp)
}
...
801002c6:	a1 00 46 13 80       	mov    0x80134600,%eax
801002cb:	3b 05 04 46 13 80    	cmp    0x80134604,%eax
...
801002e0:	68 00 46 13 80       	push   $0x80134600
801002e5:	e8 46 3c 00 00       	call   80103f30 <sleep>
    while(input.r == input.w){
801002ea:	a1 00 46 13 80       	mov    0x80134600,%eax
801002ef:	83 c4 10             	add    $0x10,%esp
801002f2:	3b 05 04 46 13 80    	cmp    0x80134604,%eax
...
80100333:	89 15 00 46 13 80    	mov    %edx,0x80134600
80100339:	89 c2                	mov    %eax,%edx
8010033b:	83 e2 7f             	and    $0x7f,%edx
8010033e:	0f be 8a 80 45 13 80 	movsbl -0x7fecba80(%edx),%ecx
    if(c == C('D')){  // EOF
...
80100384:	73 d7                	jae    8010035d <consoleread+0xcd>
        input.r--;
80100386:	a3 00 46 13 80       	mov    %eax,0x80134600
...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 4b 84 10 80 	movl   $0x8010844b,(%esp)
...
801008b4:	a1 08 46 13 80       	mov    0x80134608,%eax
801008b9:	89 c2                	mov    %eax,%edx
801008bb:	2b 15 00 46 13 80    	sub    0x80134600,%edx
...
801008d2:	89 0d 08 46 13 80    	mov    %ecx,0x80134608
        c = (c == '\r') ? '\n' : c;
801008d8:	83 fb 0d             	cmp    $0xd,%ebx
801008db:	0f 84 02 01 00 00    	je     801009e3 <consoleintr+0x183>
        input.buf[input.e++ % INPUT_BUF] = c;
801008e1:	88 98 80 45 13 80    	mov    %bl,-0x7fecba80(%eax)
  if(panicked){
...
80100908:	a1 00 46 13 80       	mov    0x80134600,%eax
8010090d:	83 e8 80             	sub    $0xffffff80,%eax
80100910:	39 05 08 46 13 80    	cmp    %eax,0x80134608
80100916:	75 80                	jne    80100898 <consoleintr+0x38>
80100918:	e9 f6 00 00 00       	jmp    80100a13 <consoleintr+0x1b3>
8010091d:	8d 76 00             	lea    0x0(%esi),%esi
      while(input.e != input.w &&
80100920:	a1 08 46 13 80       	mov    0x80134608,%eax
80100925:	39 05 04 46 13 80    	cmp    %eax,0x80134604
...
80100936:	83 e2 7f             	and    $0x7f,%edx
      while(input.e != input.w &&
80100939:	80 ba 80 45 13 80 0a 	cmpb   $0xa,-0x7fecba80(%edx)
80100940:	0f 84 52 ff ff ff    	je     80100898 <consoleintr+0x38>
  if(panicked){
80100946:	8b 15 58 d5 10 80    	mov    0x8010d558,%edx
        input.e--;
8010094c:	a3 08 46 13 80       	mov    %eax,0x80134608
  if(panicked){
...
80100965:	e8 a6 fa ff ff       	call   80100410 <consputc.part.0>
      while(input.e != input.w &&
8010096a:	a1 08 46 13 80       	mov    0x80134608,%eax
8010096f:	3b 05 04 46 13 80    	cmp    0x80134604,%eax
80100975:	75 ba                	jne    80100931 <consoleintr+0xd1>
80100977:	e9 1c ff ff ff       	jmp    80100898 <consoleintr+0x38>
8010097c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      if(input.e != input.w){
80100980:	a1 08 46 13 80       	mov    0x80134608,%eax
80100985:	3b 05 04 46 13 80    	cmp    0x80134604,%eax
8010098b:	0f 84 07 ff ff ff    	je     80100898 <consoleintr+0x38>
        input.e--;
80100991:	83 e8 01             	sub    $0x1,%eax
80100994:	a3 08 46 13 80       	mov    %eax,0x80134608
  if(panicked){
...
801009e2:	c3                   	ret    
        input.buf[input.e++ % INPUT_BUF] = c;
801009e3:	c6 80 80 45 13 80 0a 	movb   $0xa,-0x7fecba80(%eax)
  if(panicked){
...
80100a09:	e8 02 fa ff ff       	call   80100410 <consputc.part.0>
        if(c == '\n' || c == C('D') || input.e == input.r+INPUT_BUF){
80100a0e:	a1 08 46 13 80       	mov    0x80134608,%eax
          wakeup(&input.r);
80100a13:	83 ec 0c             	sub    $0xc,%esp
          input.w = input.e;
80100a16:	a3 04 46 13 80       	mov    %eax,0x80134604
          wakeup(&input.r);
80100a1b:	68 00 46 13 80       	push   $0x80134600
...
80100a4d:	6a 01                	push   $0x1
  devsw[CONSOLE].write = consolewrite;
80100a4f:	c7 05 cc 4f 13 80 40 	movl   $0x80100640,0x80134fcc
80100a56:	06 10 80 
  devsw[CONSOLE].read = consoleread;
80100a59:	c7 05 c8 4f 13 80 90 	movl   $0x80100290,0x80134fc8
80100a60:	02 10 80 
  cons.locking = 1;
...
80100d9d:	e8 6e 65 00 00       	call   80107310 <switchuvm>
  freevm(oldpgdir);
80100da2:	89 3c 24             	mov    %edi,(%esp)
80100da5:	e8 26 69 00 00       	call   801076d0 <freevm>
  return 0;
...
80100dbc:	68 61 7a 10 80       	push   $0x80107a61
...
80100dea:	68 6d 7a 10 80       	push   $0x80107a6d
80100def:	68 20 46 13 80       	push   $0x80134620
...
80100e08:	bb 54 46 13 80       	mov    $0x80134654,%ebx
{
80100e0d:	83 ec 10             	sub    $0x10,%esp
  acquire(&ftable.lock);
80100e10:	68 20 46 13 80       	push   $0x80134620
...
80100e23:	81 fb b4 4f 13 80    	cmp    $0x80134fb4,%ebx
...
80100e35:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      release(&ftable.lock);
80100e3c:	68 20 46 13 80       	push   $0x80134620
...
80100e53:	31 db                	xor    %ebx,%ebx
  release(&ftable.lock);
80100e55:	68 20 46 13 80       	push   $0x80134620
...
80100e7b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ftable.lock);
80100e7e:	68 20 46 13 80       	push   $0x80134620
...
80100e98:	89 43 04             	mov    %eax,0x4(%ebx)
  release(&ftable.lock);
80100e9b:	68 20 46 13 80       	push   $0x80134620
...
80100eaf:	68 74 7a 10 80       	push   $0x80107a74
...
80100ecd:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ftable.lock);
80100ed0:	68 20 46 13 80       	push   $0x80134620
...
80100f05:	8b 43 10             	mov    0x10(%ebx),%eax
  release(&ftable.lock);
80100f08:	68 20 46 13 80       	push   $0x80134620
  ff = *f;
...
80100f2a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    release(&ftable.lock);
80100f30:	c7 45 08 20 46 13 80 	movl   $0x80134620,0x8(%ebp)
}
...
80100f8c:	68 7c 7a 10 80       	push   $0x80107a7c
...
8010107a:	68 86 7a 10 80       	push   $0x80107a86
...
80101163:	68 8f 7a 10 80       	push   $0x80107a8f
...
80101199:	68 95 7a 10 80       	push   $0x80107a95
...
801011b8:	03 05 38 50 13 80    	add    0x80135038,%eax
{
...
80101217:	68 9f 7a 10 80       	push   $0x80107a9f
...
80101239:	8b 0d 20 50 13 80    	mov    0x80135020,%ecx
{
...
8010125c:	03 05 38 50 13 80    	add    0x80135038,%eax
...
80101271:	a1 20 50 13 80       	mov    0x80135020,%eax
...
801012c9:	39 05 20 50 13 80    	cmp    %eax,0x80135020
801012cf:	77 80                	ja     80101251 <balloc+0x21>
  panic("balloc: out of blocks");
801012d1:	83 ec 0c             	sub    $0xc,%esp
801012d4:	68 b2 7a 10 80       	push   $0x80107ab2
...
8010134a:	bb 74 50 13 80       	mov    $0x80135074,%ebx
{
8010134f:	83 ec 28             	sub    $0x28,%esp
80101352:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
80101355:	68 40 50 13 80       	push   $0x80135040
...
80101374:	81 c3 90 00 00 00    	add    $0x90,%ebx
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
8010137a:	81 fb 94 6c 13 80    	cmp    $0x80136c94,%ebx
...
80101399:	89 c6                	mov    %eax,%esi
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
8010139b:	81 fb 94 6c 13 80    	cmp    $0x80136c94,%ebx
...
801013bb:	c7 46 4c 00 00 00 00 	movl   $0x0,0x4c(%esi)
  release(&icache.lock);
801013c2:	68 40 50 13 80       	push   $0x80135040
...
801013eb:	89 de                	mov    %ebx,%esi
      release(&icache.lock);
801013ed:	68 40 50 13 80       	push   $0x80135040
      ip->ref++;
...
80101406:	c3                   	ret    
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
80101407:	81 fb 94 6c 13 80    	cmp    $0x80136c94,%ebx
...
80101422:	68 c8 7a 10 80       	push   $0x80107ac8
...
801014eb:	68 d8 7a 10 80       	push   $0x80107ad8
...
80101548:	bb 80 50 13 80       	mov    $0x80135080,%ebx
8010154d:	83 ec 0c             	sub    $0xc,%esp
  initlock(&icache.lock, "icache");
80101550:	68 eb 7a 10 80       	push   $0x80107aeb
80101555:	68 40 50 13 80       	push   $0x80135040
...
8010156b:	68 f2 7a 10 80       	push   $0x80107af2
80101570:	53                   	push   %ebx
80101571:	81 c3 90 00 00 00    	add    $0x90,%ebx
80101577:	e8 d4 2f 00 00       	call   80104550 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
8010157c:	83 c4 10             	add    $0x10,%esp
8010157f:	81 fb a0 6c 13 80    	cmp    $0x80136ca0,%ebx
80101585:	75 e1                	jne    80101568 <iinit+0x28>
  readsb(dev, &sb);
80101587:	83 ec 08             	sub    $0x8,%esp
8010158a:	68 20 50 13 80       	push   $0x80135020
8010158f:	ff 75 08             	pushl  0x8(%ebp)
80101592:	e8 69 ff ff ff       	call   80101500 <readsb>
  cprintf("sb: size %d nblocks %d ninodes %d nlog %d logstart %d\
80101597:	ff 35 38 50 13 80    	pushl  0x80135038
8010159d:	ff 35 34 50 13 80    	pushl  0x80135034
801015a3:	ff 35 30 50 13 80    	pushl  0x80135030
801015a9:	ff 35 2c 50 13 80    	pushl  0x8013502c
801015af:	ff 35 28 50 13 80    	pushl  0x80135028
801015b5:	ff 35 24 50 13 80    	pushl  0x80135024
801015bb:	ff 35 20 50 13 80    	pushl  0x80135020
801015c1:	68 58 7b 10 80       	push   $0x80107b58
...
801015f0:	83 3d 28 50 13 80 01 	cmpl   $0x1,0x80135028
{
...
8010161f:	3b 3d 28 50 13 80    	cmp    0x80135028,%edi
80101625:	73 69                	jae    80101690 <ialloc+0xb0>
    bp = bread(dev, IBLOCK(inum, sb));
80101627:	89 f8                	mov    %edi,%eax
80101629:	83 ec 08             	sub    $0x8,%esp
8010162c:	c1 e8 03             	shr    $0x3,%eax
8010162f:	03 05 34 50 13 80    	add    0x80135034,%eax
...
80101693:	68 f8 7a 10 80       	push   $0x80107af8
...
801016b8:	03 05 34 50 13 80    	add    0x80135034,%eax
...
8010173b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&icache.lock);
8010173e:	68 40 50 13 80       	push   $0x80135040
80101743:	e8 c8 30 00 00       	call   80104810 <acquire>
  ip->ref++;
80101748:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010174c:	c7 04 24 40 50 13 80 	movl   $0x80135040,(%esp)
...
801017a9:	03 05 34 50 13 80    	add    0x80135034,%eax
...
8010181d:	68 10 7b 10 80       	push   $0x80107b10
80101822:	e8 69 eb ff ff       	call   80100390 <panic>
    panic("ilock");
80101827:	83 ec 0c             	sub    $0xc,%esp
8010182a:	68 0a 7b 10 80       	push   $0x80107b0a
...
8010187b:	68 1f 7b 10 80       	push   $0x80107b1f
...
801018be:	e8 2d 2d 00 00       	call   801045f0 <releasesleep>
  acquire(&icache.lock);
801018c3:	c7 04 24 40 50 13 80 	movl   $0x80135040,(%esp)
801018ca:	e8 41 2f 00 00       	call   80104810 <acquire>
  ip->ref--;
801018cf:	83 6b 08 01          	subl   $0x1,0x8(%ebx)
  release(&icache.lock);
801018d3:	83 c4 10             	add    $0x10,%esp
801018d6:	c7 45 08 40 50 13 80 	movl   $0x80135040,0x8(%ebp)
}
...
801018f3:	68 40 50 13 80       	push   $0x80135040
801018f8:	e8 13 2f 00 00       	call   80104810 <acquire>
    int r = ip->ref;
801018fd:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101900:	c7 04 24 40 50 13 80 	movl   $0x80135040,(%esp)
...
80101b3a:	8b 04 c5 c0 4f 13 80 	mov    -0x7fecb040(,%eax,8),%eax
...
80101c4a:	8b 04 c5 c4 4f 13 80 	mov    -0x7fecb03c(,%eax,8),%eax
...
80101d4a:	68 39 7b 10 80       	push   $0x80107b39
80101d4f:	e8 3c e6 ff ff       	call   80100390 <panic>
    panic("dirlookup not DIR");
80101d54:	83 ec 0c             	sub    $0xc,%esp
80101d57:	68 27 7b 10 80       	push   $0x80107b27
...
80101d94:	8b 70 68             	mov    0x68(%eax),%esi
  acquire(&icache.lock);
80101d97:	68 40 50 13 80       	push   $0x80135040
80101d9c:	e8 6f 2a 00 00       	call   80104810 <acquire>
  ip->ref++;
80101da1:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101da5:	c7 04 24 40 50 13 80 	movl   $0x80135040,(%esp)
...
80102013:	68 48 7b 10 80       	push   $0x80107b48
80102018:	e8 73 e3 ff ff       	call   80100390 <panic>
    panic("dirlink");
8010201d:	83 ec 0c             	sub    $0xc,%esp
80102020:	68 6a 81 10 80       	push   $0x8010816a
...
8010212b:	68 b4 7b 10 80       	push   $0x80107bb4
80102130:	e8 5b e2 ff ff       	call   80100390 <panic>
    panic("idestart");
80102135:	83 ec 0c             	sub    $0xc,%esp
80102138:	68 ab 7b 10 80       	push   $0x80107bab
...
8010215a:	68 c6 7b 10 80       	push   $0x80107bc6
8010215f:	68 80 d5 10 80       	push   $0x8010d580
80102164:	e8 27 25 00 00       	call   80104690 <initlock>
  ioapicenable(IRQ_IDE, ncpu - 1);
80102169:	58                   	pop    %eax
8010216a:	a1 60 73 13 80       	mov    0x80137360,%eax
8010216f:	5a                   	pop    %edx
...
801021b8:	74 f6                	je     801021b0 <ideinit+0x60>
      havedisk1 = 1;
801021ba:	c7 05 60 d5 10 80 01 	movl   $0x1,0x8010d560
801021c1:	00 00 00 
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
...
801021ea:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&idelock);
801021ed:	68 80 d5 10 80       	push   $0x8010d580
801021f2:	e8 19 26 00 00       	call   80104810 <acquire>

  if((b = idequeue) == 0){
801021f7:	8b 1d 64 d5 10 80    	mov    0x8010d564,%ebx
...
80102207:	a3 64 d5 10 80       	mov    %eax,0x8010d564
...
8010224d:	e8 9e 1e 00 00       	call   801040f0 <wakeup>
  ...
  if(idequeue != 0)
80102252:	a1 64 d5 10 80       	mov    0x8010d564,%eax
...
80102266:	68 80 d5 10 80       	push   $0x8010d580
...
801022b7:	a1 60 d5 10 80       	mov    0x8010d560,%eax
...
801022c7:	68 80 d5 10 80       	push   $0x8010d580
801022cc:	e8 3f 25 00 00       	call   80104810 <acquire>

  // Append b to idequeue.
  b->qnext = 0;
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
801022d1:	a1 64 d5 10 80       	mov    0x8010d564,%eax
  b->qnext = 0;
...
801022f4:	89 1a                	mov    %ebx,(%edx)
  ...
  if(idequeue == b)
801022f6:	39 1d 64 d5 10 80    	cmp    %ebx,0x8010d564
...
80102313:	68 80 d5 10 80       	push   $0x8010d580
...
80102329:	75 e5                	jne    80102310 <iderw+0x90>
  ...
  release(&idelock);
8010232b:	c7 45 08 80 d5 10 80 	movl   $0x8010d580,0x8(%ebp)
}
...
80102349:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
80102350:	ba 64 d5 10 80       	mov    $0x8010d564,%edx
80102355:	eb 9d                	jmp    801022f4 <iderw+0x74>
    panic("iderw: ide disk 1 not present");
80102357:	83 ec 0c             	sub    $0xc,%esp
8010235a:	68 f5 7b 10 80       	push   $0x80107bf5
8010235f:	e8 2c e0 ff ff       	call   80100390 <panic>
    panic("iderw: nothing to do");
80102364:	83 ec 0c             	sub    $0xc,%esp
80102367:	68 e0 7b 10 80       	push   $0x80107be0
8010236c:	e8 1f e0 ff ff       	call   80100390 <panic>
    panic("iderw: buf not locked");
80102371:	83 ec 0c             	sub    $0xc,%esp
80102374:	68 ca 7b 10 80       	push   $0x80107bca
...
80102385:	c7 05 94 6c 13 80 00 	movl   $0xfec00000,0x80136c94
8010238c:	00 c0 fe 
{
...
8010239a:	00 00 00 
  return ioapic->data;
8010239d:	8b 15 94 6c 13 80    	mov    0x80136c94,%edx
801023a3:	8b 72 10             	mov    0x10(%edx),%esi
  ioapic->reg = reg;
801023a6:	c7 02 00 00 00 00    	movl   $0x0,(%edx)
  return ioapic->data;
801023ac:	8b 0d 94 6c 13 80    	mov    0x80136c94,%ecx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
  id = ioapicread(REG_ID) >> 24;
  if(id != ioapicid)
801023b2:	0f b6 15 c0 6d 13 80 	movzbl 0x80136dc0,%edx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
...
801023ce:	68 14 7c 10 80       	push   $0x80107c14
801023d3:	e8 d8 e2 ff ff       	call   801006b0 <cprintf>
801023d8:	8b 0d 94 6c 13 80    	mov    0x80136c94,%ecx
...
801023f2:	89 c3                	mov    %eax,%ebx
  ioapic->data = data;
801023f4:	8b 0d 94 6c 13 80    	mov    0x80136c94,%ecx
...
8010240c:	89 19                	mov    %ebx,(%ecx)
  ioapic->data = data;
8010240e:	8b 0d 94 6c 13 80    	mov    0x80136c94,%ecx
...
80102434:	55                   	push   %ebp
  ioapic->reg = reg;
80102435:	8b 0d 94 6c 13 80    	mov    0x80136c94,%ecx
{
...
80102447:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
80102449:	8b 0d 94 6c 13 80    	mov    0x80136c94,%ecx
...
80102458:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
8010245a:	a1 94 6c 13 80       	mov    0x80136c94,%eax
  ioapicwrite(REG_TABLE+2*irq+1, cpunum << 24);
...
80102486:	81 fb c8 9f 13 80    	cmp    $0x80139fc8,%ebx
...
801024a6:	e8 75 24 00 00       	call   80104920 <memset>
  ...
  if(kmem.use_lock)
801024ab:	8b 15 d4 6c 13 80    	mov    0x80136cd4,%edx
...
801024b8:	a1 d8 6c 13 80       	mov    0x80136cd8,%eax
801024bd:	89 03                	mov    %eax,(%ebx)
  kmem.freelist = r;
  if(kmem.use_lock)
801024bf:	a1 d4 6c 13 80       	mov    0x80136cd4,%eax
  kmem.freelist = r;
801024c4:	89 1d d8 6c 13 80    	mov    %ebx,0x80136cd8
  if(kmem.use_lock)
...
801024db:	68 a0 6c 13 80       	push   $0x80136ca0
801024e0:	e8 2b 23 00 00       	call   80104810 <acquire>
801024e5:	83 c4 10             	add    $0x10,%esp
801024e8:	eb ce                	jmp    801024b8 <kfree+0x48>
801024ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    release(&kmem.lock);
801024f0:	c7 45 08 a0 6c 13 80 	movl   $0x80136ca0,0x8(%ebp)
}
...
80102503:	68 46 7c 10 80       	push   $0x80107c46
...
8010256f:	68 4c 7c 10 80       	push   $0x80107c4c
80102574:	68 a0 6c 13 80       	push   $0x80136ca0
...
80102581:	83 c4 10             	add    $0x10,%esp
  kmem.use_lock = 0;
80102584:	c7 05 d4 6c 13 80 00 	movl   $0x0,0x80136cd4
8010258b:	00 00 00 
  p = (char*)PGROUNDUP((uint)vstart);
...
80102612:	73 e4                	jae    801025f8 <kinit2+0x28>
  kmem.use_lock = 1;
80102614:	c7 05 d4 6c 13 80 01 	movl   $0x1,0x80136cd4
8010261b:	00 00 00 
}
...
80102630:	f3 0f 1e fb          	endbr32 
  ...
  if(kmem.use_lock)
80102634:	a1 d4 6c 13 80       	mov    0x80136cd4,%eax
80102639:	85 c0                	test   %eax,%eax
8010263b:	75 1b                	jne    80102658 <kalloc+0x28>
    acquire(&kmem.lock);
  r = kmem.freelist;
8010263d:	a1 d8 6c 13 80       	mov    0x80136cd8,%eax
  if(r)
80102642:	85 c0                	test   %eax,%eax
80102644:	74 0a                	je     80102650 <kalloc+0x20>
    kmem.freelist = r->next;
80102646:	8b 10                	mov    (%eax),%edx
80102648:	89 15 d8 6c 13 80    	mov    %edx,0x80136cd8
  if(kmem.use_lock)
8010264e:	c3                   	ret    
8010264f:	90                   	nop
    release(&kmem.lock);
...
8010265b:	83 ec 24             	sub    $0x24,%esp
    acquire(&kmem.lock);
8010265e:	68 a0 6c 13 80       	push   $0x80136ca0
80102663:	e8 a8 21 00 00       	call   80104810 <acquire>
  r = kmem.freelist;
80102668:	a1 d8 6c 13 80       	mov    0x80136cd8,%eax
  if(r)
8010266d:	8b 15 d4 6c 13 80    	mov    0x80136cd4,%edx
80102673:	83 c4 10             	add    $0x10,%esp
80102676:	85 c0                	test   %eax,%eax
80102678:	74 08                	je     80102682 <kalloc+0x52>
    kmem.freelist = r->next;
8010267a:	8b 08                	mov    (%eax),%ecx
8010267c:	89 0d d8 6c 13 80    	mov    %ecx,0x80136cd8
  if(kmem.use_lock)
...
8010268c:	68 a0 6c 13 80       	push   $0x80136ca0
...
801026bb:	ec                   	in     (%dx),%al
  return data;
801026bc:	8b 1d b4 d5 10 80    	mov    0x8010d5b4,%ebx
    return -1;
  data = inb(KBDATAP);
...
801026df:	0f b6 8a 80 7d 10 80 	movzbl -0x7fef8280(%edx),%ecx
  shift ^= togglecode[data];
801026e6:	0f b6 82 80 7c 10 80 	movzbl -0x7fef8380(%edx),%eax
  shift |= shiftcode[data];
...
801026f1:	89 c8                	mov    %ecx,%eax
  shift ^= togglecode[data];
801026f3:	89 0d b4 d5 10 80    	mov    %ecx,0x8010d5b4
  c = charcode[shift & (CTL | SHIFT)][data];
801026f9:	83 e0 03             	and    $0x3,%eax
  if(shift & CAPSLOCK){
801026fc:	83 e1 08             	and    $0x8,%ecx
  c = charcode[shift & (CTL | SHIFT)][data];
801026ff:	8b 04 85 60 7c 10 80 	mov    -0x7fef83a0(,%eax,4),%eax
...
80102723:	31 c0                	xor    %eax,%eax
    shift |= E0ESC;
80102725:	89 1d b4 d5 10 80    	mov    %ebx,0x8010d5b4
}
8010272b:	5b                   	pop    %ebx
8010272c:	5d                   	pop    %ebp
8010272d:	c3                   	ret    
...
80102738:	31 c0                	xor    %eax,%eax
    shift &= ~(shiftcode[data] | E0ESC);
8010273a:	0f b6 8a 80 7d 10 80 	movzbl -0x7fef8280(%edx),%ecx
...
8010274c:	5d                   	pop    %ebp
    shift &= ~(shiftcode[data] | E0ESC);
8010274d:	89 0d b4 d5 10 80    	mov    %ecx,0x8010d5b4
}
80102753:	c3                   	ret    
...
801027a0:	f3 0f 1e fb          	endbr32 
  if(!lapic)
801027a4:	a1 dc 6c 13 80       	mov    0x80136cdc,%eax
...
801028a0:	f3 0f 1e fb          	endbr32 
  if (!lapic)
801028a4:	a1 dc 6c 13 80       	mov    0x80136cdc,%eax
...
801028c0:	f3 0f 1e fb          	endbr32 
  if(lapic)
801028c4:	a1 dc 6c 13 80       	mov    0x80136cdc,%eax
...
8010292c:	66 a3 69 04 00 80    	mov    %ax,0x80000469
  lapic[index] = value;
80102932:	a1 dc 6c 13 80       	mov    0x80136cdc,%eax
...
80102b90:	8b 0d 28 6d 13 80    	mov    0x80136d28,%ecx
...
80102bb0:	a1 14 6d 13 80       	mov    0x80136d14,%eax
80102bb5:	83 ec 08             	sub    $0x8,%esp
80102bb8:	01 f8                	add    %edi,%eax
80102bba:	83 c0 01             	add    $0x1,%eax
80102bbd:	50                   	push   %eax
80102bbe:	ff 35 24 6d 13 80    	pushl  0x80136d24
80102bc4:	e8 07 d5 ff ff       	call   801000d0 <bread>
80102bc9:	89 c6                	mov    %eax,%esi
    struct buf *dbuf = bread(log.dev, log.lh.block[tail]); // read dst
80102bcb:	58                   	pop    %eax
80102bcc:	5a                   	pop    %edx
80102bcd:	ff 34 bd 2c 6d 13 80 	pushl  -0x7fec92d4(,%edi,4)
80102bd4:	ff 35 24 6d 13 80    	pushl  0x80136d24
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102c14:	39 3d 28 6d 13 80    	cmp    %edi,0x80136d28
...
80102c37:	ff 35 14 6d 13 80    	pushl  0x80136d14
80102c3d:	ff 35 24 6d 13 80    	pushl  0x80136d24
...
80102c4b:	89 c3                	mov    %eax,%ebx
  hb->n = log.lh.n;
80102c4d:	a1 28 6d 13 80       	mov    0x80136d28,%eax
...
80102c60:	8b 0c 95 2c 6d 13 80 	mov    -0x7fec92d4(,%edx,4),%ecx
...
80102c9e:	68 80 7e 10 80       	push   $0x80107e80
80102ca3:	68 e0 6c 13 80       	push   $0x80136ce0
...
80102cbc:	59                   	pop    %ecx
  log.dev = dev;
80102cbd:	89 1d 24 6d 13 80    	mov    %ebx,0x80136d24
  log.size = sb.nlog;
80102cc3:	8b 55 e8             	mov    -0x18(%ebp),%edx
  log.start = sb.logstart;
80102cc6:	a3 14 6d 13 80       	mov    %eax,0x80136d14
  log.size = sb.nlog;
80102ccb:	89 15 18 6d 13 80    	mov    %edx,0x80136d18
  struct buf *buf = bread(log.dev, log.start);
80102cd1:	5a                   	pop    %edx
...
80102cdf:	89 0d 28 6d 13 80    	mov    %ecx,0x80136d28
  for (i = 0; i < log.lh.n; i++) {
...
80102cf4:	89 1c 95 2c 6d 13 80 	mov    %ebx,-0x7fec92d4(,%edx,4)
  for (i = 0; i < log.lh.n; i++) {
...
80102d0b:	e8 80 fe ff ff       	call   80102b90 <install_trans>
  log.lh.n = 0;
80102d10:	c7 05 28 6d 13 80 00 	movl   $0x0,0x80136d28
80102d17:	00 00 00 
...
80102d37:	83 ec 14             	sub    $0x14,%esp
  acquire(&log.lock);
80102d3a:	68 e0 6c 13 80       	push   $0x80136ce0
...
80102d53:	68 e0 6c 13 80       	push   $0x80136ce0
80102d58:	68 e0 6c 13 80       	push   $0x80136ce0
80102d5d:	e8 ce 11 00 00       	call   80103f30 <sleep>
80102d62:	83 c4 10             	add    $0x10,%esp
    if(log.committing){
80102d65:	a1 20 6d 13 80       	mov    0x80136d20,%eax
80102d6a:	85 c0                	test   %eax,%eax
80102d6c:	75 e2                	jne    80102d50 <begin_op+0x20>
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
80102d6e:	a1 1c 6d 13 80       	mov    0x80136d1c,%eax
80102d73:	8b 15 28 6d 13 80    	mov    0x80136d28,%edx
...
80102d87:	83 ec 0c             	sub    $0xc,%esp
      log.outstanding += 1;
80102d8a:	a3 1c 6d 13 80       	mov    %eax,0x80136d1c
      release(&log.lock);
80102d8f:	68 e0 6c 13 80       	push   $0x80136ce0
...
80102daa:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&log.lock);
80102dad:	68 e0 6c 13 80       	push   $0x80136ce0
80102db2:	e8 59 1a 00 00       	call   80104810 <acquire>
  log.outstanding -= 1;
80102db7:	a1 1c 6d 13 80       	mov    0x80136d1c,%eax
  if(log.committing)
80102dbc:	8b 35 20 6d 13 80    	mov    0x80136d20,%esi
80102dc2:	83 c4 10             	add    $0x10,%esp
  log.outstanding -= 1;
80102dc5:	8d 58 ff             	lea    -0x1(%eax),%ebx
80102dc8:	89 1d 1c 6d 13 80    	mov    %ebx,0x80136d1c
  if(log.committing)
...
80102dd8:	0f 85 f2 00 00 00    	jne    80102ed0 <end_op+0x130>
    do_commit = 1;
    log.committing = 1;
80102dde:	c7 05 20 6d 13 80 01 	movl   $0x1,0x80136d20
80102de5:	00 00 00 
...
80102deb:	68 e0 6c 13 80       	push   $0x80136ce0
...
{
  if (log.lh.n > 0) {
80102df5:	8b 0d 28 6d 13 80    	mov    0x80136d28,%ecx
80102dfb:	83 c4 10             	add    $0x10,%esp
80102dfe:	85 c9                	test   %ecx,%ecx
80102e00:	7f 3e                	jg     80102e40 <end_op+0xa0>
    acquire(&log.lock);
80102e02:	83 ec 0c             	sub    $0xc,%esp
80102e05:	68 e0 6c 13 80       	push   $0x80136ce0
80102e0a:	e8 01 1a 00 00       	call   80104810 <acquire>
    wakeup(&log);
80102e0f:	c7 04 24 e0 6c 13 80 	movl   $0x80136ce0,(%esp)
    log.committing = 0;
80102e16:	c7 05 20 6d 13 80 00 	movl   $0x0,0x80136d20
80102e1d:	00 00 00 
    wakeup(&log);
80102e20:	e8 cb 12 00 00       	call   801040f0 <wakeup>
    release(&log.lock);
80102e25:	c7 04 24 e0 6c 13 80 	movl   $0x80136ce0,(%esp)
...
80102e40:	a1 14 6d 13 80       	mov    0x80136d14,%eax
80102e45:	83 ec 08             	sub    $0x8,%esp
80102e48:	01 d8                	add    %ebx,%eax
80102e4a:	83 c0 01             	add    $0x1,%eax
80102e4d:	50                   	push   %eax
80102e4e:	ff 35 24 6d 13 80    	pushl  0x80136d24
80102e54:	e8 77 d2 ff ff       	call   801000d0 <bread>
80102e59:	89 c6                	mov    %eax,%esi
    struct buf *from = bread(log.dev, log.lh.block[tail]); // cache block
80102e5b:	58                   	pop    %eax
80102e5c:	5a                   	pop    %edx
80102e5d:	ff 34 9d 2c 6d 13 80 	pushl  -0x7fec92d4(,%ebx,4)
80102e64:	ff 35 24 6d 13 80    	pushl  0x80136d24
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102ea4:	3b 1d 28 6d 13 80    	cmp    0x80136d28,%ebx
...
80102eb1:	e8 da fc ff ff       	call   80102b90 <install_trans>
    log.lh.n = 0;
80102eb6:	c7 05 28 6d 13 80 00 	movl   $0x0,0x80136d28
80102ebd:	00 00 00 
...
80102ed3:	68 e0 6c 13 80       	push   $0x80136ce0
80102ed8:	e8 13 12 00 00       	call   801040f0 <wakeup>
  release(&log.lock);
80102edd:	c7 04 24 e0 6c 13 80 	movl   $0x80136ce0,(%esp)
...
80102ef7:	68 84 7e 10 80       	push   $0x80107e84
...
80102f1b:	8b 15 28 6d 13 80    	mov    0x80136d28,%edx
{
80102f21:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
80102f24:	83 fa 1d             	cmp    $0x1d,%edx
80102f27:	0f 8f 91 00 00 00    	jg     80102fbe <log_write+0xae>
80102f2d:	a1 18 6d 13 80       	mov    0x80136d18,%eax
80102f32:	83 e8 01             	sub    $0x1,%eax
80102f35:	39 c2                	cmp    %eax,%edx
80102f37:	0f 8d 81 00 00 00    	jge    80102fbe <log_write+0xae>
    panic("too big a transaction");
  if (log.outstanding < 1)
80102f3d:	a1 1c 6d 13 80       	mov    0x80136d1c,%eax
...
80102f4d:	68 e0 6c 13 80       	push   $0x80136ce0
80102f52:	e8 b9 18 00 00       	call   80104810 <acquire>
  for (i = 0; i < log.lh.n; i++) {
80102f57:	8b 15 28 6d 13 80    	mov    0x80136d28,%edx
...
80102f75:	74 29                	je     80102fa0 <log_write+0x90>
    if (log.lh.block[i] == b->blockno)   // log absorbtion
80102f77:	39 0c 85 2c 6d 13 80 	cmp    %ecx,-0x7fec92d4(,%eax,4)
80102f7e:	75 f0                	jne    80102f70 <log_write+0x60>
      break;
  }
  log.lh.block[i] = b->blockno;
80102f80:	89 0c 85 2c 6d 13 80 	mov    %ecx,-0x7fec92d4(,%eax,4)
  if (i == log.lh.n)
    log.lh.n++;
...
80102f8a:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  release(&log.lock);
80102f8d:	c7 45 08 e0 6c 13 80 	movl   $0x80136ce0,0x8(%ebp)
}
80102f94:	c9                   	leave  
  release(&log.lock);
...
80102f9a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  log.lh.block[i] = b->blockno;
80102fa0:	89 0c 95 2c 6d 13 80 	mov    %ecx,-0x7fec92d4(,%edx,4)
    log.lh.n++;
80102fa7:	83 c2 01             	add    $0x1,%edx
80102faa:	89 15 28 6d 13 80    	mov    %edx,0x80136d28
80102fb0:	eb d5                	jmp    80102f87 <log_write+0x77>
  log.lh.block[i] = b->blockno;
80102fb2:	8b 43 08             	mov    0x8(%ebx),%eax
80102fb5:	a3 2c 6d 13 80       	mov    %eax,0x80136d2c
  if (i == log.lh.n)
80102fba:	75 cb                	jne    80102f87 <log_write+0x77>
80102fbc:	eb e9                	jmp    80102fa7 <log_write+0x97>
    panic("too big a transaction");
80102fbe:	83 ec 0c             	sub    $0xc,%esp
80102fc1:	68 93 7e 10 80       	push   $0x80107e93
80102fc6:	e8 c5 d3 ff ff       	call   80100390 <panic>
    panic("log_write outside of trans");
80102fcb:	83 ec 0c             	sub    $0xc,%esp
80102fce:	68 a9 7e 10 80       	push   $0x80107ea9
...
80102ff8:	68 c4 7e 10 80       	push   $0x80107ec4
80102ffd:	e8 ae d6 ff ff       	call   801006b0 <cprintf>
  idtinit();       // load idt register
80103002:	e8 19 32 00 00       	call   80106220 <idtinit>
...
80103027:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
8010302a:	e8 c1 42 00 00       	call   801072f0 <switchkvm>
  seginit();
8010302f:	e8 2c 42 00 00       	call   80107260 <seginit>
  lapicinit();
...
8010305b:	68 c8 9f 13 80       	push   $0x80139fc8
80103060:	e8 fb f4 ff ff       	call   80102560 <kinit1>
  kvmalloc();      // kernel page table
80103065:	e8 66 47 00 00       	call   801077d0 <kvmalloc>
  mpinit();        // detect other processors
8010306a:	e8 81 01 00 00       	call   801031f0 <mpinit>
  lapicinit();     // interrupt controller
8010306f:	e8 2c f7 ff ff       	call   801027a0 <lapicinit>
  seginit();       // segment descriptors
80103074:	e8 e7 41 00 00       	call   80107260 <seginit>
  picinit();       // disable pic
...
80103088:	e8 93 34 00 00       	call   80106520 <uartinit>
  pinit();         // process table
8010308d:	e8 2e 08 00 00       	call   801038c0 <pinit>
  tvinit();        // trap vectors
80103092:	e8 09 31 00 00       	call   801061a0 <tvinit>
  binit();         // buffer cache
...
801030ae:	68 8c d4 10 80       	push   $0x8010d48c
801030b3:	68 00 70 00 80       	push   $0x80007000
801030b8:	e8 03 19 00 00       	call   801049c0 <memmove>

  for(c = cpus; c < cpus+ncpu; c++){
801030bd:	83 c4 10             	add    $0x10,%esp
801030c0:	69 05 60 73 13 80 b0 	imul   $0xb0,0x80137360,%eax
801030c7:	00 00 00 
801030ca:	05 e0 6d 13 80       	add    $0x80136de0,%eax
801030cf:	3d e0 6d 13 80       	cmp    $0x80136de0,%eax
801030d4:	76 7a                	jbe    80103150 <main+0x110>
801030d6:	bb e0 6d 13 80       	mov    $0x80136de0,%ebx
801030db:	eb 1c                	jmp    801030f9 <main+0xb9>
801030dd:	8d 76 00             	lea    0x0(%esi),%esi
801030e0:	69 05 60 73 13 80 b0 	imul   $0xb0,0x80137360,%eax
801030e7:	00 00 00 
801030ea:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
801030f0:	05 e0 6d 13 80       	add    $0x80136de0,%eax
...
8010319e:	68 d8 7e 10 80       	push   $0x80107ed8
...
8010325a:	68 dd 7e 10 80       	push   $0x80107edd
...
801032be:	a3 dc 6c 13 80       	mov    %eax,0x80136cdc
...
8010334c:	83 c0 08             	add    $0x8,%eax
      ioapicid = ioapic->apicno;
8010334f:	88 0d c0 6d 13 80    	mov    %cl,0x80136dc0
      continue;
80103355:	eb 89                	jmp    801032e0 <mpinit+0xf0>
80103357:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010335e:	66 90                	xchg   %ax,%ax
      if(ncpu < NCPU) {
80103360:	8b 0d 60 73 13 80    	mov    0x80137360,%ecx
...
80103378:	89 0d 60 73 13 80    	mov    %ecx,0x80137360
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
8010337e:	88 9f e0 6d 13 80    	mov    %bl,-0x7fec9220(%edi)
...
801033b3:	68 e2 7e 10 80       	push   $0x80107ee2
801033b8:	e8 d3 cf ff ff       	call   80100390 <panic>
    panic("Didn't find a suitable machine");
801033bd:	83 ec 0c             	sub    $0xc,%esp
801033c0:	68 fc 7e 10 80       	push   $0x80107efc
...
80103464:	00 00 00 
  initlock(&p->lock, "pipe");
80103467:	68 c7 81 10 80       	push   $0x801081c7
...
80103794:	bb d4 73 13 80       	mov    $0x801373d4,%ebx
{
80103799:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
8010379c:	68 a0 73 13 80       	push   $0x801373a0
...
801037b6:	81 fb d4 96 13 80    	cmp    $0x801396d4,%ebx
...
801037d7:	8d 50 01             	lea    0x1(%eax),%edx
  release(&ptable.lock);
801037da:	68 a0 73 13 80       	push   $0x801373a0
  p->pid = nextpid++;
801037df:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
  release(&ptable.lock);
801037e5:	e8 e6 10 00 00       	call   801048d0 <release>
...
80103807:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010380a:	c7 40 14 89 61 10 80 	movl   $0x80106189,0x14(%eax)
  p->context = (struct context*)sp;
...
80103819:	e8 02 11 00 00       	call   80104920 <memset>
...
8010383b:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
8010383d:	68 a0 73 13 80       	push   $0x801373a0
80103842:	e8 89 10 00 00       	call   801048d0 <release>
}
...
80103877:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
8010387a:	68 a0 73 13 80       	push   $0x801373a0
8010387f:	e8 4c 10 00 00       	call   801048d0 <release>
...
801038ca:	68 1b 7f 10 80       	push   $0x80107f1b
801038cf:	68 a0 73 13 80       	push   $0x801373a0
801038d4:	e8 b7 0d 00 00       	call   80104690 <initlock>
}
...
801038f0:	e8 ab ef ff ff       	call   801028a0 <lapicid>
  for (i = 0; i < ncpu; ++i) {
801038f5:	8b 35 60 73 13 80    	mov    0x80137360,%esi
  apicid = lapicid();
...
80103915:	0f b6 81 e0 6d 13 80 	movzbl -0x7fec9220(%ecx),%eax
8010391c:	39 d8                	cmp    %ebx,%eax
8010391e:	75 e8                	jne    80103908 <mycpu+0x28>
}
80103920:	8d 65 f8             	lea    -0x8(%ebp),%esp
      return &cpus[i];
80103923:	8d 81 e0 6d 13 80    	lea    -0x7fec9220(%ecx),%eax
}
80103929:	5b                   	pop    %ebx
8010392a:	5e                   	pop    %esi
8010392b:	5d                   	pop    %ebp
...
8010395f:	c9                   	leave  
  return mycpu()-cpus;
80103960:	2d e0 6d 13 80       	sub    $0x80136de0,%eax
...
80103978:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010397b:	e8 90 0d 00 00       	call   80104710 <pushcli>
  c = mycpu();
80103980:	e8 5b ff ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103985:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010398b:	e8 d0 0d 00 00       	call   80104760 <popcli>
}
...
801039b0:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039b2:	a3 b8 d5 10 80       	mov    %eax,0x8010d5b8
  if((p->pgdir = setupkvm()) == 0)
801039b7:	e8 94 3d 00 00       	call   80107750 <setupkvm>
...
801039cf:	68 60 d4 10 80       	push   $0x8010d460
801039d4:	50                   	push   %eax
801039d5:	e8 46 3a 00 00       	call   80107420 <inituvm>
...
801039ea:	e8 31 0f 00 00       	call   80104920 <memset>
...
80103a43:	68 4b 7f 10 80       	push   $0x80107f4b
80103a48:	50                   	push   %eax
80103a49:	e8 92 10 00 00       	call   80104ae0 <safestrcpy>
  p->cwd = namei("/");
80103a4e:	c7 04 24 54 7f 10 80 	movl   $0x80107f54,(%esp)
80103a55:	e8 d6 e5 ff ff       	call   80102030 <namei>
80103a5a:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103a5d:	c7 04 24 a0 73 13 80 	movl   $0x801373a0,(%esp)
80103a64:	e8 a7 0d 00 00       	call   80104810 <acquire>
  p->state = RUNNABLE;
80103a69:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103a70:	c7 04 24 a0 73 13 80 	movl   $0x801373a0,(%esp)
80103a77:	e8 54 0e 00 00       	call   801048d0 <release>
}
...
80103a87:	68 32 7f 10 80       	push   $0x80107f32
...
80103acf:	e8 3c 38 00 00       	call   80107310 <switchuvm>
  return 0;
...
80103aea:	e8 81 3a 00 00       	call   80107570 <allocuvm>
...
80103b0a:	e8 91 3b 00 00       	call   801076a0 <deallocuvm>
...
80103b2a:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b2d:	e8 de 0b 00 00       	call   80104710 <pushcli>
  c = mycpu();
80103b32:	e8 a9 fd ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103b37:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b3d:	e8 1e 0c 00 00       	call   80104760 <popcli>
  if((np = allocproc()) == 0){
...
80103b5c:	e8 bf 3c 00 00       	call   80107820 <copyuvm>
...
80103bd9:	e8 02 0f 00 00       	call   80104ae0 <safestrcpy>
  pid = np->pid;
80103bde:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103be1:	c7 04 24 a0 73 13 80 	movl   $0x801373a0,(%esp)
80103be8:	e8 23 0c 00 00       	call   80104810 <acquire>
  np->state = RUNNABLE;
80103bed:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103bf4:	c7 04 24 a0 73 13 80 	movl   $0x801373a0,(%esp)
80103bfb:	e8 d0 0c 00 00       	call   801048d0 <release>
  return pid;
...
80103c69:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c6c:	bb d4 73 13 80       	mov    $0x801373d4,%ebx
    acquire(&ptable.lock);
80103c71:	68 a0 73 13 80       	push   $0x801373a0
80103c76:	e8 95 0b 00 00       	call   80104810 <acquire>
...
80103c90:	e8 7b 36 00 00       	call   80107310 <switchuvm>
...
80103c9b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103ca2:	e8 9c 0e 00 00       	call   80104b43 <swtch>
      switchkvm();
80103ca7:	e8 44 36 00 00       	call   801072f0 <switchkvm>
      c->proc = 0;
...
80103cbf:	81 fb d4 96 13 80    	cmp    $0x801396d4,%ebx
80103cc5:	75 b9                	jne    80103c80 <scheduler+0x40>
    release(&ptable.lock);
80103cc7:	83 ec 0c             	sub    $0xc,%esp
80103cca:	68 a0 73 13 80       	push   $0x801373a0
80103ccf:	e8 fc 0b 00 00       	call   801048d0 <release>
    sti();
...
80103ce8:	53                   	push   %ebx
  pushcli();
80103ce9:	e8 22 0a 00 00       	call   80104710 <pushcli>
  c = mycpu();
80103cee:	e8 ed fb ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103cf3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103cf9:	e8 62 0a 00 00       	call   80104760 <popcli>
  if(!holding(&ptable.lock))
80103cfe:	83 ec 0c             	sub    $0xc,%esp
80103d01:	68 a0 73 13 80       	push   $0x801373a0
80103d06:	e8 b5 0a 00 00       	call   801047c0 <holding>
...
80103d47:	e8 f7 0d 00 00       	call   80104b43 <swtch>
  mycpu()->intena = intena;
...
80103e0c:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103e13:	c7 04 24 a0 73 13 80 	movl   $0x801373a0,(%esp)
80103e1a:	e8 f1 09 00 00       	call   80104810 <acquire>
...
80103e53:	3d d4 96 13 80       	cmp    $0x801396d4,%eax
80103e58:	75 e2                	jne    80103e3c <exit+0x9c>
      p->parent = initproc;
80103e5a:	8b 0d b8 d5 10 80    	mov    0x8010d5b8,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e60:	ba d4 73 13 80       	mov    $0x801373d4,%edx
...
80103e76:	81 fa d4 96 13 80    	cmp    $0x801396d4,%edx
...
80103ec7:	68 a3 7f 10 80       	push   $0x80107fa3
80103ecc:	e8 bf c4 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103ed1:	83 ec 0c             	sub    $0xc,%esp
80103ed4:	68 96 7f 10 80       	push   $0x80107f96
...
80103eeb:	68 a0 73 13 80       	push   $0x801373a0
80103ef0:	e8 1b 09 00 00       	call   80104810 <acquire>
  pushcli();
80103ef5:	e8 16 08 00 00       	call   80104710 <pushcli>
  c = mycpu();
80103efa:	e8 e1 f9 ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103eff:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f05:	e8 56 08 00 00       	call   80104760 <popcli>
  myproc()->state = RUNNABLE;
80103f0a:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
80103f11:	e8 ca fd ff ff       	call   80103ce0 <sched>
  release(&ptable.lock);
80103f16:	c7 04 24 a0 73 13 80 	movl   $0x801373a0,(%esp)
80103f1d:	e8 ae 09 00 00       	call   801048d0 <release>
}
...
80103f40:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103f43:	e8 c8 07 00 00       	call   80104710 <pushcli>
  c = mycpu();
...
80103f64:	81 fe a0 73 13 80    	cmp    $0x801373a0,%esi
80103f6a:	74 4c                	je     80103fb8 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103f6c:	83 ec 0c             	sub    $0xc,%esp
80103f6f:	68 a0 73 13 80       	push   $0x801373a0
80103f74:	e8 97 08 00 00       	call   80104810 <acquire>
    release(lk);
80103f79:	89 34 24             	mov    %esi,(%esp)
80103f7c:	e8 4f 09 00 00       	call   801048d0 <release>
  p->chan = chan;
...
80103f90:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80103f97:	c7 04 24 a0 73 13 80 	movl   $0x801373a0,(%esp)
80103f9e:	e8 2d 09 00 00       	call   801048d0 <release>
    acquire(lk);
...
80103faf:	5d                   	pop    %ebp
    acquire(lk);
80103fb0:	e9 5b 08 00 00       	jmp    80104810 <acquire>
...
80103fd9:	68 af 7f 10 80       	push   $0x80107faf
80103fde:	e8 ad c3 ff ff       	call   80100390 <panic>
    panic("sleep");
80103fe3:	83 ec 0c             	sub    $0xc,%esp
80103fe6:	68 1b 82 10 80       	push   $0x8010821b
...
80103ff8:	53                   	push   %ebx
  pushcli();
80103ff9:	e8 12 07 00 00       	call   80104710 <pushcli>
  c = mycpu();
80103ffe:	e8 dd f8 ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80104003:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104009:	e8 52 07 00 00       	call   80104760 <popcli>
  acquire(&ptable.lock);
8010400e:	83 ec 0c             	sub    $0xc,%esp
80104011:	68 a0 73 13 80       	push   $0x801373a0
80104016:	e8 f5 07 00 00       	call   80104810 <acquire>
8010401b:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
8010401e:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104020:	bb d4 73 13 80       	mov    $0x801373d4,%ebx
80104025:	eb 17                	jmp    8010403e <wait+0x4e>
80104027:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010402e:	66 90                	xchg   %ax,%ax
80104030:	81 c3 8c 00 00 00    	add    $0x8c,%ebx
80104036:	81 fb d4 96 13 80    	cmp    $0x801396d4,%ebx
...
80104047:	74 37                	je     80104080 <wait+0x90>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104049:	81 c3 8c 00 00 00    	add    $0x8c,%ebx
      havekids = 1;
8010404f:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104054:	81 fb d4 96 13 80    	cmp    $0x801396d4,%ebx
...
8010406a:	68 a0 73 13 80       	push   $0x801373a0
...
80104092:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104099:	e8 32 36 00 00       	call   801076d0 <freevm>
        release(&ptable.lock);
8010409e:	c7 04 24 a0 73 13 80 	movl   $0x801373a0,(%esp)
        p->pid = 0;
...
801040be:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
801040c5:	e8 06 08 00 00       	call   801048d0 <release>
        return pid;
...
801040d9:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801040de:	68 a0 73 13 80       	push   $0x801373a0
801040e3:	e8 e8 07 00 00       	call   801048d0 <release>
      return -1;
...
801040fb:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
801040fe:	68 a0 73 13 80       	push   $0x801373a0
80104103:	e8 08 07 00 00       	call   80104810 <acquire>
80104108:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010410b:	b8 d4 73 13 80       	mov    $0x801373d4,%eax
80104110:	eb 12                	jmp    80104124 <wakeup+0x34>
80104112:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104118:	05 8c 00 00 00       	add    $0x8c,%eax
8010411d:	3d d4 96 13 80       	cmp    $0x801396d4,%eax
...
8010412f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104136:	05 8c 00 00 00       	add    $0x8c,%eax
8010413b:	3d d4 96 13 80       	cmp    $0x801396d4,%eax
80104140:	75 e2                	jne    80104124 <wakeup+0x34>
  wakeup1(chan);
  release(&ptable.lock);
80104142:	c7 45 08 a0 73 13 80 	movl   $0x801373a0,0x8(%ebp)
}
80104149:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010414c:	c9                   	leave  
  release(&ptable.lock);
8010414d:	e9 7e 07 00 00       	jmp    801048d0 <release>
...
8010416b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
8010416e:	68 a0 73 13 80       	push   $0x801373a0
80104173:	e8 98 06 00 00       	call   80104810 <acquire>
80104178:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010417b:	b8 d4 73 13 80       	mov    $0x801373d4,%eax
80104180:	eb 12                	jmp    80104194 <kill+0x34>
80104182:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104188:	05 8c 00 00 00       	add    $0x8c,%eax
8010418d:	3d d4 96 13 80       	cmp    $0x801396d4,%eax
...
801041b0:	68 a0 73 13 80       	push   $0x801373a0
801041b5:	e8 16 07 00 00       	call   801048d0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801041cb:	68 a0 73 13 80       	push   $0x801373a0
801041d0:	e8 fb 06 00 00       	call   801048d0 <release>
}
...
801041fd:	bb 40 74 13 80       	mov    $0x80137440,%ebx
...
80104213:	68 4b 84 10 80       	push   $0x8010844b
80104218:	e8 93 c4 ff ff       	call   801006b0 <cprintf>
8010421d:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104220:	81 c3 8c 00 00 00    	add    $0x8c,%ebx
80104226:	81 fb 40 97 13 80    	cmp    $0x80139740,%ebx
...
80104237:	74 e7                	je     80104220 <procdump+0x30>
      state = "???";
80104239:	ba c0 7f 10 80       	mov    $0x80107fc0,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010423e:	83 f8 05             	cmp    $0x5,%eax
80104241:	77 11                	ja     80104254 <procdump+0x64>
80104243:	8b 14 85 38 80 10 80 	mov    -0x7fef7fc8(,%eax,4),%edx
      state = "???";
8010424a:	b8 c0 7f 10 80       	mov    $0x80107fc0,%eax
...
80104259:	68 c4 7f 10 80       	push   $0x80107fc4
...
80104280:	e8 2b 04 00 00       	call   801046b0 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801042a1:	68 21 7a 10 80       	push   $0x80107a21
...
801042d7:	53                   	push   %ebx
  struct proc *p;
  for(p=ptable.proc;p<&ptable.proc[NPROC];p++){
801042d8:	bb d4 73 13 80       	mov    $0x801373d4,%ebx
ps(void){
801042dd:	83 ec 04             	sub    $0x4,%esp
801042e0:	eb 14                	jmp    801042f6 <ps+0x26>
801042e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p=ptable.proc;p<&ptable.proc[NPROC];p++){
801042e8:	81 c3 8c 00 00 00    	add    $0x8c,%ebx
801042ee:	81 fb d4 96 13 80    	cmp    $0x801396d4,%ebx
801042f4:	74 36                	je     8010432c <ps+0x5c>
    if(p->state!=UNUSED)cprintf("%s%d %s%s\n","pid:",p->pid,"name:", p->name);
801042f6:	8b 43 0c             	mov    0xc(%ebx),%eax
801042f9:	85 c0                	test   %eax,%eax
801042fb:	74 eb                	je     801042e8 <ps+0x18>
801042fd:	83 ec 0c             	sub    $0xc,%esp
80104300:	8d 43 6c             	lea    0x6c(%ebx),%eax
  for(p=ptable.proc;p<&ptable.proc[NPROC];p++){
80104303:	81 c3 8c 00 00 00    	add    $0x8c,%ebx
    if(p->state!=UNUSED)cprintf("%s%d %s%s\n","pid:",p->pid,"name:", p->name);
80104309:	50                   	push   %eax
8010430a:	68 cd 7f 10 80       	push   $0x80107fcd
8010430f:	ff 73 84             	pushl  -0x7c(%ebx)
80104312:	68 d3 7f 10 80       	push   $0x80107fd3
80104317:	68 d8 7f 10 80       	push   $0x80107fd8
8010431c:	e8 8f c3 ff ff       	call   801006b0 <cprintf>
80104321:	83 c4 20             	add    $0x20,%esp
  for(p=ptable.proc;p<&ptable.proc[NPROC];p++){
80104324:	81 fb d4 96 13 80    	cmp    $0x801396d4,%ebx
8010432a:	75 ca                	jne    801042f6 <ps+0x26>
  }
  return 0;
}
8010432c:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010432f:	31 c0                	xor    %eax,%eax
80104331:	c9                   	leave  
80104332:	c3                   	ret    
...
8010434b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  int done = 0;
  acquire(&ptable.lock);
8010434e:	68 a0 73 13 80       	push   $0x801373a0
80104353:	e8 b8 04 00 00       	call   80104810 <acquire>
80104358:	83 c4 10             	add    $0x10,%esp
  for(p=ptable.proc;p<&ptable.proc[NPROC];p++){
8010435b:	b8 d4 73 13 80       	mov    $0x801373d4,%eax
80104360:	eb 12                	jmp    80104374 <exec_time+0x34>
80104362:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104368:	05 8c 00 00 00       	add    $0x8c,%eax
8010436d:	3d d4 96 13 80       	cmp    $0x801396d4,%eax
80104372:	74 2c                	je     801043a0 <exec_time+0x60>
    if(p->pid==pid){
80104374:	39 58 10             	cmp    %ebx,0x10(%eax)
80104377:	75 ef                	jne    80104368 <exec_time+0x28>
...
8010437c:	83 ec 0c             	sub    $0xc,%esp
      p->exec_time = exec_time;
8010437f:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)
  release(&ptable.lock);
80104385:	68 a0 73 13 80       	push   $0x801373a0
8010438a:	e8 41 05 00 00       	call   801048d0 <release>
  if(done==1)return 0;
  return -22;
}
...
801043a3:	68 a0 73 13 80       	push   $0x801373a0
801043a8:	e8 23 05 00 00       	call   801048d0 <release>
}
801043ad:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801043b0:	83 c4 10             	add    $0x10,%esp
  return -22;
801043b3:	b8 ea ff ff ff       	mov    $0xffffffea,%eax
}
801043b8:	c9                   	leave  
801043b9:	c3                   	ret    
...
801043cb:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  int done = 0;
  acquire(&ptable.lock);
801043ce:	68 a0 73 13 80       	push   $0x801373a0
801043d3:	e8 38 04 00 00       	call   80104810 <acquire>
801043d8:	83 c4 10             	add    $0x10,%esp
  for(p=ptable.proc;p<&ptable.proc[NPROC];p++){
801043db:	b8 d4 73 13 80       	mov    $0x801373d4,%eax
801043e0:	eb 12                	jmp    801043f4 <deadline+0x34>
801043e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801043e8:	05 8c 00 00 00       	add    $0x8c,%eax
801043ed:	3d d4 96 13 80       	cmp    $0x801396d4,%eax
801043f2:	74 2c                	je     80104420 <deadline+0x60>
    if(p->pid==pid){
801043f4:	39 58 10             	cmp    %ebx,0x10(%eax)
801043f7:	75 ef                	jne    801043e8 <deadline+0x28>
      p->deadline = deadline;
801043f9:	8b 55 0c             	mov    0xc(%ebp),%edx
      done = 1;
      break;
    }
  }
...
801043fc:	83 ec 0c             	sub    $0xc,%esp
      p->deadline = deadline;
801043ff:	89 50 7c             	mov    %edx,0x7c(%eax)
  release(&ptable.lock);
80104402:	68 a0 73 13 80       	push   $0x801373a0
80104407:	e8 c4 04 00 00       	call   801048d0 <release>
  if(done==1)return 0;
  return -22;
}
...
80104423:	68 a0 73 13 80       	push   $0x801373a0
80104428:	e8 a3 04 00 00       	call   801048d0 <release>
}
8010442d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104430:	83 c4 10             	add    $0x10,%esp
  return -22;
80104433:	b8 ea ff ff ff       	mov    $0xffffffea,%eax
}
80104438:	c9                   	leave  
80104439:	c3                   	ret    
...
8010444b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  int done = 0;
  acquire(&ptable.lock);
8010444e:	68 a0 73 13 80       	push   $0x801373a0
80104453:	e8 b8 03 00 00       	call   80104810 <acquire>
80104458:	83 c4 10             	add    $0x10,%esp
  for(p=ptable.proc;p<&ptable.proc[NPROC];p++){
8010445b:	b8 d4 73 13 80       	mov    $0x801373d4,%eax
80104460:	eb 12                	jmp    80104474 <rate+0x34>
80104462:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104468:	05 8c 00 00 00       	add    $0x8c,%eax
8010446d:	3d d4 96 13 80       	cmp    $0x801396d4,%eax
80104472:	74 2c                	je     801044a0 <rate+0x60>
    if(p->pid==pid){
80104474:	39 58 10             	cmp    %ebx,0x10(%eax)
80104477:	75 ef                	jne    80104468 <rate+0x28>
      p->rate = rate;
80104479:	8b 55 0c             	mov    0xc(%ebp),%edx
      done = 1;
      break;
    }
  }
...
8010447c:	83 ec 0c             	sub    $0xc,%esp
      p->rate = rate;
8010447f:	89 90 84 00 00 00    	mov    %edx,0x84(%eax)
  release(&ptable.lock);
80104485:	68 a0 73 13 80       	push   $0x801373a0
8010448a:	e8 41 04 00 00       	call   801048d0 <release>
  if(done==1)return 0;
  return -22;
}
8010448f:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  if(done==1)return 0;
...
801044a3:	68 a0 73 13 80       	push   $0x801373a0
801044a8:	e8 23 04 00 00       	call   801048d0 <release>
}
801044ad:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801044b0:	83 c4 10             	add    $0x10,%esp
  return -22;
801044b3:	b8 ea ff ff ff       	mov    $0xffffffea,%eax
}
801044b8:	c9                   	leave  
801044b9:	c3                   	ret    
801044ba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

801044c0 <sched_policy>:
...
801044d2:	68 a0 73 13 80       	push   $0x801373a0
801044d7:	e8 34 03 00 00       	call   80104810 <acquire>
801044dc:	83 c4 10             	add    $0x10,%esp
  for(p=ptable.proc;p<&ptable.proc[NPROC];p++){
801044df:	b8 d4 73 13 80       	mov    $0x801373d4,%eax
801044e4:	eb 16                	jmp    801044fc <sched_policy+0x3c>
801044e6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801044ed:	8d 76 00             	lea    0x0(%esi),%esi
801044f0:	05 8c 00 00 00       	add    $0x8c,%eax
801044f5:	3d d4 96 13 80       	cmp    $0x801396d4,%eax
801044fa:	74 34                	je     80104530 <sched_policy+0x70>
    if(p->pid==pid){
801044fc:	39 58 10             	cmp    %ebx,0x10(%eax)
801044ff:	75 ef                	jne    801044f0 <sched_policy+0x30>
      p->policy = policy;
      done = 1;
      cprintf("%d\n",p->policy);
80104501:	83 ec 08             	sub    $0x8,%esp
      p->policy = policy;
80104504:	89 b0 88 00 00 00    	mov    %esi,0x88(%eax)
      cprintf("%d\n",p->policy);
8010450a:	56                   	push   %esi
8010450b:	68 d4 7e 10 80       	push   $0x80107ed4
80104510:	e8 9b c1 ff ff       	call   801006b0 <cprintf>
      break;
    }
  }
  release(&ptable.lock);
80104515:	c7 04 24 a0 73 13 80 	movl   $0x801373a0,(%esp)
8010451c:	e8 af 03 00 00       	call   801048d0 <release>
  if(done==1)return 0;
80104521:	83 c4 10             	add    $0x10,%esp
  return -22;
80104524:	8d 65 f8             	lea    -0x8(%ebp),%esp
  if(done==1)return 0;
80104527:	31 c0                	xor    %eax,%eax
80104529:	5b                   	pop    %ebx
8010452a:	5e                   	pop    %esi
8010452b:	5d                   	pop    %ebp
8010452c:	c3                   	ret    
...
80104533:	68 a0 73 13 80       	push   $0x801373a0
80104538:	e8 93 03 00 00       	call   801048d0 <release>
  if(done==1)return 0;
8010453d:	83 c4 10             	add    $0x10,%esp
80104540:	8d 65 f8             	lea    -0x8(%ebp),%esp
  return -22;
80104543:	b8 ea ff ff ff       	mov    $0xffffffea,%eax
80104548:	5b                   	pop    %ebx
80104549:	5e                   	pop    %esi
8010454a:	5d                   	pop    %ebp
8010454b:	c3                   	ret    
...
8010455e:	68 50 80 10 80       	push   $0x80108050
...
801045bd:	e8 6e f9 ff ff       	call   80103f30 <sleep>
  while (lk->locked) {
...
801045cb:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801045d1:	e8 9a f3 ff ff       	call   80103970 <myproc>
...
80104618:	e8 d3 fa ff ff       	call   801040f0 <wakeup>
  release(&lk->lk);
...
80104673:	e8 f8 f2 ff ff       	call   80103970 <myproc>
...
8010473f:	90                   	nop
    mycpu()->intena = eflags & FL_IF;
80104740:	e8 9b f1 ff ff       	call   801038e0 <mycpu>
...
8010478f:	c3                   	ret    
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104790:	e8 4b f1 ff ff       	call   801038e0 <mycpu>
...
801047a5:	68 5b 80 10 80       	push   $0x8010805b
801047aa:	e8 e1 bb ff ff       	call   80100390 <panic>
    panic("popcli");
801047af:	83 ec 0c             	sub    $0xc,%esp
801047b2:	68 72 80 10 80       	push   $0x80108072
...
801047eb:	e8 f0 f0 ff ff       	call   801038e0 <mycpu>
...
80104854:	e8 87 f0 ff ff       	call   801038e0 <mycpu>
...
801048b7:	68 79 80 10 80       	push   $0x80108079
...
80104910:	68 81 80 10 80       	push   $0x80108081
...
80104bab:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104bae:	e8 bd ed ff ff       	call   80103970 <myproc>
...
80104c17:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104c1a:	e8 51 ed ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104c5c:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104c5f:	e8 0c ed ff ff       	call   80103970 <myproc>
...
80104cf8:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104cfb:	e8 70 ec ff ff       	call   80103970 <myproc>
...
80104d05:	8b 40 1c             	mov    0x1c(%eax),%eax
  ...
  if(num<=ONSC){
80104d08:	83 f8 15             	cmp    $0x15,%eax
80104d0b:	7f 08                	jg     80104d15 <syscall+0x25>
    CALLS[num]++;
80104d0d:	83 04 85 e0 96 13 80 	addl   $0x1,-0x7fec6920(,%eax,4)
80104d14:	01 
  }

  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104d15:	8d 50 ff             	lea    -0x1(%eax),%edx
80104d18:	83 fa 1f             	cmp    $0x1f,%edx
80104d1b:	77 23                	ja     80104d40 <syscall+0x50>
80104d1d:	8b 14 85 c0 80 10 80 	mov    -0x7fef7f40(,%eax,4),%edx
80104d24:	85 d2                	test   %edx,%edx
80104d26:	74 18                	je     80104d40 <syscall+0x50>
    curproc->tf->eax = syscalls[num]();
80104d28:	ff d2                	call   *%edx
80104d2a:	89 c2                	mov    %eax,%edx
80104d2c:	8b 43 18             	mov    0x18(%ebx),%eax
80104d2f:	89 50 1c             	mov    %edx,0x1c(%eax)
  } else {
...
80104d48:	68 89 80 10 80       	push   $0x80108089
...
80104ea4:	68 60 81 10 80       	push   $0x80108160
...
80104ebc:	68 5f 81 10 80       	push   $0x8010815f
...
80104ed1:	68 53 81 10 80       	push   $0x80108153
...
80104eef:	68 62 81 10 80       	push   $0x80108162
80104ef4:	e8 97 b4 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104ef9:	83 ec 0c             	sub    $0xc,%esp
80104efc:	68 44 81 10 80       	push   $0x80108144
...
80104f22:	e8 d9 fc ff ff       	call   80104c00 <argint>
...
80104f34:	e8 37 ea ff ff       	call   80103970 <myproc>
...
80104f7d:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104f7f:	e8 ec e9 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80104ff1:	e8 0a fc ff ff       	call   80104c00 <argint>
...
80105009:	e8 42 fc ff ff       	call   80104c50 <argptr>
...
80105061:	e8 9a fb ff ff       	call   80104c00 <argint>
...
80105079:	e8 d2 fb ff ff       	call   80104c50 <argptr>
...
801050c7:	78 27                	js     801050f0 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
801050c9:	e8 a2 e8 ff ff       	call   80103970 <myproc>
...
80105123:	e8 28 fb ff ff       	call   80104c50 <argptr>
...
80105163:	e8 48 fb ff ff       	call   80104cb0 <argstr>
...
8010517c:	e8 2f fb ff ff       	call   80104cb0 <argstr>
...
801052b3:	e8 f8 f9 ff ff       	call   80104cb0 <argstr>
...
801052ed:	58                   	pop    %eax
801052ee:	5a                   	pop    %edx
801052ef:	68 60 81 10 80       	push   $0x80108160
...
80105308:	68 5f 81 10 80       	push   $0x8010815f
...
80105362:	e8 b9 f5 ff ff       	call   80104920 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80105493:	e8 18 f8 ff ff       	call   80104cb0 <argstr>
...
801054ac:	e8 4f f7 ff ff       	call   80104c00 <argint>
...
801055d8:	e8 d3 f6 ff ff       	call   80104cb0 <argstr>
...
80105648:	e8 63 f6 ff ff       	call   80104cb0 <argstr>
...
8010565d:	e8 9e f5 ff ff       	call   80104c00 <argint>
  if((argstr(0, &path)) < 0 ||
...
80105672:	e8 89 f5 ff ff       	call   80104c00 <argint>
     argint(1, &major) < 0 ||
...
801056d9:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801056dc:	e8 8f e2 ff ff       	call   80103970 <myproc>
...
801056f1:	e8 ba f5 ff ff       	call   80104cb0 <argstr>
...
80105799:	e8 12 f5 ff ff       	call   80104cb0 <argstr>
...
801057b5:	e8 46 f4 ff ff       	call   80104c00 <argint>
...
801057da:	e8 41 f1 ff ff       	call   80104920 <memset>
...
801057fc:	e8 5f f3 ff ff       	call   80104b60 <fetchint>
...
80105820:	e8 7b f3 ff ff       	call   80104ba0 <fetchstr>
...
80105895:	e8 b6 f3 ff ff       	call   80104c50 <argptr>
...
801058bb:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801058bd:	e8 ae e0 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105969:	8b 75 0c             	mov    0xc(%ebp),%esi
8010596c:	8b 5d 08             	mov    0x8(%ebp),%ebx
  memmove(buffers[index], (char**)ch, MSSG_SIZE);
8010596f:	8d 04 f5 e0 b0 10 80 	lea    -0x7fef4f20(,%esi,8),%eax
80105976:	83 ec 04             	sub    $0x4,%esp
80105979:	6a 08                	push   $0x8
8010597b:	ff 75 10             	pushl  0x10(%ebp)
8010597e:	50                   	push   %eax
8010597f:	e8 3c f0 ff ff       	call   801049c0 <memmove>
  queue[pid][rear[pid]] = index;
80105984:	69 c3 f4 01 00 00    	imul   $0x1f4,%ebx,%eax
  rear[pid] = (rear[pid] + 1) % MAX_QUEUE_SIZE;
8010598a:	ba d3 4d 62 10       	mov    $0x10624dd3,%edx
}
8010598f:	83 c4 10             	add    $0x10,%esp
  queue[pid][rear[pid]] = index;
80105992:	8b 0c 9d c0 d6 10 80 	mov    -0x7fef2940(,%ebx,4),%ecx
80105999:	01 c8                	add    %ecx,%eax
  rear[pid] = (rear[pid] + 1) % MAX_QUEUE_SIZE;
8010599b:	83 c1 01             	add    $0x1,%ecx
  queue[pid][rear[pid]] = index;
8010599e:	89 34 85 c0 d8 10 80 	mov    %esi,-0x7fef2740(,%eax,4)
  rear[pid] = (rear[pid] + 1) % MAX_QUEUE_SIZE;
801059a5:	89 c8                	mov    %ecx,%eax
801059a7:	f7 ea                	imul   %edx
801059a9:	89 c8                	mov    %ecx,%eax
801059ab:	c1 f8 1f             	sar    $0x1f,%eax
801059ae:	c1 fa 05             	sar    $0x5,%edx
801059b1:	29 c2                	sub    %eax,%edx
801059b3:	69 d2 f4 01 00 00    	imul   $0x1f4,%edx,%edx
801059b9:	29 d1                	sub    %edx,%ecx
801059bb:	89 0c 9d c0 d6 10 80 	mov    %ecx,-0x7fef2940(,%ebx,4)
}
801059c2:	8d 65 f8             	lea    -0x8(%ebp),%esp
801059c5:	5b                   	pop    %ebx
801059c6:	5e                   	pop    %esi
801059c7:	5d                   	pop    %ebp
801059c8:	c3                   	ret    
...
801059d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  if(front[pid] == rear[pid])return -1;
801059dc:	8b 0c 9d c0 d7 10 80 	mov    -0x7fef2840(,%ebx,4),%ecx
801059e3:	3b 0c 9d c0 d6 10 80 	cmp    -0x7fef2940(,%ebx,4),%ecx
801059ea:	74 64                	je     80105a50 <deque+0x80>
  int result = queue[pid][front[pid]];
801059ec:	69 c3 f4 01 00 00    	imul   $0x1f4,%ebx,%eax
  front[pid] = (front[pid] + 1) % MAX_QUEUE_SIZE;
801059f2:	ba d3 4d 62 10       	mov    $0x10624dd3,%edx
  memmove(msg,buffers[result],MSSG_SIZE);
801059f7:	83 ec 04             	sub    $0x4,%esp
801059fa:	6a 08                	push   $0x8
  int result = queue[pid][front[pid]];
801059fc:	01 c8                	add    %ecx,%eax
  front[pid] = (front[pid] + 1) % MAX_QUEUE_SIZE;
801059fe:	83 c1 01             	add    $0x1,%ecx
  int result = queue[pid][front[pid]];
80105a01:	8b 34 85 c0 d8 10 80 	mov    -0x7fef2740(,%eax,4),%esi
  front[pid] = (front[pid] + 1) % MAX_QUEUE_SIZE;
80105a08:	89 c8                	mov    %ecx,%eax
80105a0a:	f7 ea                	imul   %edx
80105a0c:	89 c8                	mov    %ecx,%eax
80105a0e:	c1 f8 1f             	sar    $0x1f,%eax
80105a11:	c1 fa 05             	sar    $0x5,%edx
80105a14:	29 c2                	sub    %eax,%edx
  memmove(msg,buffers[result],MSSG_SIZE);
80105a16:	8d 04 f5 e0 b0 10 80 	lea    -0x7fef4f20(,%esi,8),%eax
  front[pid] = (front[pid] + 1) % MAX_QUEUE_SIZE;
80105a1d:	69 d2 f4 01 00 00    	imul   $0x1f4,%edx,%edx
  memmove(msg,buffers[result],MSSG_SIZE);
80105a23:	50                   	push   %eax
80105a24:	ff 75 08             	pushl  0x8(%ebp)
  front[pid] = (front[pid] + 1) % MAX_QUEUE_SIZE;
80105a27:	29 d1                	sub    %edx,%ecx
80105a29:	89 0c 9d c0 d7 10 80 	mov    %ecx,-0x7fef2840(,%ebx,4)
  memmove(msg,buffers[result],MSSG_SIZE);
80105a30:	e8 8b ef ff ff       	call   801049c0 <memmove>
  recv_pids[result] = -1;
  return result;
80105a35:	83 c4 10             	add    $0x10,%esp
  recv_pids[result] = -1;
80105a38:	c7 04 b5 c0 cc 12 80 	movl   $0xffffffff,-0x7fed3340(,%esi,4)
80105a3f:	ff ff ff ff 
}
80105a43:	8d 65 f8             	lea    -0x8(%ebp),%esp
80105a46:	89 f0                	mov    %esi,%eax
80105a48:	5b                   	pop    %ebx
80105a49:	5e                   	pop    %esi
80105a4a:	5d                   	pop    %ebp
80105a4b:	c3                   	ret    
80105a4c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(front[pid] == rear[pid])return -1;
80105a50:	be ff ff ff ff       	mov    $0xffffffff,%esi
80105a55:	eb ec                	jmp    80105a43 <deque+0x73>
...
80105a60:	f3 0f 1e fb          	endbr32 
  return fork();
80105a64:	e9 b7 e0 ff ff       	jmp    80103b20 <fork>
...
80105a77:	83 ec 08             	sub    $0x8,%esp
  exit();
80105a7a:	e8 21 e3 ff ff       	call   80103da0 <exit>
...
80105a90:	f3 0f 1e fb          	endbr32 
  return wait();
80105a94:	e9 57 e5 ff ff       	jmp    80103ff0 <wait>
...
80105ab0:	e8 4b f1 ff ff       	call   80104c00 <argint>
...
80105ac2:	e8 99 e6 ff ff       	call   80104160 <kill>
...
80105b11:	e8 ea f0 ff ff       	call   80104c00 <argint>
...
80105b2a:	e8 71 df ff ff       	call   80103aa0 <growproc>
...
80105b61:	e8 9a f0 ff ff       	call   80104c00 <argint>
...
80105b74:	68 80 97 13 80       	push   $0x80139780
80105b79:	e8 92 ec ff ff       	call   80104810 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105b7e:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105b81:	8b 1d c0 9f 13 80    	mov    0x80139fc0,%ebx
  while(ticks - ticks0 < n){
...
80105b93:	68 80 97 13 80       	push   $0x80139780
80105b98:	68 c0 9f 13 80       	push   $0x80139fc0
80105b9d:	e8 8e e3 ff ff       	call   80103f30 <sleep>
  while(ticks - ticks0 < n){
80105ba2:	a1 c0 9f 13 80       	mov    0x80139fc0,%eax
...
80105bc0:	68 80 97 13 80       	push   $0x80139780
80105bc5:	e8 06 ed ff ff       	call   801048d0 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105be3:	68 80 97 13 80       	push   $0x80139780
80105be8:	e8 e3 ec ff ff       	call   801048d0 <release>
  return 0;
...
80105c08:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105c0b:	68 80 97 13 80       	push   $0x80139780
80105c10:	e8 fb eb ff ff       	call   80104810 <acquire>
  xticks = ticks;
80105c15:	8b 1d c0 9f 13 80    	mov    0x80139fc0,%ebx
  release(&tickslock);
80105c1b:	c7 04 24 80 97 13 80 	movl   $0x80139780,(%esp)
80105c22:	e8 a9 ec ff ff       	call   801048d0 <release>
  return xticks;
}
...
80105c30:	f3 0f 1e fb          	endbr32 
  if(trace==TRACE_ON){
80105c34:	83 3d bc d5 10 80 01 	cmpl   $0x1,0x8010d5bc
80105c3b:	74 33                	je     80105c70 <sys_toggle+0x40>
    trace = TRACE_OFF;
  }
  else{
    trace = TRACE_ON;
80105c3d:	c7 05 bc d5 10 80 01 	movl   $0x1,0x8010d5bc
80105c44:	00 00 00 
    for(int i=1;i<=ONSC;i++){
80105c47:	b8 01 00 00 00       	mov    $0x1,%eax
80105c4c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      CALLS[i]=0;
80105c50:	c7 04 85 e0 96 13 80 	movl   $0x0,-0x7fec6920(,%eax,4)
80105c57:	00 00 00 00 
    for(int i=1;i<=ONSC;i++){
80105c5b:	83 c0 01             	add    $0x1,%eax
80105c5e:	83 f8 16             	cmp    $0x16,%eax
80105c61:	75 ed                	jne    80105c50 <sys_toggle+0x20>
...
80105c69:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    trace = TRACE_OFF;
80105c70:	c7 05 bc d5 10 80 00 	movl   $0x0,0x8010d5bc
80105c77:	00 00 00 
80105c7a:	31 c0                	xor    %eax,%eax
80105c7c:	c3                   	ret    
...
80105c87:	53                   	push   %ebx
  for(int i=1;i<=ONSC;i++){
80105c88:	bb 01 00 00 00       	mov    $0x1,%ebx
sys_print_count(void){
80105c8d:	83 ec 04             	sub    $0x4,%esp
    if(CALLS[map[i]]>0){
80105c90:	8b 04 9d 20 b0 10 80 	mov    -0x7fef4fe0(,%ebx,4),%eax
80105c97:	8b 0c 85 e0 96 13 80 	mov    -0x7fec6920(,%eax,4),%ecx
80105c9e:	85 c9                	test   %ecx,%ecx
80105ca0:	7e 38                	jle    80105cda <sys_print_count+0x5a>
      cprintf(Call_name[map[i]]);
80105ca2:	83 ec 0c             	sub    $0xc,%esp
80105ca5:	ff 34 85 80 b0 10 80 	pushl  -0x7fef4f80(,%eax,4)
80105cac:	e8 ff a9 ff ff       	call   801006b0 <cprintf>
      cprintf(" ");
80105cb1:	c7 04 24 04 80 10 80 	movl   $0x80108004,(%esp)
80105cb8:	e8 f3 a9 ff ff       	call   801006b0 <cprintf>
      cprintf("%d\n",CALLS[map[i]]);
80105cbd:	58                   	pop    %eax
80105cbe:	8b 04 9d 20 b0 10 80 	mov    -0x7fef4fe0(,%ebx,4),%eax
80105cc5:	5a                   	pop    %edx
80105cc6:	ff 34 85 e0 96 13 80 	pushl  -0x7fec6920(,%eax,4)
80105ccd:	68 d4 7e 10 80       	push   $0x80107ed4
80105cd2:	e8 d9 a9 ff ff       	call   801006b0 <cprintf>
80105cd7:	83 c4 10             	add    $0x10,%esp
  for(int i=1;i<=ONSC;i++){
80105cda:	83 c3 01             	add    $0x1,%ebx
80105cdd:	83 fb 16             	cmp    $0x16,%ebx
80105ce0:	75 ae                	jne    80105c90 <sys_print_count+0x10>
    }
  }
  return 0;
}
80105ce2:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105ce5:	31 c0                	xor    %eax,%eax
80105ce7:	c9                   	leave  
80105ce8:	c3                   	ret    
...
80105d00:	e8 fb ee ff ff       	call   80104c00 <argint>
  argint(1,&b);
80105d05:	58                   	pop    %eax
...
80105d0d:	e8 ee ee ff ff       	call   80104c00 <argint>
  return a+b;
80105d12:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d15:	03 45 f0             	add    -0x10(%ebp),%eax
}
80105d18:	c9                   	leave  
80105d19:	c3                   	ret    
...
80105d27:	83 ec 08             	sub    $0x8,%esp
  ps();
80105d2a:	e8 a1 e5 ff ff       	call   801042d0 <ps>
  return 0;
}
...
80105d4c:	31 db                	xor    %ebx,%ebx
{
80105d4e:	83 ec 18             	sub    $0x18,%esp
  argint(0, &sender_pid);
80105d51:	50                   	push   %eax
80105d52:	6a 00                	push   $0x0
80105d54:	e8 a7 ee ff ff       	call   80104c00 <argint>
  argint(1, &rec_pid);
80105d59:	8d 45 0c             	lea    0xc(%ebp),%eax
80105d5c:	5a                   	pop    %edx
80105d5d:	59                   	pop    %ecx
80105d5e:	50                   	push   %eax
80105d5f:	6a 01                	push   $0x1
80105d61:	e8 9a ee ff ff       	call   80104c00 <argint>
  argptr(2, (char**)&data, MSSG_SIZE);
80105d66:	83 c4 0c             	add    $0xc,%esp
80105d69:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105d6c:	6a 08                	push   $0x8
80105d6e:	50                   	push   %eax
80105d6f:	6a 02                	push   $0x2
80105d71:	e8 da ee ff ff       	call   80104c50 <argptr>
  acquire(&lock);
80105d76:	c7 04 24 40 97 13 80 	movl   $0x80139740,(%esp)
80105d7d:	e8 8e ea ff ff       	call   80104810 <acquire>
80105d82:	83 c4 10             	add    $0x10,%esp
80105d85:	eb 18                	jmp    80105d9f <sys_send+0x5f>
80105d87:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105d8e:	66 90                	xchg   %ax,%ax
  for(int i = 0; i < BUFFER_SIZE; i++){
80105d90:	83 c3 01             	add    $0x1,%ebx
80105d93:	81 fb e8 03 00 00    	cmp    $0x3e8,%ebx
80105d99:	0f 84 c1 00 00 00    	je     80105e60 <sys_send+0x120>
    if(recv_pids[i] <= 0){        
80105d9f:	8b 04 9d c0 cc 12 80 	mov    -0x7fed3340(,%ebx,4),%eax
80105da6:	85 c0                	test   %eax,%eax
80105da8:	7f e6                	jg     80105d90 <sys_send+0x50>
      sender_pids[i] = sender_pid;
80105daa:	8b 45 08             	mov    0x8(%ebp),%eax
  memmove(buffers[index], (char**)ch, MSSG_SIZE);
80105dad:	83 ec 04             	sub    $0x4,%esp
      recv_pids[i] = rec_pid;
80105db0:	8b 75 0c             	mov    0xc(%ebp),%esi
80105db3:	6a 08                	push   $0x8
      sender_pids[i] = sender_pid;
80105db5:	89 04 9d 60 dc 12 80 	mov    %eax,-0x7fed23a0(,%ebx,4)
80105dbc:	8d 04 dd e0 b0 10 80 	lea    -0x7fef4f20(,%ebx,8),%eax
80105dc3:	ff 75 f4             	pushl  -0xc(%ebp)
80105dc6:	50                   	push   %eax
      recv_pids[i] = rec_pid;
80105dc7:	89 34 9d c0 cc 12 80 	mov    %esi,-0x7fed3340(,%ebx,4)
80105dce:	e8 ed eb ff ff       	call   801049c0 <memmove>
  queue[pid][rear[pid]] = index;
80105dd3:	69 c6 f4 01 00 00    	imul   $0x1f4,%esi,%eax
  rear[pid] = (rear[pid] + 1) % MAX_QUEUE_SIZE;
80105dd9:	ba d3 4d 62 10       	mov    $0x10624dd3,%edx
      enque(rec_pid, i,data);
      if(wait_queue[rec_pid] == 1){
80105dde:	83 c4 10             	add    $0x10,%esp
  queue[pid][rear[pid]] = index;
80105de1:	8b 0c b5 c0 d6 10 80 	mov    -0x7fef2940(,%esi,4),%ecx
80105de8:	01 c8                	add    %ecx,%eax
  rear[pid] = (rear[pid] + 1) % MAX_QUEUE_SIZE;
80105dea:	83 c1 01             	add    $0x1,%ecx
  queue[pid][rear[pid]] = index;
80105ded:	89 1c 85 c0 d8 10 80 	mov    %ebx,-0x7fef2740(,%eax,4)
  rear[pid] = (rear[pid] + 1) % MAX_QUEUE_SIZE;
80105df4:	89 c8                	mov    %ecx,%eax
80105df6:	f7 ea                	imul   %edx
80105df8:	89 c8                	mov    %ecx,%eax
80105dfa:	c1 f8 1f             	sar    $0x1f,%eax
80105dfd:	c1 fa 05             	sar    $0x5,%edx
80105e00:	29 c2                	sub    %eax,%edx
80105e02:	69 c2 f4 01 00 00    	imul   $0x1f4,%edx,%eax
80105e08:	29 c1                	sub    %eax,%ecx
80105e0a:	8b 45 0c             	mov    0xc(%ebp),%eax
80105e0d:	89 0c b5 c0 d6 10 80 	mov    %ecx,-0x7fef2940(,%esi,4)
80105e14:	83 3c 85 c0 d5 10 80 	cmpl   $0x1,-0x7fef2a40(,%eax,4)
80105e1b:	01 
80105e1c:	74 22                	je     80105e40 <sys_send+0x100>
        wait_queue[rec_pid] = 0;
        wakeup((void*)rec_pid);
      }
      release(&lock);
80105e1e:	83 ec 0c             	sub    $0xc,%esp
80105e21:	68 40 97 13 80       	push   $0x80139740
80105e26:	e8 a5 ea ff ff       	call   801048d0 <release>
      // cprintf("%s\n",buffers[i]);
      return 0;
...
80105e3e:	66 90                	xchg   %ax,%ax
        wait_queue[rec_pid] = 0;
80105e40:	c7 04 85 c0 d5 10 80 	movl   $0x0,-0x7fef2a40(,%eax,4)
80105e47:	00 00 00 00 
        wakeup((void*)rec_pid);
80105e4b:	83 ec 0c             	sub    $0xc,%esp
80105e4e:	50                   	push   %eax
80105e4f:	e8 9c e2 ff ff       	call   801040f0 <wakeup>
80105e54:	83 c4 10             	add    $0x10,%esp
80105e57:	eb c5                	jmp    80105e1e <sys_send+0xde>
80105e59:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  release(&lock);
80105e60:	83 ec 0c             	sub    $0xc,%esp
80105e63:	68 40 97 13 80       	push   $0x80139740
80105e68:	e8 63 ea ff ff       	call   801048d0 <release>
  return -1;
80105e6d:	83 c4 10             	add    $0x10,%esp
}
80105e70:	8d 65 f8             	lea    -0x8(%ebp),%esp
  return -1;
...
80105e88:	8d 45 08             	lea    0x8(%ebp),%eax
int sys_recv(void *msg){
...
80105e93:	e8 b8 ed ff ff       	call   80104c50 <argptr>
  int me = myproc()->pid;
80105e98:	e8 d3 da ff ff       	call   80103970 <myproc>
80105e9d:	83 c4 10             	add    $0x10,%esp
80105ea0:	8b 58 10             	mov    0x10(%eax),%ebx
80105ea3:	eb 2b                	jmp    80105ed0 <sys_recv+0x50>
80105ea5:	8d 76 00             	lea    0x0(%esi),%esi
    ...
    wait_queue[me] = 1;
80105ea8:	c7 04 9d c0 d5 10 80 	movl   $0x1,-0x7fef2a40(,%ebx,4)
80105eaf:	01 00 00 00 
    sleep((void*)me, &lock);
80105eb3:	83 ec 08             	sub    $0x8,%esp
80105eb6:	68 40 97 13 80       	push   $0x80139740
80105ebb:	53                   	push   %ebx
80105ebc:	e8 6f e0 ff ff       	call   80103f30 <sleep>
    release(&lock);
80105ec1:	c7 04 24 40 97 13 80 	movl   $0x80139740,(%esp)
80105ec8:	e8 03 ea ff ff       	call   801048d0 <release>
    acquire(&lock);
80105ecd:	83 c4 10             	add    $0x10,%esp
80105ed0:	83 ec 0c             	sub    $0xc,%esp
80105ed3:	68 40 97 13 80       	push   $0x80139740
80105ed8:	e8 33 e9 ff ff       	call   80104810 <acquire>
    val = deque(msg,me);
80105edd:	58                   	pop    %eax
80105ede:	5a                   	pop    %edx
80105edf:	53                   	push   %ebx
80105ee0:	ff 75 08             	pushl  0x8(%ebp)
80105ee3:	e8 e8 fa ff ff       	call   801059d0 <deque>
    if(val!=-1){
80105ee8:	83 c4 10             	add    $0x10,%esp
80105eeb:	83 f8 ff             	cmp    $0xffffffff,%eax
80105eee:	74 b8                	je     80105ea8 <sys_recv+0x28>
      release(&lock);
80105ef0:	83 ec 0c             	sub    $0xc,%esp
80105ef3:	68 40 97 13 80       	push   $0x80139740
80105ef8:	e8 d3 e9 ff ff       	call   801048d0 <release>
  }
  return 0;
}
80105efd:	8b 5d fc             	mov    -0x4(%ebp),%ebx
...
80105f17:	57                   	push   %edi
  ...
  // cprintf("%d\n",sender_pid);
  int j = 0;
80105f18:	31 ff                	xor    %edi,%edi
int sys_send_multi(int sender_pid, int rec_pids[], void *msg){
80105f1a:	56                   	push   %esi
  argint(0,&sender_pid);
80105f1b:	8d 45 08             	lea    0x8(%ebp),%eax
int sys_send_multi(int sender_pid, int rec_pids[], void *msg){
...
80105f27:	e8 d4 ec ff ff       	call   80104c00 <argint>
  argptr(1,(char**)&rec_pids,n*sizeof(int));
80105f2c:	83 c4 0c             	add    $0xc,%esp
80105f2f:	8d 45 0c             	lea    0xc(%ebp),%eax
80105f32:	6a 20                	push   $0x20
80105f34:	50                   	push   %eax
80105f35:	6a 01                	push   $0x1
80105f37:	e8 14 ed ff ff       	call   80104c50 <argptr>
  argptr(2,(char**)&msg,MSSG_SIZE);
80105f3c:	83 c4 0c             	add    $0xc,%esp
80105f3f:	8d 45 10             	lea    0x10(%ebp),%eax
80105f42:	6a 08                	push   $0x8
80105f44:	50                   	push   %eax
80105f45:	6a 02                	push   $0x2
80105f47:	e8 04 ed ff ff       	call   80104c50 <argptr>
  acquire(&lock);
80105f4c:	c7 04 24 40 97 13 80 	movl   $0x80139740,(%esp)
80105f53:	e8 b8 e8 ff ff       	call   80104810 <acquire>
80105f58:	83 c4 10             	add    $0x10,%esp
80105f5b:	eb 1b                	jmp    80105f78 <sys_send_multi+0x68>
80105f5d:	8d 76 00             	lea    0x0(%esi),%esi
  for(int i=0;i<BUFFER_SIZE && j<n;i++){
80105f60:	83 c3 01             	add    $0x1,%ebx
80105f63:	81 fb e7 03 00 00    	cmp    $0x3e7,%ebx
80105f69:	0f 8f a9 00 00 00    	jg     80106018 <sys_send_multi+0x108>
80105f6f:	83 ff 07             	cmp    $0x7,%edi
80105f72:	0f 8f a0 00 00 00    	jg     80106018 <sys_send_multi+0x108>
    if(recv_pids[i] <= 0){
80105f78:	8b 0c 9d c0 cc 12 80 	mov    -0x7fed3340(,%ebx,4),%ecx
80105f7f:	85 c9                	test   %ecx,%ecx
80105f81:	7f dd                	jg     80105f60 <sys_send_multi+0x50>
      sender_pids[i] = sender_pid;
80105f83:	8b 45 08             	mov    0x8(%ebp),%eax
  memmove(buffers[index], (char**)ch, MSSG_SIZE);
80105f86:	83 ec 04             	sub    $0x4,%esp
80105f89:	89 04 9d 60 dc 12 80 	mov    %eax,-0x7fed23a0(,%ebx,4)
      recv_pids[i] = rec_pids[j];
80105f90:	8b 45 0c             	mov    0xc(%ebp),%eax
80105f93:	8d 04 b8             	lea    (%eax,%edi,4),%eax
      enque(rec_pids[j], i,msg);
      cprintf("%s\n",buffers[i]);
      j++;
80105f96:	83 c7 01             	add    $0x1,%edi
      recv_pids[i] = rec_pids[j];
80105f99:	8b 10                	mov    (%eax),%edx
80105f9b:	89 14 9d c0 cc 12 80 	mov    %edx,-0x7fed3340(,%ebx,4)
      enque(rec_pids[j], i,msg);
80105fa2:	8b 30                	mov    (%eax),%esi
80105fa4:	8d 04 dd e0 b0 10 80 	lea    -0x7fef4f20(,%ebx,8),%eax
80105fab:	6a 08                	push   $0x8
80105fad:	ff 75 10             	pushl  0x10(%ebp)
80105fb0:	50                   	push   %eax
80105fb1:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105fb4:	e8 07 ea ff ff       	call   801049c0 <memmove>
  queue[pid][rear[pid]] = index;
80105fb9:	69 c6 f4 01 00 00    	imul   $0x1f4,%esi,%eax
80105fbf:	8b 0c b5 c0 d6 10 80 	mov    -0x7fef2940(,%esi,4),%ecx
80105fc6:	01 c8                	add    %ecx,%eax
  rear[pid] = (rear[pid] + 1) % MAX_QUEUE_SIZE;
80105fc8:	83 c1 01             	add    $0x1,%ecx
  queue[pid][rear[pid]] = index;
80105fcb:	89 1c 85 c0 d8 10 80 	mov    %ebx,-0x7fef2740(,%eax,4)
  rear[pid] = (rear[pid] + 1) % MAX_QUEUE_SIZE;
80105fd2:	b8 d3 4d 62 10       	mov    $0x10624dd3,%eax
  for(int i=0;i<BUFFER_SIZE && j<n;i++){
80105fd7:	83 c3 01             	add    $0x1,%ebx
80105fda:	f7 e9                	imul   %ecx
80105fdc:	89 c8                	mov    %ecx,%eax
80105fde:	c1 f8 1f             	sar    $0x1f,%eax
80105fe1:	c1 fa 05             	sar    $0x5,%edx
80105fe4:	29 c2                	sub    %eax,%edx
      cprintf("%s\n",buffers[i]);
80105fe6:	58                   	pop    %eax
80105fe7:	69 d2 f4 01 00 00    	imul   $0x1f4,%edx,%edx
80105fed:	29 d1                	sub    %edx,%ecx
80105fef:	5a                   	pop    %edx
80105ff0:	ff 75 e4             	pushl  -0x1c(%ebp)
80105ff3:	68 df 7f 10 80       	push   $0x80107fdf
80105ff8:	89 0c b5 c0 d6 10 80 	mov    %ecx,-0x7fef2940(,%esi,4)
80105fff:	e8 ac a6 ff ff       	call   801006b0 <cprintf>
      j++;
80106004:	83 c4 10             	add    $0x10,%esp
  for(int i=0;i<BUFFER_SIZE && j<n;i++){
80106007:	81 fb e7 03 00 00    	cmp    $0x3e7,%ebx
8010600d:	0f 8e 5c ff ff ff    	jle    80105f6f <sys_send_multi+0x5f>
...
8010601d:	68 40 97 13 80       	push   $0x80139740
80106022:	e8 a9 e8 ff ff       	call   801048d0 <release>
80106027:	83 c4 10             	add    $0x10,%esp
8010602a:	eb 0c                	jmp    80106038 <sys_send_multi+0x128>
8010602c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(int i=0;i<n;i++){
80106030:	83 c3 04             	add    $0x4,%ebx
80106033:	83 fb 20             	cmp    $0x20,%ebx
80106036:	74 31                	je     80106069 <sys_send_multi+0x159>
    if(wait_queue[rec_pids[i]]==1){
80106038:	8b 45 0c             	mov    0xc(%ebp),%eax
8010603b:	01 d8                	add    %ebx,%eax
8010603d:	8b 10                	mov    (%eax),%edx
8010603f:	83 3c 95 c0 d5 10 80 	cmpl   $0x1,-0x7fef2a40(,%edx,4)
80106046:	01 
80106047:	75 e7                	jne    80106030 <sys_send_multi+0x120>
      wait_queue[rec_pids[i]]=0;
      wakeup((void*)rec_pids[i]);
80106049:	83 ec 0c             	sub    $0xc,%esp
8010604c:	83 c3 04             	add    $0x4,%ebx
      wait_queue[rec_pids[i]]=0;
8010604f:	c7 04 95 c0 d5 10 80 	movl   $0x0,-0x7fef2a40(,%edx,4)
80106056:	00 00 00 00 
      wakeup((void*)rec_pids[i]);
8010605a:	ff 30                	pushl  (%eax)
8010605c:	e8 8f e0 ff ff       	call   801040f0 <wakeup>
80106061:	83 c4 10             	add    $0x10,%esp
  for(int i=0;i<n;i++){
80106064:	83 fb 20             	cmp    $0x20,%ebx
80106067:	75 cf                	jne    80106038 <sys_send_multi+0x128>
    }
  }
  return 0;
}
...
80106080 <sys_exec_time>:

int sys_exec_time(int pd,int et){
80106080:	f3 0f 1e fb          	endbr32 
80106084:	55                   	push   %ebp
80106085:	89 e5                	mov    %esp,%ebp
80106087:	83 ec 10             	sub    $0x10,%esp
  argint(0,&pd);
8010608a:	8d 45 08             	lea    0x8(%ebp),%eax
8010608d:	50                   	push   %eax
8010608e:	6a 00                	push   $0x0
80106090:	e8 6b eb ff ff       	call   80104c00 <argint>
  argint(1,&et);
80106095:	58                   	pop    %eax
80106096:	8d 45 0c             	lea    0xc(%ebp),%eax
80106099:	5a                   	pop    %edx
8010609a:	50                   	push   %eax
8010609b:	6a 01                	push   $0x1
8010609d:	e8 5e eb ff ff       	call   80104c00 <argint>
  return exec_time(pd,et);
801060a2:	59                   	pop    %ecx
801060a3:	58                   	pop    %eax
801060a4:	ff 75 0c             	pushl  0xc(%ebp)
801060a7:	ff 75 08             	pushl  0x8(%ebp)
801060aa:	e8 91 e2 ff ff       	call   80104340 <exec_time>
}
801060af:	c9                   	leave  
801060b0:	c3                   	ret    
...
801060c0 <sys_deadline>:

int sys_deadline(int pd,int dd){
801060c0:	f3 0f 1e fb          	endbr32 
801060c4:	55                   	push   %ebp
801060c5:	89 e5                	mov    %esp,%ebp
801060c7:	83 ec 10             	sub    $0x10,%esp
  argint(0,&pd);
801060ca:	8d 45 08             	lea    0x8(%ebp),%eax
801060cd:	50                   	push   %eax
801060ce:	6a 00                	push   $0x0
801060d0:	e8 2b eb ff ff       	call   80104c00 <argint>
  argint(1,&dd);
801060d5:	58                   	pop    %eax
801060d6:	8d 45 0c             	lea    0xc(%ebp),%eax
801060d9:	5a                   	pop    %edx
801060da:	50                   	push   %eax
801060db:	6a 01                	push   $0x1
801060dd:	e8 1e eb ff ff       	call   80104c00 <argint>
  return deadline(pd,dd);
801060e2:	59                   	pop    %ecx
801060e3:	58                   	pop    %eax
801060e4:	ff 75 0c             	pushl  0xc(%ebp)
801060e7:	ff 75 08             	pushl  0x8(%ebp)
801060ea:	e8 d1 e2 ff ff       	call   801043c0 <deadline>
}
801060ef:	c9                   	leave  
801060f0:	c3                   	ret    
...
int sys_rate(int pd,int rt){
80106100:	f3 0f 1e fb          	endbr32 
80106104:	55                   	push   %ebp
80106105:	89 e5                	mov    %esp,%ebp
80106107:	83 ec 10             	sub    $0x10,%esp
  argint(0,&pd);
8010610a:	8d 45 08             	lea    0x8(%ebp),%eax
8010610d:	50                   	push   %eax
8010610e:	6a 00                	push   $0x0
80106110:	e8 eb ea ff ff       	call   80104c00 <argint>
  argint(1,&rt);
80106115:	58                   	pop    %eax
80106116:	8d 45 0c             	lea    0xc(%ebp),%eax
80106119:	5a                   	pop    %edx
8010611a:	50                   	push   %eax
8010611b:	6a 01                	push   $0x1
8010611d:	e8 de ea ff ff       	call   80104c00 <argint>
  return rate(pd,rt);
80106122:	59                   	pop    %ecx
80106123:	58                   	pop    %eax
80106124:	ff 75 0c             	pushl  0xc(%ebp)
80106127:	ff 75 08             	pushl  0x8(%ebp)
8010612a:	e8 11 e3 ff ff       	call   80104440 <rate>
}
8010612f:	c9                   	leave  
80106130:	c3                   	ret    
...
80106147:	83 ec 10             	sub    $0x10,%esp
  argint(0,&pid);
8010614a:	8d 45 08             	lea    0x8(%ebp),%eax
8010614d:	50                   	push   %eax
8010614e:	6a 00                	push   $0x0
80106150:	e8 ab ea ff ff       	call   80104c00 <argint>
  argint(1,&policy);
80106155:	58                   	pop    %eax
80106156:	8d 45 0c             	lea    0xc(%ebp),%eax
80106159:	5a                   	pop    %edx
8010615a:	50                   	push   %eax
8010615b:	6a 01                	push   $0x1
8010615d:	e8 9e ea ff ff       	call   80104c00 <argint>
  return sched_policy(pid,policy);
80106162:	59                   	pop    %ecx
80106163:	58                   	pop    %eax
80106164:	ff 75 0c             	pushl  0xc(%ebp)
80106167:	ff 75 08             	pushl  0x8(%ebp)
8010616a:	e8 51 e3 ff ff       	call   801044c0 <sched_policy>
8010616f:	c9                   	leave  
80106170:	c3                   	ret    
...
80106172:	06                   	push   %es
  pushl %fs
80106173:	0f a0                	push   %fs
  pushl %gs
80106175:	0f a8                	push   %gs
  pushal
80106177:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80106178:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
8010617c:	8e d8                	mov    %eax,%ds
  movw %ax, %es
8010617e:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80106180:	54                   	push   %esp
  call trap
80106181:	e8 ca 00 00 00       	call   80106250 <trap>
  addl $4, %esp
80106186:	83 c4 04             	add    $0x4,%esp
...
80106189:	61                   	popa   
  popl %gs
8010618a:	0f a9                	pop    %gs
  popl %fs
8010618c:	0f a1                	pop    %fs
  popl %es
8010618e:	07                   	pop    %es
  popl %ds
8010618f:	1f                   	pop    %ds
...
801061b0:	8b 14 85 20 d0 10 80 	mov    -0x7fef2fe0(,%eax,4),%edx
801061b7:	c7 04 c5 c2 97 13 80 	movl   $0x8e000008,-0x7fec683e(,%eax,8)
801061be:	08 00 00 8e 
801061c2:	66 89 14 c5 c0 97 13 	mov    %dx,-0x7fec6840(,%eax,8)
801061c9:	80 
801061ca:	c1 ea 10             	shr    $0x10,%edx
801061cd:	66 89 14 c5 c6 97 13 	mov    %dx,-0x7fec683a(,%eax,8)
801061d4:	80 
  for(i = 0; i < 256; i++)
...
801061df:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801061e2:	a1 20 d1 10 80       	mov    0x8010d120,%eax
801061e7:	c7 05 c2 99 13 80 08 	movl   $0xef000008,0x801399c2
801061ee:	00 00 ef 
  initlock(&tickslock, "time");
801061f1:	68 27 82 10 80       	push   $0x80108227
801061f6:	68 80 97 13 80       	push   $0x80139780
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801061fb:	66 a3 c0 99 13 80    	mov    %ax,0x801399c0
80106201:	c1 e8 10             	shr    $0x10,%eax
80106204:	66 a3 c6 99 13 80    	mov    %ax,0x801399c6
  initlock(&tickslock, "time");
8010620a:	e8 81 e4 ff ff       	call   80104690 <initlock>
}
...
8010622f:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80106233:	b8 c0 97 13 80       	mov    $0x801397c0,%eax
...
80106274:	3e ff 24 85 14 83 10 	notrack jmp *-0x7fef7cec(,%eax,4)
8010627b:	80 
    lapiceoi();
    break;
...
8010627c:	e8 ef d6 ff ff       	call   80103970 <myproc>
...
8010629c:	e8 af d6 ff ff       	call   80103950 <cpuid>
...
801062ad:	e8 be d6 ff ff       	call   80103970 <myproc>
801062b2:	89 45 e0             	mov    %eax,-0x20(%ebp)
801062b5:	e8 b6 d6 ff ff       	call   80103970 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
801062d1:	68 d0 82 10 80       	push   $0x801082d0
801062d6:	e8 d5 a3 ff ff       	call   801006b0 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801062db:	83 c4 20             	add    $0x20,%esp
801062de:	e8 8d d6 ff ff       	call   80103970 <myproc>
...
801062ea:	e8 81 d6 ff ff       	call   80103970 <myproc>
801062ef:	85 c0                	test   %eax,%eax
801062f1:	74 1d                	je     80106310 <trap+0xc0>
801062f3:	e8 78 d6 ff ff       	call   80103970 <myproc>
...
80106310:	e8 5b d6 ff ff       	call   80103970 <myproc>
80106315:	85 c0                	test   %eax,%eax
80106317:	74 0f                	je     80106328 <trap+0xd8>
80106319:	e8 52 d6 ff ff       	call   80103970 <myproc>
...
80106322:	0f 84 e8 00 00 00    	je     80106410 <trap+0x1c0>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106328:	e8 43 d6 ff ff       	call   80103970 <myproc>
8010632d:	85 c0                	test   %eax,%eax
8010632f:	74 1d                	je     8010634e <trap+0xfe>
80106331:	e8 3a d6 ff ff       	call   80103970 <myproc>
...
80106355:	c3                   	ret    
    ideintr();
80106356:	e8 85 be ff ff       	call   801021e0 <ideintr>
    lapiceoi();
8010635b:	e8 60 c5 ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106360:	e8 0b d6 ff ff       	call   80103970 <myproc>
80106365:	85 c0                	test   %eax,%eax
80106367:	75 8a                	jne    801062f3 <trap+0xa3>
80106369:	eb a5                	jmp    80106310 <trap+0xc0>
    if(cpuid() == 0){
8010636b:	e8 e0 d5 ff ff       	call   80103950 <cpuid>
80106370:	85 c0                	test   %eax,%eax
80106372:	75 e7                	jne    8010635b <trap+0x10b>
      acquire(&tickslock);
80106374:	83 ec 0c             	sub    $0xc,%esp
80106377:	68 80 97 13 80       	push   $0x80139780
8010637c:	e8 8f e4 ff ff       	call   80104810 <acquire>
      wakeup(&ticks);
80106381:	c7 04 24 c0 9f 13 80 	movl   $0x80139fc0,(%esp)
      ticks++;
80106388:	83 05 c0 9f 13 80 01 	addl   $0x1,0x80139fc0
      wakeup(&ticks);
8010638f:	e8 5c dd ff ff       	call   801040f0 <wakeup>
      release(&tickslock);
80106394:	c7 04 24 80 97 13 80 	movl   $0x80139780,(%esp)
8010639b:	e8 30 e5 ff ff       	call   801048d0 <release>
801063a0:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
801063a3:	eb b6                	jmp    8010635b <trap+0x10b>
    kbdintr();
801063a5:	e8 d6 c3 ff ff       	call   80102780 <kbdintr>
    lapiceoi();
801063aa:	e8 11 c5 ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801063af:	e8 bc d5 ff ff       	call   80103970 <myproc>
...
801063c1:	e8 4a 02 00 00       	call   80106610 <uartintr>
    lapiceoi();
801063c6:	e8 f5 c4 ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801063cb:	e8 a0 d5 ff ff       	call   80103970 <myproc>
...
801063e4:	e8 67 d5 ff ff       	call   80103950 <cpuid>
801063e9:	57                   	push   %edi
801063ea:	56                   	push   %esi
801063eb:	50                   	push   %eax
801063ec:	68 78 82 10 80       	push   $0x80108278
801063f1:	e8 ba a2 ff ff       	call   801006b0 <cprintf>
    lapiceoi();
801063f6:	e8 c5 c4 ff ff       	call   801028c0 <lapiceoi>
    break;
801063fb:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801063fe:	e8 6d d5 ff ff       	call   80103970 <myproc>
...
80106488:	68 9c 82 10 80       	push   $0x8010829c
8010648d:	e8 1e a2 ff ff       	call   801006b0 <cprintf>
      panic("trap");
80106492:	83 c4 14             	add    $0x14,%esp
80106495:	68 71 82 10 80       	push   $0x80108271
...
801064a0:	f3 0f 1e fb          	endbr32 
  if(!uart)
801064a4:	a1 00 ec 12 80       	mov    0x8012ec00,%eax
...
801064f5:	e8 e6 c3 ff ff       	call   801028e0 <microdelay>
...
8010657b:	74 52                	je     801065cf <uartinit+0xaf>
  uart = 1;
8010657d:	c7 05 00 ec 12 80 01 	movl   $0x1,0x8012ec00
80106584:	00 00 00 
...
80106593:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80106598:	bb 94 83 10 80       	mov    $0x80108394,%ebx
  ioapicenable(IRQ_COM1, 0);
8010659d:	6a 00                	push   $0x0
8010659f:	6a 04                	push   $0x4
801065a1:	e8 8a be ff ff       	call   80102430 <ioapicenable>
...
801065b0:	0f b6 73 01          	movzbl 0x1(%ebx),%esi
  if(!uart)
801065b4:	8b 15 00 ec 12 80    	mov    0x8012ec00,%edx
...
801065e4:	55                   	push   %ebp
  if(!uart)
801065e5:	8b 15 00 ec 12 80    	mov    0x8012ec00,%edx
{
...
8010662b:	6a 00                	push   $0x0
  jmp alltraps
8010662d:	e9 3f fb ff ff       	jmp    80106171 <alltraps>
...
80106634:	6a 01                	push   $0x1
  jmp alltraps
80106636:	e9 36 fb ff ff       	jmp    80106171 <alltraps>
...
8010663d:	6a 02                	push   $0x2
  jmp alltraps
8010663f:	e9 2d fb ff ff       	jmp    80106171 <alltraps>
...
80106646:	6a 03                	push   $0x3
  jmp alltraps
80106648:	e9 24 fb ff ff       	jmp    80106171 <alltraps>
...
8010664f:	6a 04                	push   $0x4
  jmp alltraps
80106651:	e9 1b fb ff ff       	jmp    80106171 <alltraps>
...
80106658:	6a 05                	push   $0x5
  jmp alltraps
8010665a:	e9 12 fb ff ff       	jmp    80106171 <alltraps>
...
80106661:	6a 06                	push   $0x6
  jmp alltraps
80106663:	e9 09 fb ff ff       	jmp    80106171 <alltraps>
...
8010666a:	6a 07                	push   $0x7
  jmp alltraps
8010666c:	e9 00 fb ff ff       	jmp    80106171 <alltraps>
...
80106671:	6a 08                	push   $0x8
  jmp alltraps
80106673:	e9 f9 fa ff ff       	jmp    80106171 <alltraps>
...
8010667a:	6a 09                	push   $0x9
  jmp alltraps
8010667c:	e9 f0 fa ff ff       	jmp    80106171 <alltraps>
...
80106681:	6a 0a                	push   $0xa
  jmp alltraps
80106683:	e9 e9 fa ff ff       	jmp    80106171 <alltraps>
...
80106688:	6a 0b                	push   $0xb
  jmp alltraps
8010668a:	e9 e2 fa ff ff       	jmp    80106171 <alltraps>
...
8010668f:	6a 0c                	push   $0xc
  jmp alltraps
80106691:	e9 db fa ff ff       	jmp    80106171 <alltraps>
...
80106696:	6a 0d                	push   $0xd
  jmp alltraps
80106698:	e9 d4 fa ff ff       	jmp    80106171 <alltraps>
...
8010669d:	6a 0e                	push   $0xe
  jmp alltraps
8010669f:	e9 cd fa ff ff       	jmp    80106171 <alltraps>
...
801066a6:	6a 0f                	push   $0xf
  jmp alltraps
801066a8:	e9 c4 fa ff ff       	jmp    80106171 <alltraps>
...
801066af:	6a 10                	push   $0x10
  jmp alltraps
801066b1:	e9 bb fa ff ff       	jmp    80106171 <alltraps>
...
801066b6:	6a 11                	push   $0x11
  jmp alltraps
801066b8:	e9 b4 fa ff ff       	jmp    80106171 <alltraps>
...
801066bf:	6a 12                	push   $0x12
  jmp alltraps
801066c1:	e9 ab fa ff ff       	jmp    80106171 <alltraps>
...
801066c8:	6a 13                	push   $0x13
  jmp alltraps
801066ca:	e9 a2 fa ff ff       	jmp    80106171 <alltraps>
...
801066d1:	6a 14                	push   $0x14
  jmp alltraps
801066d3:	e9 99 fa ff ff       	jmp    80106171 <alltraps>
...
801066da:	6a 15                	push   $0x15
  jmp alltraps
801066dc:	e9 90 fa ff ff       	jmp    80106171 <alltraps>
...
801066e3:	6a 16                	push   $0x16
  jmp alltraps
801066e5:	e9 87 fa ff ff       	jmp    80106171 <alltraps>
...
801066ec:	6a 17                	push   $0x17
  jmp alltraps
801066ee:	e9 7e fa ff ff       	jmp    80106171 <alltraps>
...
801066f5:	6a 18                	push   $0x18
  jmp alltraps
801066f7:	e9 75 fa ff ff       	jmp    80106171 <alltraps>
...
801066fe:	6a 19                	push   $0x19
  jmp alltraps
80106700:	e9 6c fa ff ff       	jmp    80106171 <alltraps>
...
80106707:	6a 1a                	push   $0x1a
  jmp alltraps
80106709:	e9 63 fa ff ff       	jmp    80106171 <alltraps>
...
80106710:	6a 1b                	push   $0x1b
  jmp alltraps
80106712:	e9 5a fa ff ff       	jmp    80106171 <alltraps>
...
80106719:	6a 1c                	push   $0x1c
  jmp alltraps
8010671b:	e9 51 fa ff ff       	jmp    80106171 <alltraps>
...
80106722:	6a 1d                	push   $0x1d
  jmp alltraps
80106724:	e9 48 fa ff ff       	jmp    80106171 <alltraps>
...
8010672b:	6a 1e                	push   $0x1e
  jmp alltraps
8010672d:	e9 3f fa ff ff       	jmp    80106171 <alltraps>
...
80106734:	6a 1f                	push   $0x1f
  jmp alltraps
80106736:	e9 36 fa ff ff       	jmp    80106171 <alltraps>
...
8010673d:	6a 20                	push   $0x20
  jmp alltraps
8010673f:	e9 2d fa ff ff       	jmp    80106171 <alltraps>
...
80106746:	6a 21                	push   $0x21
  jmp alltraps
80106748:	e9 24 fa ff ff       	jmp    80106171 <alltraps>
...
8010674f:	6a 22                	push   $0x22
  jmp alltraps
80106751:	e9 1b fa ff ff       	jmp    80106171 <alltraps>
...
80106758:	6a 23                	push   $0x23
  jmp alltraps
8010675a:	e9 12 fa ff ff       	jmp    80106171 <alltraps>
...
80106761:	6a 24                	push   $0x24
  jmp alltraps
80106763:	e9 09 fa ff ff       	jmp    80106171 <alltraps>
...
8010676a:	6a 25                	push   $0x25
  jmp alltraps
8010676c:	e9 00 fa ff ff       	jmp    80106171 <alltraps>
...
80106773:	6a 26                	push   $0x26
  jmp alltraps
80106775:	e9 f7 f9 ff ff       	jmp    80106171 <alltraps>
...
8010677c:	6a 27                	push   $0x27
  jmp alltraps
8010677e:	e9 ee f9 ff ff       	jmp    80106171 <alltraps>
...
80106785:	6a 28                	push   $0x28
  jmp alltraps
80106787:	e9 e5 f9 ff ff       	jmp    80106171 <alltraps>
...
8010678e:	6a 29                	push   $0x29
  jmp alltraps
80106790:	e9 dc f9 ff ff       	jmp    80106171 <alltraps>
...
80106797:	6a 2a                	push   $0x2a
  jmp alltraps
80106799:	e9 d3 f9 ff ff       	jmp    80106171 <alltraps>
...
801067a0:	6a 2b                	push   $0x2b
  jmp alltraps
801067a2:	e9 ca f9 ff ff       	jmp    80106171 <alltraps>
...
801067a9:	6a 2c                	push   $0x2c
  jmp alltraps
801067ab:	e9 c1 f9 ff ff       	jmp    80106171 <alltraps>
...
801067b2:	6a 2d                	push   $0x2d
  jmp alltraps
801067b4:	e9 b8 f9 ff ff       	jmp    80106171 <alltraps>
...
801067bb:	6a 2e                	push   $0x2e
  jmp alltraps
801067bd:	e9 af f9 ff ff       	jmp    80106171 <alltraps>
...
801067c4:	6a 2f                	push   $0x2f
  jmp alltraps
801067c6:	e9 a6 f9 ff ff       	jmp    80106171 <alltraps>
...
801067cd:	6a 30                	push   $0x30
  jmp alltraps
801067cf:	e9 9d f9 ff ff       	jmp    80106171 <alltraps>
...
801067d6:	6a 31                	push   $0x31
  jmp alltraps
801067d8:	e9 94 f9 ff ff       	jmp    80106171 <alltraps>
...
801067df:	6a 32                	push   $0x32
  jmp alltraps
801067e1:	e9 8b f9 ff ff       	jmp    80106171 <alltraps>
...
801067e8:	6a 33                	push   $0x33
  jmp alltraps
801067ea:	e9 82 f9 ff ff       	jmp    80106171 <alltraps>
...
801067f1:	6a 34                	push   $0x34
  jmp alltraps
801067f3:	e9 79 f9 ff ff       	jmp    80106171 <alltraps>
...
801067fa:	6a 35                	push   $0x35
  jmp alltraps
801067fc:	e9 70 f9 ff ff       	jmp    80106171 <alltraps>
...
80106803:	6a 36                	push   $0x36
  jmp alltraps
80106805:	e9 67 f9 ff ff       	jmp    80106171 <alltraps>
...
8010680c:	6a 37                	push   $0x37
  jmp alltraps
8010680e:	e9 5e f9 ff ff       	jmp    80106171 <alltraps>
...
80106815:	6a 38                	push   $0x38
  jmp alltraps
80106817:	e9 55 f9 ff ff       	jmp    80106171 <alltraps>
...
8010681e:	6a 39                	push   $0x39
  jmp alltraps
80106820:	e9 4c f9 ff ff       	jmp    80106171 <alltraps>
...
80106827:	6a 3a                	push   $0x3a
  jmp alltraps
80106829:	e9 43 f9 ff ff       	jmp    80106171 <alltraps>
...
80106830:	6a 3b                	push   $0x3b
  jmp alltraps
80106832:	e9 3a f9 ff ff       	jmp    80106171 <alltraps>
...
80106839:	6a 3c                	push   $0x3c
  jmp alltraps
8010683b:	e9 31 f9 ff ff       	jmp    80106171 <alltraps>
...
80106842:	6a 3d                	push   $0x3d
  jmp alltraps
80106844:	e9 28 f9 ff ff       	jmp    80106171 <alltraps>
...
8010684b:	6a 3e                	push   $0x3e
  jmp alltraps
8010684d:	e9 1f f9 ff ff       	jmp    80106171 <alltraps>
...
80106854:	6a 3f                	push   $0x3f
  jmp alltraps
80106856:	e9 16 f9 ff ff       	jmp    80106171 <alltraps>
...
8010685d:	6a 40                	push   $0x40
  jmp alltraps
8010685f:	e9 0d f9 ff ff       	jmp    80106171 <alltraps>
...
80106866:	6a 41                	push   $0x41
  jmp alltraps
80106868:	e9 04 f9 ff ff       	jmp    80106171 <alltraps>
...
8010686f:	6a 42                	push   $0x42
  jmp alltraps
80106871:	e9 fb f8 ff ff       	jmp    80106171 <alltraps>
...
80106878:	6a 43                	push   $0x43
  jmp alltraps
8010687a:	e9 f2 f8 ff ff       	jmp    80106171 <alltraps>
...
80106881:	6a 44                	push   $0x44
  jmp alltraps
80106883:	e9 e9 f8 ff ff       	jmp    80106171 <alltraps>
...
8010688a:	6a 45                	push   $0x45
  jmp alltraps
8010688c:	e9 e0 f8 ff ff       	jmp    80106171 <alltraps>
...
80106893:	6a 46                	push   $0x46
  jmp alltraps
80106895:	e9 d7 f8 ff ff       	jmp    80106171 <alltraps>
...
8010689c:	6a 47                	push   $0x47
  jmp alltraps
8010689e:	e9 ce f8 ff ff       	jmp    80106171 <alltraps>
...
801068a5:	6a 48                	push   $0x48
  jmp alltraps
801068a7:	e9 c5 f8 ff ff       	jmp    80106171 <alltraps>
...
801068ae:	6a 49                	push   $0x49
  jmp alltraps
801068b0:	e9 bc f8 ff ff       	jmp    80106171 <alltraps>
...
801068b7:	6a 4a                	push   $0x4a
  jmp alltraps
801068b9:	e9 b3 f8 ff ff       	jmp    80106171 <alltraps>
...
801068c0:	6a 4b                	push   $0x4b
  jmp alltraps
801068c2:	e9 aa f8 ff ff       	jmp    80106171 <alltraps>
...
801068c9:	6a 4c                	push   $0x4c
  jmp alltraps
801068cb:	e9 a1 f8 ff ff       	jmp    80106171 <alltraps>
...
801068d2:	6a 4d                	push   $0x4d
  jmp alltraps
801068d4:	e9 98 f8 ff ff       	jmp    80106171 <alltraps>
...
801068db:	6a 4e                	push   $0x4e
  jmp alltraps
801068dd:	e9 8f f8 ff ff       	jmp    80106171 <alltraps>
...
801068e4:	6a 4f                	push   $0x4f
  jmp alltraps
801068e6:	e9 86 f8 ff ff       	jmp    80106171 <alltraps>
...
801068ed:	6a 50                	push   $0x50
  jmp alltraps
801068ef:	e9 7d f8 ff ff       	jmp    80106171 <alltraps>
...
801068f6:	6a 51                	push   $0x51
  jmp alltraps
801068f8:	e9 74 f8 ff ff       	jmp    80106171 <alltraps>
...
801068ff:	6a 52                	push   $0x52
  jmp alltraps
80106901:	e9 6b f8 ff ff       	jmp    80106171 <alltraps>
...
80106908:	6a 53                	push   $0x53
  jmp alltraps
8010690a:	e9 62 f8 ff ff       	jmp    80106171 <alltraps>
...
80106911:	6a 54                	push   $0x54
  jmp alltraps
80106913:	e9 59 f8 ff ff       	jmp    80106171 <alltraps>
...
8010691a:	6a 55                	push   $0x55
  jmp alltraps
8010691c:	e9 50 f8 ff ff       	jmp    80106171 <alltraps>
...
80106923:	6a 56                	push   $0x56
  jmp alltraps
80106925:	e9 47 f8 ff ff       	jmp    80106171 <alltraps>
...
8010692c:	6a 57                	push   $0x57
  jmp alltraps
8010692e:	e9 3e f8 ff ff       	jmp    80106171 <alltraps>
...
80106935:	6a 58                	push   $0x58
  jmp alltraps
80106937:	e9 35 f8 ff ff       	jmp    80106171 <alltraps>
...
8010693e:	6a 59                	push   $0x59
  jmp alltraps
80106940:	e9 2c f8 ff ff       	jmp    80106171 <alltraps>
...
80106947:	6a 5a                	push   $0x5a
  jmp alltraps
80106949:	e9 23 f8 ff ff       	jmp    80106171 <alltraps>
...
80106950:	6a 5b                	push   $0x5b
  jmp alltraps
80106952:	e9 1a f8 ff ff       	jmp    80106171 <alltraps>
...
80106959:	6a 5c                	push   $0x5c
  jmp alltraps
8010695b:	e9 11 f8 ff ff       	jmp    80106171 <alltraps>
...
80106962:	6a 5d                	push   $0x5d
  jmp alltraps
80106964:	e9 08 f8 ff ff       	jmp    80106171 <alltraps>
...
8010696b:	6a 5e                	push   $0x5e
  jmp alltraps
8010696d:	e9 ff f7 ff ff       	jmp    80106171 <alltraps>
...
80106974:	6a 5f                	push   $0x5f
  jmp alltraps
80106976:	e9 f6 f7 ff ff       	jmp    80106171 <alltraps>
...
8010697d:	6a 60                	push   $0x60
  jmp alltraps
8010697f:	e9 ed f7 ff ff       	jmp    80106171 <alltraps>
...
80106986:	6a 61                	push   $0x61
  jmp alltraps
80106988:	e9 e4 f7 ff ff       	jmp    80106171 <alltraps>
...
8010698f:	6a 62                	push   $0x62
  jmp alltraps
80106991:	e9 db f7 ff ff       	jmp    80106171 <alltraps>
...
80106998:	6a 63                	push   $0x63
  jmp alltraps
8010699a:	e9 d2 f7 ff ff       	jmp    80106171 <alltraps>
...
801069a1:	6a 64                	push   $0x64
  jmp alltraps
801069a3:	e9 c9 f7 ff ff       	jmp    80106171 <alltraps>
...
801069aa:	6a 65                	push   $0x65
  jmp alltraps
801069ac:	e9 c0 f7 ff ff       	jmp    80106171 <alltraps>
...
801069b3:	6a 66                	push   $0x66
  jmp alltraps
801069b5:	e9 b7 f7 ff ff       	jmp    80106171 <alltraps>
...
801069bc:	6a 67                	push   $0x67
  jmp alltraps
801069be:	e9 ae f7 ff ff       	jmp    80106171 <alltraps>
...
801069c5:	6a 68                	push   $0x68
  jmp alltraps
801069c7:	e9 a5 f7 ff ff       	jmp    80106171 <alltraps>
...
801069ce:	6a 69                	push   $0x69
  jmp alltraps
801069d0:	e9 9c f7 ff ff       	jmp    80106171 <alltraps>
...
801069d7:	6a 6a                	push   $0x6a
  jmp alltraps
801069d9:	e9 93 f7 ff ff       	jmp    80106171 <alltraps>
...
801069e0:	6a 6b                	push   $0x6b
  jmp alltraps
801069e2:	e9 8a f7 ff ff       	jmp    80106171 <alltraps>
...
801069e9:	6a 6c                	push   $0x6c
  jmp alltraps
801069eb:	e9 81 f7 ff ff       	jmp    80106171 <alltraps>
...
801069f2:	6a 6d                	push   $0x6d
  jmp alltraps
801069f4:	e9 78 f7 ff ff       	jmp    80106171 <alltraps>
...
801069fb:	6a 6e                	push   $0x6e
  jmp alltraps
801069fd:	e9 6f f7 ff ff       	jmp    80106171 <alltraps>
...
80106a04:	6a 6f                	push   $0x6f
  jmp alltraps
80106a06:	e9 66 f7 ff ff       	jmp    80106171 <alltraps>
...
80106a0d:	6a 70                	push   $0x70
  jmp alltraps
80106a0f:	e9 5d f7 ff ff       	jmp    80106171 <alltraps>
...
80106a16:	6a 71                	push   $0x71
  jmp alltraps
80106a18:	e9 54 f7 ff ff       	jmp    80106171 <alltraps>
...
80106a1f:	6a 72                	push   $0x72
  jmp alltraps
80106a21:	e9 4b f7 ff ff       	jmp    80106171 <alltraps>
...
80106a28:	6a 73                	push   $0x73
  jmp alltraps
80106a2a:	e9 42 f7 ff ff       	jmp    80106171 <alltraps>
...
80106a31:	6a 74                	push   $0x74
  jmp alltraps
80106a33:	e9 39 f7 ff ff       	jmp    80106171 <alltraps>
...
80106a3a:	6a 75                	push   $0x75
  jmp alltraps
80106a3c:	e9 30 f7 ff ff       	jmp    80106171 <alltraps>
...
80106a43:	6a 76                	push   $0x76
  jmp alltraps
80106a45:	e9 27 f7 ff ff       	jmp    80106171 <alltraps>
...
80106a4c:	6a 77                	push   $0x77
  jmp alltraps
80106a4e:	e9 1e f7 ff ff       	jmp    80106171 <alltraps>
...
80106a55:	6a 78                	push   $0x78
  jmp alltraps
80106a57:	e9 15 f7 ff ff       	jmp    80106171 <alltraps>
...
80106a5e:	6a 79                	push   $0x79
  jmp alltraps
80106a60:	e9 0c f7 ff ff       	jmp    80106171 <alltraps>
...
80106a67:	6a 7a                	push   $0x7a
  jmp alltraps
80106a69:	e9 03 f7 ff ff       	jmp    80106171 <alltraps>
...
80106a70:	6a 7b                	push   $0x7b
  jmp alltraps
80106a72:	e9 fa f6 ff ff       	jmp    80106171 <alltraps>
...
80106a79:	6a 7c                	push   $0x7c
  jmp alltraps
80106a7b:	e9 f1 f6 ff ff       	jmp    80106171 <alltraps>
...
80106a82:	6a 7d                	push   $0x7d
  jmp alltraps
80106a84:	e9 e8 f6 ff ff       	jmp    80106171 <alltraps>
...
80106a8b:	6a 7e                	push   $0x7e
  jmp alltraps
80106a8d:	e9 df f6 ff ff       	jmp    80106171 <alltraps>
...
80106a94:	6a 7f                	push   $0x7f
  jmp alltraps
80106a96:	e9 d6 f6 ff ff       	jmp    80106171 <alltraps>
...
80106a9d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106aa2:	e9 ca f6 ff ff       	jmp    80106171 <alltraps>
...
80106aa9:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80106aae:	e9 be f6 ff ff       	jmp    80106171 <alltraps>
...
80106ab5:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106aba:	e9 b2 f6 ff ff       	jmp    80106171 <alltraps>
...
80106ac1:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106ac6:	e9 a6 f6 ff ff       	jmp    80106171 <alltraps>
...
80106acd:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106ad2:	e9 9a f6 ff ff       	jmp    80106171 <alltraps>
...
80106ad9:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106ade:	e9 8e f6 ff ff       	jmp    80106171 <alltraps>
...
80106ae5:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106aea:	e9 82 f6 ff ff       	jmp    80106171 <alltraps>
...
80106af1:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106af6:	e9 76 f6 ff ff       	jmp    80106171 <alltraps>
...
80106afd:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106b02:	e9 6a f6 ff ff       	jmp    80106171 <alltraps>
...
80106b09:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106b0e:	e9 5e f6 ff ff       	jmp    80106171 <alltraps>
...
80106b15:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106b1a:	e9 52 f6 ff ff       	jmp    80106171 <alltraps>
...
80106b21:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106b26:	e9 46 f6 ff ff       	jmp    80106171 <alltraps>
...
80106b2d:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106b32:	e9 3a f6 ff ff       	jmp    80106171 <alltraps>
...
80106b39:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80106b3e:	e9 2e f6 ff ff       	jmp    80106171 <alltraps>
...
80106b45:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106b4a:	e9 22 f6 ff ff       	jmp    80106171 <alltraps>
...
80106b51:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106b56:	e9 16 f6 ff ff       	jmp    80106171 <alltraps>
...
80106b5d:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80106b62:	e9 0a f6 ff ff       	jmp    80106171 <alltraps>
...
80106b69:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80106b6e:	e9 fe f5 ff ff       	jmp    80106171 <alltraps>
...
80106b75:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106b7a:	e9 f2 f5 ff ff       	jmp    80106171 <alltraps>
...
80106b81:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106b86:	e9 e6 f5 ff ff       	jmp    80106171 <alltraps>
...
80106b8d:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106b92:	e9 da f5 ff ff       	jmp    80106171 <alltraps>
...
80106b99:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80106b9e:	e9 ce f5 ff ff       	jmp    80106171 <alltraps>
...
80106ba5:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106baa:	e9 c2 f5 ff ff       	jmp    80106171 <alltraps>
...
80106bb1:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106bb6:	e9 b6 f5 ff ff       	jmp    80106171 <alltraps>
...
80106bbd:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106bc2:	e9 aa f5 ff ff       	jmp    80106171 <alltraps>
...
80106bc9:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80106bce:	e9 9e f5 ff ff       	jmp    80106171 <alltraps>
...
80106bd5:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106bda:	e9 92 f5 ff ff       	jmp    80106171 <alltraps>
...
80106be1:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106be6:	e9 86 f5 ff ff       	jmp    80106171 <alltraps>
...
80106bed:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80106bf2:	e9 7a f5 ff ff       	jmp    80106171 <alltraps>
...
80106bf9:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80106bfe:	e9 6e f5 ff ff       	jmp    80106171 <alltraps>
...
80106c05:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106c0a:	e9 62 f5 ff ff       	jmp    80106171 <alltraps>
...
80106c11:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106c16:	e9 56 f5 ff ff       	jmp    80106171 <alltraps>
...
80106c1d:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80106c22:	e9 4a f5 ff ff       	jmp    80106171 <alltraps>
...
80106c29:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80106c2e:	e9 3e f5 ff ff       	jmp    80106171 <alltraps>
...
80106c35:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106c3a:	e9 32 f5 ff ff       	jmp    80106171 <alltraps>
...
80106c41:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106c46:	e9 26 f5 ff ff       	jmp    80106171 <alltraps>
...
80106c4d:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80106c52:	e9 1a f5 ff ff       	jmp    80106171 <alltraps>
...
80106c59:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80106c5e:	e9 0e f5 ff ff       	jmp    80106171 <alltraps>
...
80106c65:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106c6a:	e9 02 f5 ff ff       	jmp    80106171 <alltraps>
...
80106c71:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106c76:	e9 f6 f4 ff ff       	jmp    80106171 <alltraps>
...
80106c7d:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80106c82:	e9 ea f4 ff ff       	jmp    80106171 <alltraps>
...
80106c89:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80106c8e:	e9 de f4 ff ff       	jmp    80106171 <alltraps>
...
80106c95:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106c9a:	e9 d2 f4 ff ff       	jmp    80106171 <alltraps>
...
80106ca1:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106ca6:	e9 c6 f4 ff ff       	jmp    80106171 <alltraps>
...
80106cad:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80106cb2:	e9 ba f4 ff ff       	jmp    80106171 <alltraps>
...
80106cb9:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106cbe:	e9 ae f4 ff ff       	jmp    80106171 <alltraps>
...
80106cc5:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106cca:	e9 a2 f4 ff ff       	jmp    80106171 <alltraps>
...
80106cd1:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106cd6:	e9 96 f4 ff ff       	jmp    80106171 <alltraps>
...
80106cdd:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80106ce2:	e9 8a f4 ff ff       	jmp    80106171 <alltraps>
...
80106ce9:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106cee:	e9 7e f4 ff ff       	jmp    80106171 <alltraps>
...
80106cf5:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106cfa:	e9 72 f4 ff ff       	jmp    80106171 <alltraps>
...
80106d01:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106d06:	e9 66 f4 ff ff       	jmp    80106171 <alltraps>
...
80106d0d:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80106d12:	e9 5a f4 ff ff       	jmp    80106171 <alltraps>
...
80106d19:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106d1e:	e9 4e f4 ff ff       	jmp    80106171 <alltraps>
...
80106d25:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106d2a:	e9 42 f4 ff ff       	jmp    80106171 <alltraps>
...
80106d31:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106d36:	e9 36 f4 ff ff       	jmp    80106171 <alltraps>
...
80106d3d:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80106d42:	e9 2a f4 ff ff       	jmp    80106171 <alltraps>
...
80106d49:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106d4e:	e9 1e f4 ff ff       	jmp    80106171 <alltraps>
...
80106d55:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106d5a:	e9 12 f4 ff ff       	jmp    80106171 <alltraps>
...
80106d61:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106d66:	e9 06 f4 ff ff       	jmp    80106171 <alltraps>
...
80106d6d:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80106d72:	e9 fa f3 ff ff       	jmp    80106171 <alltraps>
...
80106d79:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80106d7e:	e9 ee f3 ff ff       	jmp    80106171 <alltraps>
...
80106d85:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106d8a:	e9 e2 f3 ff ff       	jmp    80106171 <alltraps>
...
80106d91:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106d96:	e9 d6 f3 ff ff       	jmp    80106171 <alltraps>
...
80106d9d:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106da2:	e9 ca f3 ff ff       	jmp    80106171 <alltraps>
...
80106da9:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106dae:	e9 be f3 ff ff       	jmp    80106171 <alltraps>
...
80106db5:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106dba:	e9 b2 f3 ff ff       	jmp    80106171 <alltraps>
...
80106dc1:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106dc6:	e9 a6 f3 ff ff       	jmp    80106171 <alltraps>
...
80106dcd:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106dd2:	e9 9a f3 ff ff       	jmp    80106171 <alltraps>
...
80106dd9:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106dde:	e9 8e f3 ff ff       	jmp    80106171 <alltraps>
...
80106de5:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106dea:	e9 82 f3 ff ff       	jmp    80106171 <alltraps>
...
80106df1:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106df6:	e9 76 f3 ff ff       	jmp    80106171 <alltraps>
...
80106dfd:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106e02:	e9 6a f3 ff ff       	jmp    80106171 <alltraps>
...
80106e09:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106e0e:	e9 5e f3 ff ff       	jmp    80106171 <alltraps>
...
80106e15:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106e1a:	e9 52 f3 ff ff       	jmp    80106171 <alltraps>
...
80106e21:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106e26:	e9 46 f3 ff ff       	jmp    80106171 <alltraps>
...
80106e2d:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106e32:	e9 3a f3 ff ff       	jmp    80106171 <alltraps>
...
80106e39:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106e3e:	e9 2e f3 ff ff       	jmp    80106171 <alltraps>
...
80106e45:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106e4a:	e9 22 f3 ff ff       	jmp    80106171 <alltraps>
...
80106e51:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106e56:	e9 16 f3 ff ff       	jmp    80106171 <alltraps>
...
80106e5d:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106e62:	e9 0a f3 ff ff       	jmp    80106171 <alltraps>
...
80106e69:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106e6e:	e9 fe f2 ff ff       	jmp    80106171 <alltraps>
...
80106e75:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106e7a:	e9 f2 f2 ff ff       	jmp    80106171 <alltraps>
...
80106e81:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106e86:	e9 e6 f2 ff ff       	jmp    80106171 <alltraps>
...
80106e8d:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106e92:	e9 da f2 ff ff       	jmp    80106171 <alltraps>
...
80106e99:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106e9e:	e9 ce f2 ff ff       	jmp    80106171 <alltraps>
...
80106ea5:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106eaa:	e9 c2 f2 ff ff       	jmp    80106171 <alltraps>
...
80106eb1:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106eb6:	e9 b6 f2 ff ff       	jmp    80106171 <alltraps>
...
80106ebd:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106ec2:	e9 aa f2 ff ff       	jmp    80106171 <alltraps>
...
80106ec9:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106ece:	e9 9e f2 ff ff       	jmp    80106171 <alltraps>
...
80106ed5:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106eda:	e9 92 f2 ff ff       	jmp    80106171 <alltraps>
...
80106ee1:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106ee6:	e9 86 f2 ff ff       	jmp    80106171 <alltraps>
...
80106eed:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106ef2:	e9 7a f2 ff ff       	jmp    80106171 <alltraps>
...
80106ef9:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106efe:	e9 6e f2 ff ff       	jmp    80106171 <alltraps>
...
80106f05:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106f0a:	e9 62 f2 ff ff       	jmp    80106171 <alltraps>
...
80106f11:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106f16:	e9 56 f2 ff ff       	jmp    80106171 <alltraps>
...
80106f1d:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106f22:	e9 4a f2 ff ff       	jmp    80106171 <alltraps>
...
80106f29:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106f2e:	e9 3e f2 ff ff       	jmp    80106171 <alltraps>
...
80106f35:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106f3a:	e9 32 f2 ff ff       	jmp    80106171 <alltraps>
...
80106f41:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106f46:	e9 26 f2 ff ff       	jmp    80106171 <alltraps>
...
80106f4d:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106f52:	e9 1a f2 ff ff       	jmp    80106171 <alltraps>
...
80106f59:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106f5e:	e9 0e f2 ff ff       	jmp    80106171 <alltraps>
...
80106f65:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106f6a:	e9 02 f2 ff ff       	jmp    80106171 <alltraps>
...
80106f71:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106f76:	e9 f6 f1 ff ff       	jmp    80106171 <alltraps>
...
80106f7d:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106f82:	e9 ea f1 ff ff       	jmp    80106171 <alltraps>
...
80106f89:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106f8e:	e9 de f1 ff ff       	jmp    80106171 <alltraps>
...
80106f95:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106f9a:	e9 d2 f1 ff ff       	jmp    80106171 <alltraps>
...
80106fa1:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106fa6:	e9 c6 f1 ff ff       	jmp    80106171 <alltraps>
...
80106fad:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106fb2:	e9 ba f1 ff ff       	jmp    80106171 <alltraps>
...
80106fb9:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106fbe:	e9 ae f1 ff ff       	jmp    80106171 <alltraps>
...
80106fc5:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106fca:	e9 a2 f1 ff ff       	jmp    80106171 <alltraps>
...
80106fd1:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106fd6:	e9 96 f1 ff ff       	jmp    80106171 <alltraps>
...
80106fdd:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106fe2:	e9 8a f1 ff ff       	jmp    80106171 <alltraps>
...
80106fe9:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106fee:	e9 7e f1 ff ff       	jmp    80106171 <alltraps>
...
80106ff5:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106ffa:	e9 72 f1 ff ff       	jmp    80106171 <alltraps>
...
80107001:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107006:	e9 66 f1 ff ff       	jmp    80106171 <alltraps>
...
8010700d:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107012:	e9 5a f1 ff ff       	jmp    80106171 <alltraps>
...
80107019:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010701e:	e9 4e f1 ff ff       	jmp    80106171 <alltraps>
...
80107025:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
8010702a:	e9 42 f1 ff ff       	jmp    80106171 <alltraps>
...
80107031:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107036:	e9 36 f1 ff ff       	jmp    80106171 <alltraps>
...
8010703d:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107042:	e9 2a f1 ff ff       	jmp    80106171 <alltraps>
...
80107049:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010704e:	e9 1e f1 ff ff       	jmp    80106171 <alltraps>
...
80107055:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
8010705a:	e9 12 f1 ff ff       	jmp    80106171 <alltraps>
...
80107061:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107066:	e9 06 f1 ff ff       	jmp    80106171 <alltraps>
...
8010706d:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107072:	e9 fa f0 ff ff       	jmp    80106171 <alltraps>
...
80107079:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010707e:	e9 ee f0 ff ff       	jmp    80106171 <alltraps>
...
80107085:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
8010708a:	e9 e2 f0 ff ff       	jmp    80106171 <alltraps>
...
80107091:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107096:	e9 d6 f0 ff ff       	jmp    80106171 <alltraps>
...
801070e4:	e8 47 b5 ff ff       	call   80102630 <kalloc>
...
801070fa:	e8 21 d8 ff ff       	call   80104920 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010719d:	68 9c 83 10 80       	push   $0x8010839c
...
80107218:	e8 53 b2 ff ff       	call   80102470 <kfree>
      *pte = 0;
...
80107267:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
8010726a:	e8 e1 c6 ff ff       	call   80103950 <cpuid>
  pd[0] = size-1;
...
8010727e:	c7 80 58 6e 13 80 ff 	movl   $0xffff,-0x7fec91a8(%eax)
80107285:	ff 00 00 
80107288:	c7 80 5c 6e 13 80 00 	movl   $0xcf9a00,-0x7fec91a4(%eax)
8010728f:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80107292:	c7 80 60 6e 13 80 ff 	movl   $0xffff,-0x7fec91a0(%eax)
80107299:	ff 00 00 
8010729c:	c7 80 64 6e 13 80 00 	movl   $0xcf9200,-0x7fec919c(%eax)
801072a3:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801072a6:	c7 80 68 6e 13 80 ff 	movl   $0xffff,-0x7fec9198(%eax)
801072ad:	ff 00 00 
801072b0:	c7 80 6c 6e 13 80 00 	movl   $0xcffa00,-0x7fec9194(%eax)
801072b7:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801072ba:	c7 80 70 6e 13 80 ff 	movl   $0xffff,-0x7fec9190(%eax)
801072c1:	ff 00 00 
801072c4:	c7 80 74 6e 13 80 00 	movl   $0xcff200,-0x7fec918c(%eax)
801072cb:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
801072ce:	05 50 6e 13 80       	add    $0x80136e50,%eax
  pd[1] = (uint)p;
...
801072f4:	a1 c4 9f 13 80       	mov    0x80139fc4,%eax
...
80107338:	0f 84 c2 00 00 00    	je     80107400 <switchuvm+0xf0>
  pushcli();
8010733e:	e8 cd d3 ff ff       	call   80104710 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80107343:	e8 98 c5 ff ff       	call   801038e0 <mycpu>
80107348:	89 c3                	mov    %eax,%ebx
8010734a:	e8 91 c5 ff ff       	call   801038e0 <mycpu>
8010734f:	89 c7                	mov    %eax,%edi
80107351:	e8 8a c5 ff ff       	call   801038e0 <mycpu>
80107356:	83 c7 08             	add    $0x8,%edi
80107359:	89 45 e4             	mov    %eax,-0x1c(%ebp)
8010735c:	e8 7f c5 ff ff       	call   801038e0 <mycpu>
...
8010743f:	77 4b                	ja     8010748c <inituvm+0x6c>
  mem = kalloc();
80107441:	e8 ea b1 ff ff       	call   80102630 <kalloc>
  memset(mem, 0, PGSIZE);
...
80107453:	e8 c8 d4 ff ff       	call   80104920 <memset>
...
80107486:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80107487:	e9 34 d5 ff ff       	jmp    801049c0 <memmove>
    panic("inituvm: more than a page");
8010748c:	83 ec 0c             	sub    $0xc,%esp
8010748f:	68 e1 83 10 80       	push   $0x801083e1
...
8010751e:	e8 3d a5 ff ff       	call   80101a60 <readi>
...
801075bb:	e8 60 d3 ff ff       	call   80104920 <memset>
...
801075e9:	76 48                	jbe    80107633 <allocuvm+0xc3>
    mem = kalloc();
801075eb:	e8 40 b0 ff ff       	call   80102630 <kalloc>
...
801075f9:	68 19 84 10 80       	push   $0x80108419
...
8010765b:	68 31 84 10 80       	push   $0x80108431
...
80107680:	e8 eb ad ff ff       	call   80102470 <kfree>
      return 0;
...
8010771e:	e8 4d ad ff ff       	call   80102470 <kfree>
...
80107733:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80107734:	e9 37 ad ff ff       	jmp    80102470 <kfree>
    panic("freevm: no pgdir");
80107739:	83 ec 0c             	sub    $0xc,%esp
8010773c:	68 4d 84 10 80       	push   $0x8010844d
...
80107759:	e8 d2 ae ff ff       	call   80102630 <kalloc>
...
80107767:	bb 20 d4 10 80       	mov    $0x8010d420,%ebx
  memset(pgdir, 0, PGSIZE);
8010776c:	68 00 10 00 00       	push   $0x1000
80107771:	6a 00                	push   $0x0
80107773:	50                   	push   %eax
80107774:	e8 a7 d1 ff ff       	call   80104920 <memset>
...
8010779e:	81 fb 60 d4 10 80    	cmp    $0x8010d460,%ebx
...
801077df:	a3 c4 9f 13 80       	mov    %eax,0x80139fc4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80107813:	68 5e 84 10 80       	push   $0x8010845e
...
80107860:	e8 5b d1 ff ff       	call   801049c0 <memmove>
...
801078b2:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
801078b8:	e8 73 ad ff ff       	call   80102630 <kalloc>
...
8010798e:	e8 2d d0 ff ff       	call   801049c0 <memmove>
    len -= n;
    buf += n;
